...
`:case"\r":case"\u2028":case"\u2029":D(),G="default";return;case void 0:return D(),se("eof")}D()},value(){switch(Z){case"{":case"[":return se("punctuator",D());case"n":return D(),bn("ull"),se("null",null);case"t":return D(),bn("rue"),se("boolean",!0);case"f":return D(),bn("alse"),se("boolean",!1);case"-":case"+":D()==="-"&&(Bt=-1),G="sign";return;case".":q=D(),G="decimalPointLeading";return;case"0":q=D(),G="zero";return;case"1":case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":q=D(),G="decimalInteger";return;case"I":return D(),bn("nfinity"),se("numeric",1/0);case"N":return D(),bn("aN"),se("numeric",NaN);case'"':case"'":Mr=D()==='"',q="",G="string";return}throw oe(D())},identifierNameStartEscape(){if(Z!=="u")throw oe(D());D();const e=Xo();switch(e){case"$":case"_":break;default:if(!ge.isIdStartChar(e))throw xu();break}q+=e,G="identifierName"},identifierName(){switch(Z){case"$":case"_":case"‌":case"‍":q+=D();return;case"\\":D(),G="identifierNameEscape";return}if(ge.isIdContinueChar(Z)){q+=D();return}return se("identifier",q)},identifierNameEscape(){if(Z!=="u")throw oe(D());D();const e=Xo();switch(e){case"$":case"_":case"‌":case"‍":break;default:if(!ge.isIdContinueChar(e))throw xu();break}q+=e,G="identifierName"},sign(){switch(Z){case".":q=D(),G="decimalPointLeading";return;case"0":q=D(),G="zero";return;case"1":case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":q=D(),G="decimalInteger";return;case"I":return D(),bn("nfinity"),se("numeric",Bt*(1/0));case"N":return D(),bn("aN"),se("numeric",NaN)}throw oe(D())},zero(){switch(Z){case".":q+=D(),G="decimalPoint";return;case"e":case"E":q+=D(),G="decimalExponent";return;case"x":case"X":q+=D(),G="hexadecimal";return}return se("numeric",Bt*0)},decimalInteger(){switch(Z){case".":q+=D(),G="decimalPoint";return;case"e":case"E":q+=D(),G="decimalExponent";return}if(ge.isDigit(Z)){q+=D();return}return se("numeric",Bt*Number(q))},decimalPointLeading(){if(ge.isDigit(Z)){q+=D(),G="decimalFraction";return}throw oe(D())},decimalPoint(){switch(Z){case"e":case"E":q+=D(),G="decimalExponent";return}if(ge.isDigit(Z)){q+=D(),G="decimalFraction";return}return se("numeric",Bt*Number(q))},decimalFraction(){switch(Z){case"e":case"E":q+=D(),G="decimalExponent";return}if(ge.isDigit(Z)){q+=D();return}return se("numeric",Bt*Number(q))},decimalExponent(){switch(Z){case"+":case"-":q+=D(),G="decimalExponentSign";return}if(ge.isDigit(Z)){q+=D(),G="decimalExponentInteger";return}throw oe(D())},decimalExponentSign(){if(ge.isDigit(Z)){q+=D(),G="decimalExponentInteger";return}throw oe(D())},decimalExponentInteger(){if(ge.isDigit(Z)){q+=D();return}return se("numeric",Bt*Number(q))},hexadecimal(){if(ge.isHexDigit(Z)){q+=D(),G="hexadecimalInteger";return}throw oe(D())},hexadecimalInteger(){if(ge.isHexDigit(Z)){q+=D();return}return se("numeric",Bt*Number(q))},string(){switch(Z){case"\\":D(),q+=wp();return;case'"':if(Mr)return D(),se("string",q);q+=D();return;case"'":if(!Mr)return D(),se("string",q);q+=D();return;case`
`:case"\r":throw oe(D());case"\u2028":case"\u2029":vp(Z);break;case void 0:throw oe(D())}q+=D()},start(){switch(Z){case"{":case"[":return se("punctuator",D())}G="value"},beforePropertyName(){switch(Z){case"$":case"_":q=D(),G="identifierName";return;case"\\":D(),G="identifierNameStartEscape";return;case"}":return se("punctuator",D());case'"':case"'":Mr=D()==='"',G="string";return}if(ge.isIdStartChar(Z)){q+=D(),G="identifierName";return}throw oe(D())},afterPropertyName(){if(Z===":")return se("punctuator",D());throw oe(D())},beforePropertyValue(){G="value"},afterPropertyValue(){switch(Z){case",":case"}":return se("punctuator",D())}throw oe(D())},beforeArrayValue(){if(Z==="]")return se("punctuator",D());G="value"},afterArrayValue(){switch(Z){case",":case"]":return se("punctuator",D())}throw oe(D())},end(){throw oe(D())}};function se(e,t){return{type:e,value:t,line:cn,column:yt}}function bn(e){for(const t of e){if(Wt()!==t)throw oe(D());D()}}function wp(){switch(Wt()){case"b":return D(),"\b";case"f":return D(),"\f";case"n":return D(),`
`;case"r":return D(),"\r";case"t":return D(),"	";case"v":return D(),"\v";case"0":if(D(),ge.isDigit(Wt()))throw oe(D());return"\0";case"x":return D(),yp();case"u":return D(),Xo();case`
`:case"\u2028":case"\u2029":return D(),"";case"\r":return D(),Wt()===`
`&&D(),"";case"1":case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":throw oe(D());case void 0:throw oe(D())}return D()}function yp(){let e="",t=Wt();if(!ge.isHexDigit(t)||(e+=D(),t=Wt(),!ge.isHexDigit(t)))throw oe(D());return e+=D(),String.fromCodePoint(parseInt(e,16))}function Xo(){let e="",t=4;for(;t-- >0;){const n=Wt();if(!ge.isHexDigit(n))throw oe(D());e+=D()}return String.fromCodePoint(parseInt(e,16))}const bp={start(){if($e.type==="eof")throw vn();uo()},beforePropertyName(){switch($e.type){case"identifier":case"string":Ba=$e.value,Ne="afterPropertyName";return;case"punctuator":vi();return;case"eof":throw vn()}},afterPropertyName(){if($e.type==="eof")throw vn();Ne="beforePropertyValue"},beforePropertyValue(){if($e.type==="eof")throw vn();uo()},beforeArrayValue(){if($e.type==="eof")throw vn();if($e.type==="punctuator"&&$e.value==="]"){vi();return}uo()},afterPropertyValue(){if($e.type==="eof")throw vn();switch($e.value){case",":Ne="beforePropertyName";return;case"}":vi()}},afterArrayValue(){if($e.type==="eof")throw vn();switch($e.value){case",":Ne="beforeArrayValue";return;case"]":vi()}},end(){}};function uo(){let e;switch($e.type){case"punctuator":switch($e.value){case"{":e={};break;case"[":e=[];break}break;case"null":case"boolean":case"numeric":case"string":e=$e.value;break}if(Or===void 0)Or=e;else{const t=Ot[Ot.length-1];Array.isArray(t)?t.push(e):Object.defineProperty(t,Ba,{value:e,writable:!0,enumerable:!0,configurable:!0})}if(e!==null&&typeof e=="object")Ot.push(e),Array.isArray(e)?Ne="beforeArrayValue":Ne="beforePropertyName";else{const t=Ot[Ot.length-1];t==null?Ne="end":Array.isArray(t)?Ne="afterArrayValue":Ne="afterPropertyValue"}}function vi(){Ot.pop();const e=Ot[Ot.length-1];e==null?Ne="end":Array.isArray(e)?Ne="afterArrayValue":Ne="afterPropertyValue"}function oe(e){return es(e===void 0?`JSON5: invalid end of input at ${cn}:${yt}`:`JSON5: invalid character '${Mf(e)}' at ${cn}:${yt}`)}function vn(){return es(`JSON5: invalid end of input at ${cn}:${yt}`)}function xu(){return yt-=5,es(`JSON5: invalid identifier character at ${cn}:${yt}`)}function vp(e){console.warn(`JSON5: '${Mf(e)}' in strings is not valid ECMAScript; consider escaping`)}function Mf(e){const t={"'":"\\'",'"':'\\"',"\\":"\\\\","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","	":"\\t","\v":"\\v","\0":"\\0","\u2028":"\\u2028","\u2029":"\\u2029"};if(t[e])return t[e];if(e<" "){const n=e.charCodeAt(0).toString(16);return"\\x"+("00"+n).substring(n.length)}return e}function es(e){const t=new SyntaxError(e);return t.lineNumber=cn,t.columnNumber=yt,t}var Ep=function(t,n,r){const i=[];let s="",o,a,u="",l;if(n!=null&&typeof n=="object"&&!Array.isArray(n)&&(r=n.space,l=n.quote,n=n.replacer),typeof n=="function")a=n;else if(Array.isArray(n)){o=[];for(const v of n){let C;typeof v=="string"?C=v:(typeof v=="number"||v instanceof String||v instanceof Number)&&(C=String(v)),C!==void 0&&o.indexOf(C)<0&&o.push(C)}}return r instanceof Number?r=Number(r):r instanceof String&&(r=String(r)),typeof r=="number"?r>0&&(r=Math.min(10,Math.floor(r)),u="          ".substr(0,r)):typeof r=="string"&&(u=r.substr(0,10)),f("",{"":t});function f(v,C){let A=C[v];switch(A!=null&&(typeof A.toJSON5=="function"?A=A.toJSON5(v):typeof A.toJSON=="function"&&(A=A.toJSON(v))),a&&(A=a.call(C,v,A)),A instanceof Number?A=Number(A):A instanceof String?A=String(A):A instanceof Boolean&&(A=A.valueOf()),A){case null:return"null";case!0:return"true";case!1:return"false"}if(typeof A=="string")return c(A);if(typeof A=="number")return String(A);if(typeof A=="object")return Array.isArray(A)?b(A):m(A)}function c(v){const C={"'":.1,'"':.2},A={"'":"\\'",'"':'\\"',"\\":"\\\\","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","	":"\\t","\v":"\\v","\0":"\\0","\u2028":"\\u2028","\u2029":"\\u2029"};let M="";for(let W=0;W<v.length;W++){const J=v[W];switch(J){case"'":case'"':C[J]++,M+=J;continue;case"\0":if(ge.isDigit(v[W+1])){M+="\\x00";continue}}if(A[J]){M+=A[J];continue}if(J<" "){let Me=J.charCodeAt(0).toString(16);M+="\\x"+("00"+Me).substring(Me.length);continue}M+=J}const R=l||Object.keys(C).reduce((W,J)=>C[W]<C[J]?W:J);return M=M.replace(new RegExp(R,"g"),A[R]),R+M+R}function m(v){if(i.indexOf(v)>=0)throw TypeError("Converting circular structure to JSON5");i.push(v);let C=s;s=s+u;let A=o||Object.keys(v),M=[];for(const W of A){const J=f(W,v);if(J!==void 0){let Me=g(W)+":";u!==""&&(Me+=" "),Me+=J,M.push(Me)}}let R;if(M.length===0)R="{}";else{let W;if(u==="")W=M.join(","),R="{"+W+"}";else{let J=`,
`+s;W=M.join(J),R=`{
`+s+W+`,
 ...
 * @param {Mixed} value
 * @return {Boolean} result
 */function sr(e){return e===null||typeof e!="object"}function Cl(e){return e.map(function(n){return typeof n=="symbol"?n.toString():n})}const Xt={strictEquals(e,t,n){if(e!==t)throw new d(`
...
`,n)}},Yd=Xt.deepEquals,Jd={assert:Xt,check:{strictEquals(e,t){return e===t},notStrictEquals(e,t){return e!==t},looseEquals(e,t){return e==t},notLooseEquals(e,t){return e!=t},deepEquals(e,t){return Ye(e,t)},notDeepEquals(e,t){return!Ye(e,t)}},assertWrap:{strictEquals(e,t,n){if(e===t)return e;throw new d(`
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xr=yn(class extends Kt{constructor(e){if(super(e),e.type!==eo.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(const r in t)t[r]&&!this.nt?.has(r)&&this.st.add(r);return this.render(t)}const n=e.element.classList;for(const r of this.st)r in t||(n.remove(r),this.st.delete(r));for(const r in t){const i=!!t[r];i===this.st.has(r)||this.nt?.has(r)||(i?(n.add(r),this.st.add(r)):(n.remove(r),this.st.delete(r)))}return et}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wm=e=>e??ce;/**
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ca extends Kt{constructor(t){if(super(t),this.it=ce,t.type!==eo.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===ce||t==null)return this._t=void 0,this.it=t;if(t===et)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const n=[t];return n.raw=n,this._t={_$litType$:this.constructor.resultType,strings:n,values:[]}}}Ca.directiveName="unsafeHTML",Ca.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const nf=(e,t,n)=>{const r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},WD=yn(class extends Kt{constructor(e){if(super(e),e.type!==eo.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);const i=[],s=[];let o=0;for(const a of e)i[o]=r?r(a,o):o,s[o]=n(a,o),o++;return{values:s,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){const i=ED(e),{values:s,keys:o}=this.dt(t,n,r);if(!Array.isArray(i))return this.ut=o,s;const a=this.ut??=[],u=[];let l,f,c=0,m=i.length-1,g=0,b=s.length-1;for(;c<=m&&g<=b;)if(i[c]===null)c++;else if(i[m]===null)m--;else if(a[c]===o[g])u[g]=Cn(i[c],s[g]),c++,g++;else if(a[m]===o[b])u[b]=Cn(i[m],s[b]),m--,b--;else if(a[c]===o[b])u[b]=Cn(i[c],s[b]),Tr(e,u[b+1],i[c]),c++,b--;else if(a[m]===o[g])u[g]=Cn(i[m],s[g]),Tr(e,i[c],i[m]),m--,g++;else if(l===void 0&&(l=nf(o,g,b),f=nf(a,c,m)),l.has(a[c]))if(l.has(a[m])){const v=f.get(o[g]),C=v!==void 0?i[v]:null;if(C===null){const A=Tr(e,i[c]);Cn(A,s[g]),u[g]=A}else u[g]=Cn(C,s[g]),Tr(e,i[c],C),i[v]=null;g++}else zo(i[m]),m--;else zo(i[c]),c++;for(;g<=b;){const v=Tr(e,u[b+1]);Cn(v,s[g]),u[g++]=v}for(;c<=m;){const v=i[c++];v!==null&&zo(v)}return this.ut=o,vD(e,u),et}}),qD=WD;function no(e,t){return ei(e,t),e.element}function jD(e){try{return e.options.host.tagName.toLowerCase()}catch{return}}function ei(e,t){const n=jD(e),r=n?`: in ${n}`:"";if(e.type!==eo.ELEMENT)throw new Error(`${t} directive can only be attached directly to an element${r}.`);if(!e.element)throw new Error(`${t} directive found no element${r}.`)}function zD(e){const t=yn(class extends Kt{element;constructor(n){super(n),this.element=no(n,e)}render(n){return this.element.setAttribute(e,n),et}});return{attributeSelector(n){return`[${e}="${n}"]`},attributeDirective(n){return t(n)},attributeName:e}}function te(e,t){return GD(e,t)}const GD=yn(class extends Kt{element;lastListenerMetaData;constructor(e){super(e),this.element=no(e,"listen")}resetListener(e){this.lastListenerMetaData&&this.element.removeEventListener(this.lastListenerMetaData.eventType,this.lastListenerMetaData.listener),this.element.addEventListener(e.eventType,e.listener),this.lastListenerMetaData=e}createListenerMetaData(e,t){return{eventType:e,callback:t,listener:n=>this.lastListenerMetaData?.callback(n)}}render(e,t){const n=typeof e=="string"?e:e.type;if(typeof n!="string")throw new TypeError(`Cannot listen to an event with a name that is not a string. Given event name: '${String(n)}'`);return this.lastListenerMetaData&&this.lastListenerMetaData.eventType===n?this.lastListenerMetaData.callback=t:this.resetListener(this.createListenerMetaData(n,t)),et}}),rf="onDomCreated",sf=yn(class extends Kt{element;constructor(e){super(e),ei(e,rf)}update(e,[t]){ei(e,rf);const n=e.element;return n!==this.element&&(window.requestAnimationFrame(()=>t(n)),this.element=n),this.render(t)}render(e){}}),Go="onResize",Tm=yn(class extends Kt{element;resizeObserver=new ResizeObserver(e=>this.fireCallback(e));callback;constructor(e){super(e),ei(e,Go)}fireCallback(e){const t=e[0];if(!t)throw console.error(e),new Error(`${Go} observation triggered but the first entry was empty.`);this.callback?.({target:t.target,contentRect:t.contentRect},this.element)}update(e,[t]){ei(e,Go),this.callback=t;const n=e.element,r=this.element;return n!==r&&(this.element=n,r&&this.resizeObserver.unobserve(r),this.resizeObserver.observe(n)),this.render(t)}render(e){}});function We(e,t,n){return CD(e,()=>t,()=>n)}const{attributeDirective:KD}=zD("data-test-id"),Lr=KD;ne({assign:"",assignedInputs:"",cssVars:"",elementOptions:"",events:"",hostClasses:"",init:"",inputsType:"",render:"",slotNames:"",stateInitStatic:"",stateType:"",styles:"",tagName:"",updateStateType:""});function ZD(e){return{[ws]:e}}function Mm(e){const{assertInputs:t,transformInputs:n}={assertInputs:e?.assertInputs??(()=>{}),transformInputs:e?.transformInputs??(r=>r)};return{defineElement:()=>r=>(t(r),vu()(n(r))),defineElementNoInputs:r=>(t(r),to(n(r)))}}function YD(e,t){return JD(void 0,e)}const JD=yn(class extends Kt{element;constructor(e){super(e),this.element=no(e,"assign")}render(e,t){return Sm(this.element,t),et}}),HD={};function QD(e,t){return t.map((n,r)=>{const i=e[r],s=e[r+1];if(i&&s){const{shouldHaveTagNameHere:o}=Nm(i,s);if(o&&$.isString(n))return{tagName:n,tagInterpolationKey:dh(HD,n,()=>({tagName:n}))}}return n})}function Nm(e,t){const n=e.trim().endsWith("<")&&!!t.match(/^[\s>]/),r=e.trim().endsWith("</")&&t.trim().startsWith(">");return{isOpeningTag:n,shouldHaveTagNameHere:n||r}}function XD(...[e,t,n]){const r=Hi(n)?n.definition:n,{isOpeningTag:i,shouldHaveTagNameHere:s}=Nm(e,t),o=yu(r);if(o&&s&&r.tagInterpolationKey)return{replacement:r.tagName,getExtraValues:void 0};if(s&&!o)throw console.error({lastNewString:e,currentTemplateString:t,currentValue:r}),new Error(`Got interpolated tag name but found no tag name on the given value: '${r?.tagName||r?.prototype?.constructor?.name||r?.constructor?.name}'`);if(!s||!o)return;if(i&&r.elementOptions&&!r.elementOptions.ignoreUnsetInputs&&!Hi(n))throw new Error(`Missing inputs for '${r.tagName}'`);return{replacement:r.tagName,getExtraValues(u){const l=Hi(u)?u.inputs:void 0;return[i&&l?YD(l):void 0].filter($.isTruthy)}}}function e5(e){}function t5(e){return Cm(e.strings,e.values,XD,e5)}function E(e,...t){const n=QD(e,t),r=jb(e,...n),i=$m(e,n,()=>t5(r));return{...r,strings:i.strings,values:i.values}}function xm(e){return Be(e,(t,n)=>n instanceof re?we(n.toString({format:"hex"})):xm(n))}const n5="dodgerblue";function ka(e){const t=Math.abs(e.contrast("white","APCA")),n=Math.abs(e.contrast("black","APCA"));return t>n?"white":"black"}function Ko({background:e,foreground:t}){return{background:e??new re(ka(t)),foreground:t??new re(ka(e))}}function r5(e){return e==="black"?"white":"black"}const i5={black:{foregroundFaint1:new re("#ccc"),foregroundFaint2:new re("#eee")},white:{foregroundFaint1:new re("#ccc"),foregroundFaint2:new re("#eee")}},s5={black:{backgroundFaint1:new re("#666"),backgroundFaint2:new re("#444")},white:{backgroundFaint1:new re("#ccc"),backgroundFaint2:new re("#fafafa")}};function of({themeColor:e=n5,themeStyle:t="light"}={}){const n=new re(e),r=new re(t==="dark"?"black":"white"),i=ka(r),s=new re(i),o={nav:{hover:Ko({background:n.clone().set({"hsl.l":93})}),active:Ko({background:n.clone().set({"hsl.l":90})}),selected:Ko({background:n.clone().set({"hsl.l":85})})},accent:{icon:n.clone().set({"hsl.l":40})},page:{background:r,...s5[r5(i)],foreground:s,...i5[i]}};return xm(o)}var _t=(e=>(e.Footer="book-footer",e.NavHeader="book-nav-header",e))(_t||{});async function Sa(e=1){const t=new Pf;function n(){requestAnimationFrame(()=>{e--,e?n():t.resolve()})}return n(),t.promise}function o5(e){return[...e.children,...e.shadowRoot?.children??[]]}function a5(e){return e.matches(":focus")}function ys(e){if(e instanceof ShadowRoot)return ys(e.host);const t=e.parentNode;if(t)return t instanceof Element?t:ys(t)}function Pm(e,t){if(t(e))return e;const n=ys(e);if(n)return Pm(n,t)}async function u5(e){return l5(e,1)}async function l5(e,t){return new Promise(n=>{new IntersectionObserver((i,s)=>{vr.isLengthAtLeast(i,1),s.disconnect(),n(i[0].intersectionRatio>=t)}).observe(e)})}function Ir(e,t,n={}){const r=n.useOriginalTarget?e.target:e.currentTarget;if(!(r instanceof t)){const i=t.name,s=r?.constructor.name,o=n.useOriginalTarget?`Current target from event '${e.type}' was not of type '${i}'. Got '${s}'.`:`Target from event '${e.type}' was not of type '${i}'. Got '${s}'.`;throw new Error(o)}return r}function c5(e){const t=ys(e);return t&&Pm(t,n=>globalThis.getComputedStyle(n).overflowY!=="visible")||document.body}const f5={a:window.HTMLAnchorElement,abbr:window.HTMLElement,address:window.HTMLElement,area:window.HTMLAreaElement,article:window.HTMLElement,aside:window.HTMLElement,audio:window.HTMLAudioElement,b:window.HTMLElement,base:window.HTMLBaseElement,bdi:window.HTMLElement,bdo:window.HTMLElement,blockquote:window.HTMLQuoteElement,body:window.HTMLBodyElement,br:window.HTMLBRElement,button:window.HTMLButtonElement,canvas:window.HTMLCanvasElement,caption:window.HTMLTableCaptionElement,cite:window.HTMLElement,code:window.HTMLElement,col:window.HTMLTableColElement,colgroup:window.HTMLTableColElement,data:window.HTMLDataElement,datalist:window.HTMLDataListElement,dd:window.HTMLElement,del:window.HTMLModElement,details:window.HTMLDetailsElement,dfn:window.HTMLElement,dialog:window.HTMLDialogElement,div:window.HTMLDivElement,dl:window.HTMLDListElement,dt:window.HTMLElement,em:window.HTMLElement,embed:window.HTMLEmbedElement,fieldset:window.HTMLFieldSetElement,figcaption:window.HTMLElement,figure:window.HTMLElement,footer:window.HTMLElement,form:window.HTMLFormElement,h1:window.HTMLHeadingElement,h2:window.HTMLHeadingElement,h3:window.HTMLHeadingElement,h4:window.HTMLHeadingElement,h5:window.HTMLHeadingElement,h6:window.HTMLHeadingElement,head:window.HTMLHeadElement,header:window.HTMLElement,hgroup:window.HTMLElement,hr:window.HTMLHRElement,html:window.HTMLHtmlElement,i:window.HTMLElement,iframe:window.HTMLIFrameElement,img:window.HTMLImageElement,input:window.HTMLInputElement,ins:window.HTMLModElement,kbd:window.HTMLElement,label:window.HTMLLabelElement,legend:window.HTMLLegendElement,li:window.HTMLLIElement,link:window.HTMLLinkElement,main:window.HTMLElement,map:window.HTMLMapElement,mark:window.HTMLElement,menu:window.HTMLMenuElement,meta:window.HTMLMetaElement,meter:window.HTMLMeterElement,nav:window.HTMLElement,noscript:window.HTMLElement,object:window.HTMLObjectElement,ol:window.HTMLOListElement,optgroup:window.HTMLOptGroupElement,option:window.HTMLOptionElement,output:window.HTMLOutputElement,p:window.HTMLParagraphElement,picture:window.HTMLPictureElement,pre:window.HTMLPreElement,progress:window.HTMLProgressElement,q:window.HTMLQuoteElement,rp:window.HTMLElement,rt:window.HTMLElement,ruby:window.HTMLElement,s:window.HTMLElement,samp:window.HTMLElement,script:window.HTMLScriptElement,search:window.HTMLElement,section:window.HTMLElement,select:window.HTMLSelectElement,slot:window.HTMLSlotElement,small:window.HTMLElement,source:window.HTMLSourceElement,span:window.HTMLSpanElement,strong:window.HTMLElement,style:window.HTMLStyleElement,sub:window.HTMLElement,summary:window.HTMLElement,sup:window.HTMLElement,table:window.HTMLTableElement,tbody:window.HTMLTableSectionElement,td:window.HTMLTableCellElement,template:window.HTMLTemplateElement,textarea:window.HTMLTextAreaElement,tfoot:window.HTMLTableSectionElement,th:window.HTMLTableCellElement,thead:window.HTMLTableSectionElement,time:window.HTMLTimeElement,title:window.HTMLTitleElement,tr:window.HTMLTableRowElement,track:window.HTMLTrackElement,u:window.HTMLElement,ul:window.HTMLUListElement,var:window.HTMLElement,video:window.HTMLVideoElement,wbr:window.HTMLElement},d5=Object.keys(f5),h5={annotation:window.MathMLElement,"annotation-xml":window.MathMLElement,maction:window.MathMLElement,math:window.MathMLElement,merror:window.MathMLElement,mfrac:window.MathMLElement,mi:window.MathMLElement,mmultiscripts:window.MathMLElement,mn:window.MathMLElement,mo:window.MathMLElement,mover:window.MathMLElement,mpadded:window.MathMLElement,mphantom:window.MathMLElement,mprescripts:window.MathMLElement,mroot:window.MathMLElement,mrow:window.MathMLElement,ms:window.MathMLElement,mspace:window.MathMLElement,msqrt:window.MathMLElement,mstyle:window.MathMLElement,msub:window.MathMLElement,msubsup:window.MathMLElement,msup:window.MathMLElement,mtable:window.MathMLElement,mtd:window.MathMLElement,mtext:window.MathMLElement,mtr:window.MathMLElement,munder:window.MathMLElement,munderover:window.MathMLElement,semantics:window.MathMLElement},m5=Object.keys(h5),p5={a:window.SVGAElement,animate:window.SVGAnimateElement,animateMotion:window.SVGAnimateMotionElement,animateTransform:window.SVGAnimateTransformElement,circle:window.SVGCircleElement,clipPath:window.SVGClipPathElement,defs:window.SVGDefsElement,desc:window.SVGDescElement,ellipse:window.SVGEllipseElement,feBlend:window.SVGFEBlendElement,feColorMatrix:window.SVGFEColorMatrixElement,feComponentTransfer:window.SVGFEComponentTransferElement,feComposite:window.SVGFECompositeElement,feConvolveMatrix:window.SVGFEConvolveMatrixElement,feDiffuseLighting:window.SVGFEDiffuseLightingElement,feDisplacementMap:window.SVGFEDisplacementMapElement,feDistantLight:window.SVGFEDistantLightElement,feDropShadow:window.SVGFEDropShadowElement,feFlood:window.SVGFEFloodElement,feFuncA:window.SVGFEFuncAElement,feFuncB:window.SVGFEFuncBElement,feFuncG:window.SVGFEFuncGElement,feFuncR:window.SVGFEFuncRElement,feGaussianBlur:window.SVGFEGaussianBlurElement,feImage:window.SVGFEImageElement,feMerge:window.SVGFEMergeElement,feMergeNode:window.SVGFEMergeNodeElement,feMorphology:window.SVGFEMorphologyElement,feOffset:window.SVGFEOffsetElement,fePointLight:window.SVGFEPointLightElement,feSpecularLighting:window.SVGFESpecularLightingElement,feSpotLight:window.SVGFESpotLightElement,feTile:window.SVGFETileElement,feTurbulence:window.SVGFETurbulenceElement,filter:window.SVGFilterElement,foreignObject:window.SVGForeignObjectElement,g:window.SVGGElement,image:window.SVGImageElement,line:window.SVGLineElement,linearGradient:window.SVGLinearGradientElement,marker:window.SVGMarkerElement,mask:window.SVGMaskElement,metadata:window.SVGMetadataElement,mpath:window.SVGMPathElement,path:window.SVGPathElement,pattern:window.SVGPatternElement,polygon:window.SVGPolygonElement,polyline:window.SVGPolylineElement,radialGradient:window.SVGRadialGradientElement,rect:window.SVGRectElement,script:window.SVGScriptElement,set:window.SVGSetElement,stop:window.SVGStopElement,style:window.SVGStyleElement,svg:window.SVGSVGElement,switch:window.SVGSwitchElement,symbol:window.SVGSymbolElement,text:window.SVGTextElement,textPath:window.SVGTextPathElement,title:window.SVGTitleElement,tspan:window.SVGTSpanElement,use:window.SVGUseElement,view:window.SVGViewElement},g5=Object.keys(p5);Array.from(new Set([...d5,...g5,...m5].sort()));function w5({searchQuery:e,searchIn:t}){const n=t.length,r=e.length;if(r>n)return!1;if(r===n)return e===t;const i=t.toLowerCase(),s=e.toLowerCase();e:for(let o=0,a=0;o<r;o++){const u=s.codePointAt(o);for(;a<n;)if(i.codePointAt(a++)===u)continue e;return!1}return!0}const y5=hh(32);function Qi(e){return e.join(y5)}function Bm(e){if(!e.length)return[];const t=Qi(e),n=Bm(e.slice(0,-1));return[t,...n]}const b5=["error","errors"];function v5(e){return b5.includes(e)}function E5({flattenedNodes:e,searchQuery:t}){const n={};function r(i){Object.values(i.children).map(o=>(r(o),Qi(o.fullUrlBreadcrumbs))).forEach(o=>n[o]=!0)}return e.forEach(i=>{const s=i.entry.errors.length&&v5(t),o=Qi(i.fullUrlBreadcrumbs);if(w5({searchIn:[i.entry.title,...i.entry.descriptionParagraphs].join(" ").toLowerCase(),searchQuery:t.toLowerCase()})||s||n[o]){const u=Bm(i.fullUrlBreadcrumbs);r(i),u.forEach(l=>n[l]=!0)}else n[o]=!1}),e.filter(i=>{const s=Qi(i.fullUrlBreadcrumbs),o=n[s];if(!$.isBoolean(o))throw new TypeError(`Failed to find '${i.fullUrlBreadcrumbs.join(" > ")}' in includeInSearchResults.`);return o})}class Eu extends Error{name="SpaRouterError"}class af extends Eu{name="GlobalUrlEventsConsolidationError"}class D5 extends Eu{name="SanitizationDepthMaxed"}At({paths:[""],search:ie(void 0,Ks({keys:"",values:[""],required:!1})),hash:ie(void 0,"")});const A5=At({basePath:ie("",void 0),sanitizeRoute:e=>e,maxListenerCount:ie(1,void 0),disableWarnings:ie(void 0,!1),isPaused:ie(!1,void 0)}),Zo="://";function Du(...e){const t=e.join("/"),[n,r=""]=t.includes(Zo)?t.split(Zo):["",t];let i=!1;const s=r.replace(/\/{2,}/g,"/").split("/").reduce((o,a,u,l)=>{if(i)return o;const f=l[u+1];let c=a;const m=f?.startsWith("?"),g=!a.includes("?")&&m,b=f==="?";if(m||g){i=!0;let v=!1;const C=l.slice(u+2).reduce((A,M)=>(M.includes("#")&&(v=!0),v?A.concat(M):[A,M].join("&")),"");c=[a,f,b?er({value:C,prefix:"&"}):C].join("")}return o.concat(c)},[]);return[n,n?Zo:"",s.join("/")].join("")}var mr;(function(e){e.Encode="encode",e.Decode="decode",e.None="none"})(mr||(mr={}));var pr;(function(e){e.Clear="clear",e.Replace="replace",e.Append="append"})(pr||(pr={}));const $5=At({encoding:ht(ie(void 0,Ea(mr))),searchParamStrategy:ht(ie(void 0,Ea(pr)))});function Ii(e,t){return e.map(n=>{if(n!=null)return nr(String(n),t)}).filter(n=>n!=null)}function nr(e,t){return t?.encoding===mr.Decode?decodeURIComponent(e):t?.encoding===mr.Encode?encodeURIComponent(e):e}const C5=At(Ks({keys:"",values:[""],required:!0}));function k5(e,t,n){const r=n?.searchParamStrategy===pr.Clear?{}:Be(e,(o,a)=>$.isString(a)?[a]:a),i=Be(t,(o,a)=>{if(n?.searchParamStrategy===pr.Append){const u=r[o],l=$.isArray(u)?u:[u];if(a){const f=$.isArray(a)?a:[a];return Ii([...l,...f],n)}else return Ii(l,n)}else return $.isArray(a)?Ii(a,n):a?Ii([a],n):void 0});return xs({...r,...i},(o,a)=>!!a)}function Lm(e,t){return $.isString(e)&&!e.includes("?")?{}:($.isString(e)?e:e instanceof URLSearchParams?e.toString():e.search).replace(/(^.*\?)|(#[^#]*$)/,"").split("&").map(s=>{const[o,...a]=qy(s,"=");return[o,a.length?a.join("="):void 0]}).reduce((s,[o,a])=>{const u=Im({options:t,key:o,value:a}),l=dh(s,u.key,()=>[]);return a!=null&&l.push(u.value),s},{})}function S5(e){if(e!=null)return $.isArray(e)?[...e]:e===""?[]:[e]}function F5(e,t){const n=Ns(Object.entries(e),([r,i])=>{const s=S5(i);return s?.length?s.map(o=>{const a=Im({options:t,key:r,value:o});return[a.key,a.value].join("=")}):[r]},(r,[,i])=>i!=null).flat();return n.length?Xe({value:n.join("&"),prefix:"?"}):""}function Im({options:e,key:t,value:n}){return{key:nr(t,e),value:nr(String(n),e)}}function Rm({hash:e,hostname:t,password:n,pathname:r,port:i,protocol:s,search:o,username:a}){return[s?s+"://":"",a?a+":":"",n?n+"@":"",ro({hostname:t,port:i}),Au({hash:e,pathname:r,search:o})].join("")}function Om({pathname:e}){const t=er({value:e,prefix:"/"});return t?t.split("/"):[]}function Au({hash:e,pathname:t,search:n}){return[Xe({value:t,prefix:"/"}),n?Xe({value:n,prefix:"?"}):"",e?Xe({value:e,prefix:"#"}):""].join("")}function ro({hostname:e,port:t}){return[e,t?":"+t:""].join("")}function Vm({hostname:e,port:t,protocol:n}){return[n,ro({hostname:e,port:t})].filter($.isTruthy).join("://")}function rr(e,t){const n=$.isString(e)?er({value:e,prefix:"."}):e.toString(),r=n.replace(/^[^#]*(?:#|$)/,""),i=r?Xe({value:nr(r,t),prefix:"#"}):"",s=n.replace(/#[^#]*$/,""),o=s.replace(/^[^?]*(?:\?|$)/,""),a=o?Xe({value:nr(o,t),prefix:"?"}):"",u=s.replace(/\?[^?]*$/,""),l=u.includes("://")?u.replace(/:\/\/.*$/,""):"",f=u.replace(/^.*:\/\//,"").replace(/\/\//g,"/"),c=f.replace(/@.*/,""),m=f.replace(/^[^@]*@/,""),g=c!==m,[b,...v]=g?c.split(":").reverse():[],C=v.toReversed().join("").replace(/[/:]/g,"")||"",A=b?.replace(/[/:]/g,"")||"",M=Wy(m.replace(/\/.*/,""),":",{caseSensitive:!0}).toReversed(),R=M[0]?.endsWith("]")?"":M[1]===":"&&M[0]||"",J=m.replace(new RegExp(`:${R}($|/)`),"$1").replace(/\/.*/,""),Me=m.replace(/^[^/]*(\/|$)/,"$1"),ct=nr(Me.replace(/^[^/]*(?:\/|$)/,"/"),t),Le=ro({hostname:J,port:R}),Ge=Vm({hostname:J,port:R,protocol:l}),$t=Rm({hash:i,hostname:J,password:A,pathname:ct,port:R,protocol:l,search:a,username:C}),Mt=Lm(a),yi=Om({pathname:ct});return{fullPath:Au({hash:i,pathname:ct,search:a}),hash:i,host:Le,hostname:J,href:$t,origin:Ge,password:A,pathname:ct,paths:yi,port:R,protocol:l,search:a,searchParams:Mt,username:C}}At({hash:ht(ie(void 0,"")),search:ht(ie(void 0,"",Ks({keys:"",required:!1,values:ie(null,void 0,"",-1,!1,0n)}))),hostname:ht(ie(void 0,"")),pathname:ht(ie(void 0,"")),paths:ht(ie(void 0,[""])),protocol:ht(ie(void 0,"")),username:ht(ie(void 0,"")),password:ht(ie(void 0,"")),port:ht(ie(void 0,"",-1))});function T5(e,t,n){const r=!!n,i=t==null||dm(t,$5),s=i?rr(""):$.instanceOf(e,URL)||$.isString(e)?rr(e):e,o=i?e:t,a=$.isString(o)&&o.startsWith("."),u=$.isString(o)||$.instanceOf(o,URL)?xs(rr(o),(v,C)=>$.isTruthy(C)):o,l=r?n:i?t:void 0,f=Be(s,(v,C)=>{if(!$.hasKey(u,v))return C;const A=u[v];return $.isNumber(A)?String(A):$.isString(A)?v==="hash"&&A?Xe({value:A,prefix:"#"}):v==="pathname"?Xe({value:A,prefix:"/"}):A:C});$.hasKey(u,"paths")&&u.paths&&(f.pathname=Du(a?s.pathname:"",...u.paths));const c=$.isString(u.search)?Lm(Xe({value:u.search,prefix:"?"})):ph(u.search||{}),m=k5(f.searchParams,c,{...l,encoding:mr.None}),g=F5(m,l);return{...f,searchParams:m,search:g,paths:Om(f),fullPath:Au(f),host:ro(f),origin:Vm(f),href:Rm({...f,search:g})}}const M5=At({protocol:"",username:"",password:"",host:"",hostname:"",port:"",origin:"",pathname:"/",paths:[""],search:"",searchParams:C5,hash:"",fullPath:"/",href:"/"});({...M5.defaultValue});const N5=0;function _m(e){return!(e.type!=="click"&&e.type!=="mousedown"||e.metaKey||e.altKey||e.ctrlKey||e.shiftKey||e.button!==N5)}const io="locationchange";globalThis.SPA_ROUTER_VIR_HISTORY_EVENTS_CONSOLIDATED_ALREADY=!1;const x5=globalThis.history.pushState;function uf(...e){const t=x5.apply(globalThis.history,e);return globalThis.dispatchEvent(new Event(io)),t}const P5=globalThis.history.replaceState;function lf(...e){const t=P5.apply(globalThis.history,e);return globalThis.dispatchEvent(new Event(io)),t}function B5(){if(!globalThis.SPA_ROUTER_VIR_HISTORY_EVENTS_CONSOLIDATED_ALREADY){{if(globalThis.history.pushState===uf)throw new af("The consolidation module thinks that window events have not been consolidated yet but globalThis.history.pushState has already been overridden. Does this module have two copies in your repo?");if(globalThis.history.replaceState===lf)throw new af("The consolidation module thinks that window events have not been consolidated yet but globalThis.history.replaceState has already been overridden. Does this module have two copies in your repo?")}globalThis.SPA_ROUTER_VIR_HISTORY_EVENTS_CONSOLIDATED_ALREADY=!0,globalThis.history.pushState=uf,globalThis.history.replaceState=lf,globalThis.addEventListener("popstate",()=>{globalThis.dispatchEvent(new Event(io))})}}function Ri(e,t){const n=rr(e),r=er({value:er({value:n.pathname,prefix:Xe({value:t||"",prefix:"/"})}),prefix:"/"}),i=r?r.split("/"):[],s=Object.keys(n.searchParams).length?n.searchParams:void 0,o=n.hash?er({value:n.hash,prefix:"#"}):void 0;return{paths:i,search:s,hash:o}}class L5{innerObservable;removeGlobalListener;sanitizationDepth=0;params;constructor(t){hm(t,A5),this.params={...t};const n=this.readCurrentRoute();this.innerObservable=new gm({defaultValue:n,equalityCheck:()=>!1}),B5(),this.removeGlobalListener=m0(globalThis,io,()=>{if(this.params.isPaused)return;if(this.sanitizationDepth>2)throw new D5("Looping route sanitization detected; aborting window URL change listener.");const r=Ri(globalThis.location.href,this.params.basePath),i=t.sanitizeRoute(r);$.jsonEquals(r,i)?(this.sanitizationDepth=0,this.innerObservable.setValue(i)):(this.sanitizationDepth++,this.setRoute(i,{replace:!0}),t.disableWarnings||console.warn("Route sanitized.",{from:r,to:i}))}),this.setRoute(n,{replace:!0})}routeIncludesBasePath(t){return!t.paths||!this.params.basePath?!1:Du(...t.paths).startsWith(this.params.basePath)}readCurrentRoute(){return this.sanitizeRoute(Ri(globalThis.location.href,this.params.basePath))}sanitizeRoute(t){return this.params.sanitizeRoute(t)}createRouteUrl(t){const n={...Ri(globalThis.location.href,this.params.basePath),...t},r=this.sanitizeRoute(n),s=this.routeIncludesBasePath(Ri(globalThis.location.href,void 0))&&!this.routeIncludesBasePath(r)&&this.params.basePath?{...r,paths:[this.params.basePath,...r.paths]}:r;return T5(globalThis.location.href,{paths:s.paths,search:s.search,hash:s.hash?Xe({value:s.hash,prefix:"#"}):"#"},{searchParamStrategy:pr.Clear}).href}setRoute(t,n={}){const r=this.createRouteUrl(t),{fullPath:i}=rr(r);return this.params.isPaused||!n.force&&$.jsonEquals(rr(globalThis.location.href).fullPath,i)?!1:n.replace?(globalThis.history.replaceState(void 0,"",i),!0):(globalThis.history.pushState(void 0,"",i),!0)}setRouteOnDirectNavigation(t,n){return _m(n)?(n.preventDefault(),this.setRoute(t)):!1}listen(t,n){const r=this.params.maxListenerCount==null?1:this.params.maxListenerCount;if(r&&this.innerObservable.getListenerCount()>=r)throw new Eu(`Attempting to attach more route listeners than the \`maxListenerCount\` of '${r}'.`);return this.innerObservable.listen(t,n),()=>this.removeListener(n)}removeListener(t){return this.innerObservable.removeListener(t)}getListenerCount(){return this.innerObservable.getListenerCount()}destroy(){this.params.isPaused=!0,this.removeGlobalListener(),this.innerObservable.destroy()}}function I5(e){return new L5({basePath:e,sanitizeRoute(t){return{paths:R5(t.paths),hash:void 0,search:void 0}}})}function R5(e){const t=e[0];if($.isEnumValue(t,pt)){if(t===pt.Book)return[pt.Book,...e.slice(1)];if(t===pt.Search)return e[1]?[t,e[1]]:[pt.Book,...e.slice(1)];throw new Error(`Route path not handled for sanitization: ${e.join("/")}`)}else return ur.paths}const bs=bu()("element-book-change-route"),cf="vira-",{defineElement:O5}=Mm({assertInputs:e=>{if(!e.tagName.startsWith(cf))throw new Error(`Tag name should start with '${cf}' but got '${e.tagName}'`)}}),Zt=O5,k=gn({"vira-icon-stroke-color":"currentColor","vira-icon-fill-color":"none","vira-icon-stroke-width":"1px"}),V5=re;function _5(e){try{if(!e)throw new Error("invalid empty color");return new V5(e)}catch{throw new Error(`Invalid color: ${h(e)}`)}}function de({name:e,svgTemplate:t}){return{name:e,svgTemplate:t}}function ff(e,t){const n=ne(t).map(r=>{const i=t[r],s=_5(i);return`${k[r].name}: ${s.toString()};`}).join(" ");return de({name:e.name,svgTemplate:E`
    ...
    `}),wt=gn({"vira-form-input-radius":"8px"}),so=T`
    pointer-events: none;
    opacity: 0.3;
    cursor: not-allowed;
`,bt=gn({"vira-extended-animation-duration":"1.2s","vira-pretty-animation-duration":"300ms","vira-interaction-animation-duration":"84ms"}),Ln=gn({"vira-focus-outline-color":"#59b1ff","vira-focus-outline-border-radius":T`calc(${wt["vira-form-input-radius"].value} + 4px)`});function $u({selector:e,elementBorderSize:t,outlineGap:n=2,outlineWidth:r=2}){const i=we(wh(r+n+t));return T`
        ${we(e)}::after {
            content: '';
            top: calc(${i} * -1);
            left: calc(${i} * -1);
    ...
    `}const an=gn({"vira-form-border-color":"#cccccc","vira-form-background-color":"white","vira-form-foreground-color":"black","vira-form-focus-color":Ln["vira-focus-outline-color"].value,"vira-form-selection-hover-background-color":"#d2eaff","vira-form-selection-hover-foreground-color":"black"}),U5=T`
    padding: 0;
    margin: 0;
`,sn=T`
    ${U5};
...
`,df=T`#e2e2e2`,Wm={menuShadow:T`
    ...
    user-select: none;
`,V=Zt()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>T`
        :host {
    ...
    `,render({inputs:e}){return e.icon?e.icon.svgTemplate:""}}),Vt=Zt()({tagName:"vira-dropdown-item",hostClasses:{"vira-dropdown-item-selected":({inputs:e})=>e.selected},styles:({hostClasses:e})=>T`
        :host {
            display: flex;
            ${ti};
        }
        ...
        */
        ...
        .dropdown-wrapper:not(.reverse-direction) .option:last-of-type {
            border-radius: 0 0 ${wt["vira-form-input-radius"].value}
                ${wt["vira-form-input-radius"].value};
        }

        .dropdown-wrapper.reverse-direction .option:first-of-type {
            border-radius: ${wt["vira-form-input-radius"].value}
                ${wt["vira-form-input-radius"].value} 0 0;
        }
    `,render({inputs:e}){return E`
        ...
        :host {
            ...
            background-color: ${an["vira-form-background-color"].value};
            border: 1px solid ${an["vira-form-border-color"].value};
            color: ${an["vira-form-foreground-color"].value};
            ${Wm.menuShadow}
        }
        ...
        ${Ma.css.selected(".dropdown-item:not(.disabled)")} {
            background-color: ${an["vira-form-selection-hover-background-color"].value};
            outline: none;
        }
    ...
    `,render({inputs:e,dispatch:t,events:n}){const r=e.options.map(i=>{const s=i.template||E`
                    <${Vt.assign({label:i.label,selected:e.selectedOptions.includes(i)})}></${Vt}>
                `;return E`
                <div
    ...
    `}),Ut=de({name:"Element24Icon",svgTemplate:E`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
...
`,ii=de({name:"LoaderAnimated24Icon",svgTemplate:E`
    ...
    `,events:{selectedChange:Dt(),openChange:Dt()},stateInitStatic:{showPopUpResult:void 0,popUpManager:ZD(()=>new EA),navController:void 0},cleanup({state:e,updateState:t}){t({showPopUpResult:void 0}),e.popUpManager.destroy()},init({state:e,updateState:t,host:n,inputs:r,dispatch:i,events:s}){e.popUpManager.listen(tp,()=>{if(t({showPopUpResult:void 0}),!r.isDisabled){const o=n.shadowRoot.querySelector(".dropdown-wrapper");vr.instanceOf(o,HTMLButtonElement,"failed to find dropdown wrapper child"),o.focus()}}),e.popUpManager.listen(np,o=>{const a=o.detail.x,u=r.options[a];if(!u)throw new Error(`Found no dropdown option at index '${a}'`);r.isMultiSelect||vf({emitEvent:!0,open:!1},{dispatch:l=>{i(new s.openChange(l))},host:n,popUpManager:e.popUpManager,updateState:t}),i(new s.selectedChange(bf(u.id,r.selected,!!r.isMultiSelect)))}),t({navController:new Zm(n)})},render({dispatch:e,events:t,state:n,inputs:r,updateState:i,host:s}){AA(r.options);function o(b){vf(b,{dispatch:v=>{e(new t.openChange(v))},host:s,popUpManager:n.popUpManager,updateState:i})}r.isDisabled?o({open:!1,emitEvent:!1}):r.z_debug_forceOpenState!=null&&(!r.z_debug_forceOpenState&&n.showPopUpResult?o({emitEvent:!1,open:!1}):r.z_debug_forceOpenState&&!n.showPopUpResult&&o({emitEvent:!1,open:!0}));const a=DA(r),u=r.icon?E`
        ...
        `}}),kn=vu()({tagName:"vira-bold",cssVars:{"vira-bold-bold-weight":"bold"},hostClasses:{"vira-bold-bold":({inputs:e})=>e.bold},styles:({hostClasses:e,cssVars:t})=>T`
        :host {
            position: relative;
        }
    ...
    `,render:({inputs:e})=>{const t=e.icon?E`
        ...
        `}}),Pt=Zt()({tagName:"vira-collapsible-wrapper",hostClasses:{"vira-collapsible-wrapper-expanded":({inputs:e})=>e.expanded},slotNames:["header"],styles:({hostClasses:e})=>T`
        :host {
            display: flex;
            flex-direction: column;
        }
    ...
    `,events:{expandChange:Dt()},stateInitStatic:{contentHeight:0},render({state:e,slotNames:t,updateState:n,dispatch:r,events:i,inputs:s}){const o=s.expanded?T`
        ...
        `}}),Qt=Zt()({tagName:"vira-image",hostClasses:{"vira-image-height-constrained":({inputs:e})=>e.dominantDimension==="height"},slotNames:["loading","error"],events:{imageLoad:Dt(),imageError:Dt()},styles:({hostClasses:e})=>T`
        :host {
            display: inline-flex;
            overflow: hidden;
            flex-direction: column;
    ...
    `,stateInitStatic:{loadedUrls:{},erroredUrls:{}},render({inputs:e,state:t,updateState:n,dispatch:r,events:i,slotNames:s}){const o=e.imageUrl,a=t.erroredUrls[o]?E`
            ...
            <img
                ...
                src=${o}
            />
        `}});function xa({input:e,matcher:t}){return!e||!t?!0:e.length>1?!!e.split("").every(n=>xa({input:n,matcher:t})):t instanceof RegExp?!!e.match(t):t.includes(e)}function $A({value:e,allowed:t,blocked:n}){const r=t?xa({input:e,matcher:t}):!0,i=n?xa({input:e,matcher:n}):!1;return r&&!i}function Pa(e){if(!e.value)return{filtered:e.value,blocked:""};const{filtered:t,blocked:n}=e.value.split("").reduce((r,i)=>($A({...e,value:i})?r.filtered.push(i):r.blocked.push(i),r),{filtered:[],blocked:[]});return{filtered:t.join(""),blocked:n.join("")}}function CA({inputs:e,previousValue:t,event:n,inputBlockedCallback:r,newValueCallback:i}){if(!(n instanceof InputEvent))throw new TypeError("Text input event was not an InputEvent.");const s=Ir(n,HTMLInputElement),o=n.data;if(o){const{blocked:u}=Pa({value:o,allowed:e.allowedInputs,blocked:e.blockedInputs});u.length&&r(u)}const a=Pa({value:s.value,allowed:e.allowedInputs,blocked:e.blockedInputs}).filtered;s.value!==a&&(s.value=a),t!==a&&i(a)}var ip=(e=>(e.Default="text",e.Password="password",e.Email="email",e))(ip||{});const he=Zt()({tagName:"vira-input",hostClasses:{"vira-input-disabled":({inputs:e})=>!!e.disabled,"vira-input-fit-text":({inputs:e})=>!!e.fitText,"vira-input-clear-button-shown":({inputs:e})=>!!e.showClearButton},cssVars:{"vira-input-background-color":"white","vira-input-placeholder-color":"#cccccc","vira-input-text-color":"#000000","vira-input-border-color":"#cccccc","vira-input-focus-border-color":Ln["vira-focus-outline-color"].default,"vira-input-text-selection-color":"#cfe9ff","vira-input-action-button-color":"#aaaaaa","vira-input-clear-button-hover-color":"#ff0000","vira-input-clear-button-active-color":"#b30000","vira-input-show-password-button-hover-color":"#0a89ff","vira-input-show-password-button-active-color":"#0261ba","vira-input-padding-horizontal":"10px","vira-input-padding-vertical":"6px"},events:{valueChange:Dt(),inputBlocked:Dt()},styles:({hostClasses:e,cssVars:t})=>T`
            :host {
                position: relative;
                display: inline-flex;
                width: 224px;
        ...
        `,stateInitStatic:{forcedInputWidth:0,showPassword:!1},render:({inputs:e,dispatch:t,state:n,updateState:r,events:i})=>{const{filtered:s}=Pa({value:e.value,allowed:e.allowedInputs,blocked:e.blockedInputs}),o=e.icon?E`
        ...
        `}});function kA(e,t){return e==="password"&&t?"text":e||"text"}const _i=Zt()({tagName:"vira-link",cssVars:{"vira-link-hover-color":"currentColor"},styles:({cssVars:e})=>T`
        :host {
            display: inline;
    ...
    `,render({inputs:e}){function t(n){e.route&&e.route.router.setRouteOnDirectNavigation(e.route.route,n)&&e.route.scrollToTop&&window.scrollTo(0,0)}if(e.link?.newTab)return E`
            ...
            `}}}),{defineElement:lt}=Mm(),st=lt()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>T`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,render:({inputs:e,dispatch:t})=>{const n=e.router?.createRouteUrl({...e.route})??"#";return E`
        ...
        `}});function SA(e,t){return e.entry.entryType===Te.Root?!1:e.entry.entryType===Te.Page||$.jsonEquals(t,e.fullUrlBreadcrumbs.slice(0,-1))?!0:$.jsonEquals(t?.slice(0,-1),e.fullUrlBreadcrumbs.slice(0,-1))}const It=lt()({tagName:"book-nav",cssVars:{"book-nav-internal-indent":"0"},styles:({cssVars:e})=>T`
        :host {
            display: flex;
            flex-direction: column;
            padding: 16px 0;
        ...
        .title-row {
            display: block;
            ${st.cssVars["book-route-link-anchor-padding"].name}: 1px 24px 1px calc(calc(16px * ${e["book-nav-internal-indent"].value}) + 8px);
        }
    ...
    `,render({inputs:e}){const t=e.flattenedNodes.map(n=>{if(!SA(n,e.selectedPath))return;const r=T`
            ...
            `;return E`
                <li style=${r}>
                    <${st.assign({router:e.router,route:{paths:[pt.Book,...n.fullUrlBreadcrumbs]}})}
            ...
            `});return E`
            <${st.assign({route:ur,router:e.router})}>
                <slot name=${_t.NavHeader}>Book</slot>
            </${st}>
            <ul>
                ${t}
            </ul>
        `}});async function FA(e){await Sa(2);const t=e.shadowRoot.querySelector(".selected");if(!t)throw new Error("Failed to find selected nav tree element.");await u5(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const pn=lt()({tagName:"book-error",styles:T`
        :host {
            display: flex;
            flex-direction: column;
            color: red;
    ...
    `,render({inputs:e}){return($.isArray(e.message)?e.message:[e.message]).map(n=>E`
                <p>${n}</p>
            `)}}),si=lt()({tagName:"book-page-controls",events:{controlValueChange:Dt()},hostClasses:{"book-page-controls-has-controls":({inputs:e})=>!!Object.keys(e.config).length},styles:({hostClasses:e})=>T`
        :host {
            display: flex;
            flex-wrap: wrap;
    ...
    `,render({inputs:e,dispatch:t,events:n}){return Object.entries(e.config).length?Object.entries(e.config).map(([r,i],s)=>{if(i.controlType===H.Hidden)return"";const o=TA(e.currentValues[r],i,a=>{const u=$.isArray(e.fullUrlBreadcrumbs)?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[r];if(!u)throw new Error(`Failed to find breadcrumbs from given control name: '${r}'`);t(new n.controlValueChange({fullUrlBreadcrumbs:u,newValues:{...e.currentValues,[r]:a}}))});return E`
        ...
        `}const Ef=lt()({tagName:"book-breadcrumbs",styles:T`
        :host {
            display: flex;
            color: #999;
        }
    ...
    `,render:({inputs:e})=>{const t=e.currentRoute.paths.slice(1);return t.length?t.map((n,r,i)=>{const s=r>=i.length-1,o=i.slice(0,r+1),a=s?"":E`
                  ...
                  `;return E`
                <${st.assign({route:{hash:void 0,search:void 0,paths:[pt.Book,...o]},router:e.router})}>
                    ${n}
                </${st}>
                ${a}
            `}):E`
                &nbsp;
            `}}),Yo=lt()({tagName:"book-breadcrumbs-bar",styles:T`
        :host {
    ...
    `,render({inputs:e,dispatch:t}){return E`
            ...
            <input
                ...
                ${te("input",async n=>{const r=n.currentTarget;if(!(r instanceof HTMLInputElement))throw new TypeError("Failed to find input element for search.");const i=r.value;await zr({milliseconds:200}),r.value===i&&(r.value?t(new bs({paths:[pt.Search,encodeURIComponent(r.value)]})):t(new bs(ur)))})}
            />
        `}}),Df=lt()({tagName:"book-entry-description",styles:T`
        :host {
            color: ${X["element-book-page-foreground-faint-level-1-color"].value};
            display: inline-flex;
            flex-direction: column;
    ...
    `,render({inputs:e}){return e.descriptionParagraphs.map(t=>E`
                <p>${t}</p>
            `)}}),Af=lt()({tagName:"book-page-wrapper",styles:T`
        :host {
            display: block;
        }
    ...
    `,render({inputs:e}){const t=e.isTopLevel?E`
              ...
              `,n=[pt.Book,...e.pageNode.fullUrlBreadcrumbs],r=e.pageNode.entry.errors.length?mh(e.pageNode.entry.errors):void 0;return r&&console.error(r),E`
            <div class="page-header block-entry">
                <div class="title-group">
                    <${st.assign({route:{paths:n,hash:void 0,search:void 0},router:e.router})}>
                        ${t}
                    </${st}>
                    ${r?E`
                              <${pn.assign({message:r.message})}></${pn}>
                          `:E`
        ...
        `}}),Ui=lt()({tagName:"book-element-example-controls",styles:T`
        :host {
            display: flex;
            color: ${X["element-book-page-foreground-faint-level-1-color"].value};
    ...
    `,render({inputs:e}){const t=[pt.Book,...e.elementExampleNode.fullUrlBreadcrumbs];return E`
        ...
        `}}),$f=Symbol("unset-internal-state"),Cf=lt()({tagName:"book-element-example-viewer",stateInitStatic:{isUnset:$f},render({state:e,inputs:t,updateState:n}){try{if(t.elementExampleNode.entry.errors.length)throw mh(t.elementExampleNode.entry.errors);if(!t.elementExampleNode.entry.render||typeof t.elementExampleNode.entry.render=="string")throw new Error(`Failed to render example '${t.elementExampleNode.entry.title}': render is not a function`);e.isUnset===$f&&n({isUnset:void 0,...t.elementExampleNode.entry.stateInitStatic});const r=t.elementExampleNode.entry.render({state:e,updateState:n,controls:t.currentPageControls});if(r instanceof Promise)throw new TypeError("render output cannot be a promise");return E`
            ...
            `}catch(r){return console.error("ERROR HERE",je(r)),console.error(r),E`
                <${pn.assign({message:`${t.elementExampleNode.entry.title} failed: ${je(r)}`})}></${pn}>
            `}},options:{allowPolymorphicState:!0}}),kf=lt()({tagName:"book-element-example-wrapper",styles:T`
        :host {
            display: inline-flex;
            flex-direction: column;
            gap: 24px;
    ...
    `,render({inputs:e}){return E`
        ...
        `}});function sp(e,t,n,r){const i=ca(n,r),s=[];if(i){const o=sp(e,t,i,r);o&&s.push(o)}if(tr(n,Te.Page)&&!e.includes(n)){const o=Xa(t,n.fullUrlBreadcrumbs);s.push({config:n.entry.controls,current:o,breadcrumbs:Be(o,()=>n.fullUrlBreadcrumbs)})}return s.reduce((o,a)=>({config:{...o.config,...a.config},current:{...o.current,...a.current},breadcrumbs:{...o.breadcrumbs,...a.breadcrumbs}}),{config:{},current:{},breadcrumbs:{}})}function MA({currentNodes:e,isTopLevel:t,router:n,isSearching:r,controls:i,originalTree:s}){if(!e.length&&r)return[E`
                No results
            `];const o=$.isLengthAtLeast(e,1)?sp(e,i,e[0],s):void 0,a=o&&Object.values(o.config).length&&$.isLengthAtLeast(e,1)?E`
              ...
              `:ce,u=qD(e,l=>l.fullUrlBreadcrumbs.join(">"),l=>{if(tr(l,Te.Page))return E`
                ...
                `}else return tr(l,Te.Root)?ce:E`
                    <${pn.assign({message:`Unknown entry type for rendering: '${l.entry.entryType}'`})}
                        class="block-entry"
                    ></${pn}>
                `});return[a,u]}const zn=lt()({tagName:"book-entry-display",styles:T`
        :host {
            display: flex;
            flex-direction: column;
            position: relative;
    ...
    `,events:{loadingRender:Dt()},stateInitStatic:{lastElement:void 0},render:({inputs:e,dispatch:t,events:n,state:r,updateState:i})=>{const s=fa(e.currentRoute.paths),o=MA({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!s,controls:e.controls,originalTree:e.originalTree});return E`
            ...
            ${We(e.showLoading,E`
                ...
                `,E`
                    ...
                    <slot name=${_t.Footer}></slot>
                `)}
        `}});function NA(e,t,n){const r=Sf(e,t);return r.length?r:(n(ur),Sf(e,ur.paths))}function Sf(e,t){return e.filter(n=>$b({searchFor:t.slice(1),searchIn:n.fullUrlBreadcrumbs}))}const Jo=vu()({tagName:"element-book-app",events:{pathUpdate:Dt()},stateInitStatic:{currentRoute:ur,router:void 0,loading:!0,colors:{config:void 0,theme:of(void 0)},treeBasedControls:void 0,originalWindowTitle:void 0},styles:T`
        :host {
            display: flex;
            flex-direction: column;
            height: 100%;
    ...
    `,init({host:e,state:t}){setTimeout(async()=>{await Ff(e,fa(t.currentRoute.paths),t.currentRoute)},500)},cleanup({state:e,updateState:t}){e.router&&(e.router.destroy(),t({router:void 0}))},render:({state:e,inputs:t,host:n,updateState:r,dispatch:i,events:s})=>{t._debug&&console.info("rendering element-book app");function o(f){return{...e.currentRoute,...f}}function a(f){const c=o(f);return!$.jsonEquals(e.currentRoute,c)}function u(f){t.preventWindowTitleChange||(e.originalWindowTitle||r({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,f].filter($.isTruthy).join(" - "))}function l(f){if(!a(f))return;const c=o(f);e.router?e.router.setRoute(c):r({currentRoute:{...e.currentRoute,...c}}),t.elementBookRoutePaths&&!$.jsonEquals(t.elementBookRoutePaths,e.currentRoute.paths)&&i(new s.pathUpdate(c.paths))}try{if(t.elementBookRoutePaths&&!$.jsonEquals(t.elementBookRoutePaths,e.currentRoute.paths)&&l({paths:t.elementBookRoutePaths}),t.internalRouterConfig?.useInternalRouter&&!e.router){const A=I5(t.internalRouterConfig.basePath);r({router:A}),A.listen(!0,M=>{r({currentRoute:M})})}else!t.internalRouterConfig?.useInternalRouter&&e.router&&e.router.destroy();const f={themeColor:t.themeColor};if(!$.jsonEquals(f,e.colors.config)){const A=of(f);r({colors:{config:f,theme:A}}),rv(n,A)}const c=t._debug??!1,m=Tb({entries:t.pages,debug:c});(!e.treeBasedControls||e.treeBasedControls.pages!==t.pages||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),r({treeBasedControls:{pages:t.pages,lastGlobalInputs:t.globalValues??{},controls:y0(m.tree,{children:e.treeBasedControls?.controls.children,controls:t.globalValues})}}));const g=fa(e.currentRoute.paths),v=(g?E5({flattenedNodes:m.flattenedNodes,searchQuery:g}):void 0)??NA(m.flattenedNodes,e.currentRoute.paths,l);u(v[0]?.entry.title);const C=e.treeBasedControls?.controls;return C?(t._debug&&console.info({currentControls:C}),E`
                <div
                    class="root"
                    ${te(bs,async A=>{const M=A.detail;if(!a(M))return;if(r({loading:!0}),l(M),!(n.shadowRoot.querySelector(It.tagName)instanceof It))throw new TypeError(`Failed to find child '${It.tagName}'`);await Ff(n,g,e.currentRoute)})}
                ...
                >
                    <${It.assign({flattenedNodes:m.flattenedNodes,router:e.router,selectedPath:g?void 0:e.currentRoute.paths.slice(1)})}>
                        <slot
                            name=${_t.NavHeader}
                            slot=${_t.NavHeader}
                        ></slot>
        ...
        `},{title:"without a placeholder",inputs:{placeholder:void 0}},{title:"with a prefix",inputs:{selectionPrefix:"Pre:",selected:[1]}},{title:"with an icon",inputs:{icon:Ut}}],LA=ut({title:Rr.tagName,parent:Su,controls:{Selected:{controlType:H.Dropdown,initValue:"",options:["",...qr.map(e=>e.label)]},Prefix:{controlType:H.Text,initValue:""},"Force State":{controlType:H.Dropdown,options:["","force open","force closed"],initValue:""},"Multi Select":{controlType:H.Dropdown,options:["","all","none"],initValue:""},Icon:{controlType:H.Dropdown,initValue:"",options:["",...Object.keys(Na)]},Disabled:{controlType:H.Dropdown,options:["","all","none"],initValue:""},Placeholder:{controlType:H.Text,initValue:"Select something"}},defineExamples({defineExample:e}){BA.forEach(t=>{e({title:t.title,stateInitStatic:{selected:t.inputs?.selected||[]},styles:t.customStyle,render({state:n,updateState:r,controls:i}){const s={placeholder:t.inputs&&"placeholder"in t.inputs?t.inputs.placeholder:i.Placeholder,options:t.inputs?.options||qr,selected:i.Selected?[qr.find(o=>o.label===i.Selected)?.id].filter($.isTruthy):n.selected,selectionPrefix:i.Prefix||t.inputs?.selectionPrefix,isDisabled:i.Disabled?i.Disabled==="all":t.inputs?.isDisabled,icon:i.Icon?Na[i.Icon]:t.inputs?.icon,isMultiSelect:i["Multi Select"]?i["Multi Select"]==="all":t.inputs?.isMultiSelect,z_debug_forceOpenState:i["Force State"]?i["Force State"]==="force open":t.inputs?.z_debug_forceOpenState};return E`
            ...
            `,stateInitStatic:{expandedStates:[],showMoreStates:[]},render({updateState:t,state:n}){return new Array(3).fill(0).map((r,i)=>E`
                    ...
                    `)}})}}),_A=ut({title:V.tagName,parent:Yt,descriptionParagraphs:["See the 'Icons' page for a list of all included icons."],defineExamples({defineExample:e}){e({title:"basic",render(){return E`
                    <${V.assign({icon:Ut})}></${V}>
                `}}),e({title:"using createColoredIcon",render(){return E`
                    <${V.assign({icon:ff(Ut,{"vira-icon-stroke-color":"red"})})}></${V}>
            ...
            `,render(){return E`
                ...
                `,stateInitStatic:{imageUrl:n.inputs.imageUrl},render({state:r,updateState:i}){return E`
                        <${Qt.assign({...n.inputs,imageUrl:r.imageUrl})}
...
`);return E`
                ...
                `,inputs:{value:"",placeholder:"width",icon:Ut}},{title:"taller height",styles:T`
                    ${he} {
                        height: 48px;
                    }
                `,inputs:{value:"",placeholder:"taller",icon:Ut}},{title:"shorter height",styles:T`
                    ${he} {
                        height: 26px;
                    }
                `,inputs:{value:"",placeholder:"shorter",showClearButton:!0,icon:Ut}},{title:"max width",styles:T`
                    ${he} {
                        max-width: 150px;
                    }
