 ...
 */function vw(e){return typeof Symbol<"u"&&typeof e=="object"&&typeof Symbol.iterator<"u"&&typeof e[Symbol.iterator]=="function"}/*!
 * Gets all iterator entries from the given Object. If the Object has no @@iterator function, returns an empty array.
 * This will consume the iterator - which could have side effects depending on the @@iterator implementation.
 *
 * @param {Object} target
 * @returns {Array} an array of entries from the @@iterator function
 */function al(e){if(vw(e))try{return Ko(e[Symbol.iterator]())}catch{return[]}return[]}/*!
 ...
 * @param {Object} [options] (Optional)
 * @return {Boolean} result
 */function Dw(e,t,n){var r=ul(e),i=ul(t),s=ll(e),o=ll(t);if(r=r.concat(s),i=i.concat(o),r.length&&r.length===i.length)return wn(cl(r).sort(),cl(i).sort())===!1?!1:xd(e,t,r,n);var a=al(e),u=al(t);return a.length&&a.length===u.length?(a.sort(),u.sort(),wn(a,u,n)):r.length===0&&a.length===0&&i.length===0&&u.length===0}/*!
...
${m(t)}.`,n);return e},isEmpty(e,t){if(typeof e!="string"&&typeof e!="object")throw new h(`'${m(e)}' is not empty.`,t);if(typeof e=="string"&&!e){if(!e)return e}else if(Array.isArray(e)){if(!e.length)return e}else if(e instanceof Map||e instanceof Set){if(!e.size)return e}else if(typeof e=="object"&&!Object.keys(e).length)return e;throw new h(`'${m(e)}' is not empty.`,t)},isNotEmpty(e,t){if(typeof e!="string"&&typeof e!="object")return e;if(typeof e=="string"&&!e){if(!e)throw new h(`'${m(e)}' is empty.`,t)}else if(Array.isArray(e)){if(!e.length)throw new h(`'${m(e)}' is empty.`,t)}else if(e instanceof Map||e instanceof Set){if(!e.size)throw new h(`'${m(e)}' is empty.`,t)}else if(typeof e=="object"&&!Object.keys(e).length)throw new h(`'${m(e)}' is empty.`,t);return e}},checkWrap:{hasValue(e,t){if(_e(e,t))return e},lacksValue(e,t){if(!_e(e,t))return e},hasValues(e,t){if(t.every(n=>_e(e,n)))return e},lacksValues(e,t){if(!t.every(n=>_e(e,n)))return e},isIn(e,t){if(Je(e,t))return e},isNotIn(e,t){if(!Je(e,t))return e},isEmpty(e){if(!(typeof e!="string"&&typeof e!="object")){if(typeof e=="string"){if(!e)return e}else if(Array.isArray(e)){if(!e.length)return e}else if(e instanceof Map||e instanceof Set){if(!e.size)return e}else if(typeof e=="object"&&!Object.keys(e).length)return e}},isNotEmpty(e){if(typeof e!="string"&&typeof e!="object")return e;if(typeof e=="string"){if(!e)return}else if(Array.isArray(e)){if(!e.length)return}else if(e instanceof Map||e instanceof Set){if(!e.size)return}else if(typeof e=="object"&&!Object.keys(e).length)return;return e}},waitUntil:{hasValue:k(Et.hasValue),lacksValue:k(Et.lacksValue),hasValues:k(Et.hasValues),lacksValues:k(Et.lacksValues),isIn:k(Et.isIn),isNotIn:k(Et.isNotIn),isEmpty:k(Et.isEmpty),isNotEmpty:k(Et.isNotEmpty)}},lo={isHttpStatus(e,t){if(!Dt(e,b))throw new h(`${m(e)} is not a valid HTTP status.`,t)},isHttpStatusCategory(e,t,n){if(Dt(e,b)){if(!Je(e,Fi[t]))throw new h(`${m(e)} is not a '${t}' HTTP status.`,n)}else throw new h(`${m(e)} is not a valid HTTP status.`,n)}},Id={assert:lo,check:{isHttpStatus(e){return Dt(e,b)},isHttpStatusCategory(e,t){return Dt(e,b)&&Je(e,Fi[t])}},assertWrap:{isHttpStatus(e,t){if(!Dt(e,b))throw new h(`${m(e)} is not a valid HTTP status.`,t);return e},isHttpStatusCategory(e,t,n){if(Dt(e,b)){if(!Je(e,Fi[t]))throw new h(`${m(e)} is not a '${t}' HTTP status.`,n)}else throw new h(`${m(e)} is not a valid HTTP status.`,n);return e}},checkWrap:{isHttpStatus(e){if(Dt(e,b))return e},isHttpStatusCategory(e,t){if(Dt(e,b)&&Je(e,Fi[t]))return e}},waitUntil:{isHttpStatus:k(lo.isHttpStatus),isHttpStatusCategory:k(lo.isHttpStatusCategory)}},co={instanceOf(e,t,n){if(!(e instanceof t))throw new h(`'${m(e)}' is not an instance of '${t.name}'`,n)},notInstanceOf(e,t,n){if(e instanceof t)throw new h(`'${m(e)}' is an instance of '${t.name}'`,n)}},Rd={assert:co,check:{instanceOf(e,t){return e instanceof t},notInstanceOf(e,t){return!(e instanceof t)}},assertWrap:{instanceOf(e,t,n){if(e instanceof t)return e;throw new h(`'${m(e)}' is not an instance of '${t.name}'`,n)},notInstanceOf(e,t,n){if(e instanceof t)throw new h(`'${m(e)}' is an instance of '${t.name}'`,n);return e}},checkWrap:{instanceOf(e,t){if(e instanceof t)return e},notInstanceOf(e,t){if(!(e instanceof t))return e}},waitUntil:{instanceOf:k(co.instanceOf),notInstanceOf:k(co.notInstanceOf)}},Aw=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function ee(e,t){return Aw.some(n=>{try{return n(e,t)}catch{return!1}})}const un={isKeyOf(e,t,n){if(!ee(t,e))throw new h(`'${String(e)}' is not a key of '${m(t)}'.`,n)},isNotKeyOf(e,t,n){if(ee(t,e))throw new h(`'${String(e)}' is a key of '${m(t)}'.`,n)},hasKey(e,t,n){if(!ee(e,t))throw new h(`'${m(e)}' does not have key '${String(t)}'.`,n)},lacksKey(e,t,n){if(ee(e,t))throw new h(`'${m(e)}' has key '${String(t)}'.`,n)},hasKeys(e,t,n){const r=t.filter(i=>!ee(e,i));if(r.length)throw new h(`'${m(e)}' does not have keys '${r.join(",")}'.`,n)},lacksKeys(e,t,n){const r=t.filter(i=>ee(e,i));if(r.length)throw new h(`'${m(e)}' does not lack keys '${r.join(",")}'.`,n)}},Od={assert:un,check:{isKeyOf(e,t){return ee(t,e)},isNotKeyOf(e,t){return!ee(t,e)},hasKey:ee,lacksKey(e,t){return!ee(e,t)},hasKeys(e,t){return t.every(n=>ee(e,n))},lacksKeys(e,t){return t.every(n=>!ee(e,n))}},assertWrap:{isKeyOf(e,t,n){if(!ee(t,e))throw new h(`'${String(e)}' is not a key of '${m(t)}'.`,n);return e},isNotKeyOf(e,t,n){if(ee(t,e))throw new h(`'${String(e)}' is a key of '${m(t)}'.`,n);return e},hasKey(e,t,n){if(!ee(e,t))throw new h(`'${m(e)}' does not have key '${String(t)}'.`,n);return e},lacksKey(e,t,n){if(ee(e,t))throw new h(`'${m(e)}' has key '${String(t)}'.`,n);return e},hasKeys(e,t,n){const r=t.filter(i=>!ee(e,i));if(r.length)throw new h(`'${m(e)}' does not have keys '${r.join(",")}'.`,n);return e},lacksKeys(e,t,n){const r=t.filter(i=>ee(e,i));if(r.length)throw new h(`'${m(e)}' does not lack keys '${r.join(",")}'.`,n);return e}},checkWrap:{isKeyOf(e,t){if(ee(t,e))return e},isNotKeyOf(e,t){if(!ee(t,e))return e},hasKey(e,t){if(ee(e,t))return e},lacksKey(e,t){if(!ee(e,t))return e},hasKeys(e,t){if(t.every(n=>ee(e,n)))return e},lacksKeys(e,t){if(t.every(n=>!ee(e,n)))return e}},waitUntil:{isKeyOf:k(un.isKeyOf),isNotKeyOf:k(un.isNotKeyOf),hasKey:k(un.hasKey),lacksKey:k(un.lacksKey),hasKeys:k(un.hasKeys),lacksKeys:k(un.lacksKeys)}};function $w(e,t,n){if((Array.isArray(e)||typeof e=="string"?e.length:J(e).length)<t)throw new h(`Length '${e.length}' is not at least '${t}'.`,n)}function Cw(e,t,n){if((Array.isArray(e)||typeof e=="string"?e.length:J(e).length)!==t)throw new h(`Length '${e.length}' is not exactly '${t}'.`,n)}const fo={isLengthAtLeast:$w,isLengthExactly:Cw},_d={assert:fo,check:{isLengthAtLeast:(e,t)=>(Array.isArray(e)||typeof e=="string"?e.length:J(e).length)>=t,isLengthExactly:(e,t)=>(Array.isArray(e)||typeof e=="string"?e.length:J(e).length)===t},assertWrap:{isLengthAtLeast:(e,t,n)=>{if((Array.isArray(e)||typeof e=="string"?e.length:J(e).length)<t)throw new h(`Length '${e.length}' is not at least '${t}'.`,n);return e},isLengthExactly:(e,t,n)=>{if((Array.isArray(e)||typeof e=="string"?e.length:J(e).length)!==t)throw new h(`Length '${e.length}' is not exactly '${t}'.`,n);return e}},checkWrap:{isLengthAtLeast:(e,t)=>{if((Array.isArray(e)||typeof e=="string"?e.length:J(e).length)>=t)return e},isLengthExactly:(e,t)=>{if((Array.isArray(e)||typeof e=="string"?e.length:J(e).length)===t)return e}},waitUntil:{isLengthAtLeast:k(fo.isLengthAtLeast),isLengthExactly:k(fo.isLengthExactly)}},ho={isDefined(e,t){if(e==null)throw new h(`'${m(e)}' is not defined.`,t)},isNullish(e,t){if(e!=null)throw new h(`'${m(e)}' is not a nullish.`,t)}},Vd={assert:ho,check:{isDefined(e){return e!=null},isNullish(e){return e==null}},assertWrap:{isDefined(e,t){if(e==null)throw new h(`'${m(e)}' is not defined.`,t);return e},isNullish(e,t){if(e==null)return e;throw new h(`'${m(e)}' is not nullish.`,t)}},checkWrap:{isDefined:void 0,isNullish:void 0},waitUntil:{isDefined:k(ho.isDefined),isNullish:k(ho.isNullish)}},Se={isInBounds(e,{max:t,min:n},r){if(e<n||t<e)throw new h(`${e} is not within the bounds ${m({min:n,max:t})}`,r)},isOutBounds(e,{min:t,max:n},r){if(t<=e&&e<=n)throw new h(`${e} is not outside the bounds ${m({min:t,max:n})}`,r)},isInteger(e,t){if(typeof e!="number"||isNaN(e)||!Number.isInteger(e))throw new h(`${e} is not an integer.`,t)},isNotInteger(e,t){if(Number.isInteger(e))throw new h(`${e} is an integer.`,t)},isAbove(e,t,n){if(e<=t)throw new h(`${e} is not above ${t}`,n)},isAtLeast(e,t,n){if(e<t)throw new h(`${e} is not at least ${t}`,n)},isBelow(e,t,n){if(e>=t)throw new h(`${e} is not below ${t}`,n)},isAtMost(e,t,n){if(e>t)throw new h(`${e} is not at most ${t}`,n)},isNaN(e,t){if(!isNaN(e))throw new h(`${e} is not NaN`,t)},isFinite(e,t){if(isNaN(e)||e===1/0||e===-1/0)throw new h(`${e} is not finite`,t)},isInfinite(e,t){if(e!==1/0&&e!==-1/0)throw new h(`${e} is not infinite`,t)},isApproximately(e,t,n,r){if(e<t-n||e>t+n)throw new h(`${e} is not within ±${n} of ${t}`,r)},isNotApproximately(e,t,n,r){if(e>=t-n&&e<=t+n)throw new h(`${e} is within ±${n} of ${t}`,r)}},Ud={assert:Se,check:{isInBounds(e,{max:t,min:n}){return n<=e&&e<=t},isOutBounds(e,{max:t,min:n}){return e<n||t<e},isInteger(e){return typeof e=="number"&&!isNaN(e)&&Number.isInteger(e)},isNotInteger(e){return typeof e!="number"||isNaN(e)||!Number.isInteger(e)},isAbove(e,t){return e>t},isAtLeast(e,t){return e>=t},isBelow(e,t){return e<t},isAtMost(e,t){return e<=t},isNaN(e){return isNaN(e)},isFinite(e){return!isNaN(e)&&e!==1/0&&e!==-1/0},isInfinite(e){return e===1/0||e===-1/0},isApproximately(e,t,n){return t-n<=e&&e<=t+n},isNotApproximately(e,t,n){return e<t-n||e>t+n}},assertWrap:{isInBounds(e,{max:t,min:n},r){if(e<n||t<e)throw new h(`${e} is not within the bounds ${m({min:n,max:t})}`,r);return e},isOutBounds(e,{min:t,max:n},r){if(t<=e&&e<=n)throw new h(`${e} is not outside the bounds ${m({min:t,max:n})}`,r);return e},isInteger(e,t){if(typeof e!="number"||isNaN(e)||!Number.isInteger(e))throw new h(`${e} is not an integer.`,t);return e},isNotInteger(e,t){if(Number.isInteger(e))throw new h(`${e} is an integer.`,t);return e},isAbove(e,t,n){if(e<=t)throw new h(`${e} is not above ${t}`,n);return e},isAtLeast(e,t,n){if(e<t)throw new h(`${e} is not at least ${t}`,n);return e},isBelow(e,t,n){if(e>=t)throw new h(`${e} is not below ${t}`,n);return e},isAtMost(e,t,n){if(e>t)throw new h(`${e} is not at most ${t}`,n);return e},isNaN(e,t){if(!isNaN(e))throw new h(`${e} is not NaN`,t);return e},isFinite(e,t){if(isNaN(e)||e===1/0||e===-1/0)throw new h(`${e} is not finite`,t);return e},isInfinite(e,t){if(e!==1/0&&e!==-1/0)throw new h(`${e} is not infinite`,t);return e},isApproximately(e,t,n,r){if(e<t-n||e>t+n)throw new h(`${e} is not within ±${n} of ${t}`,r);return e},isNotApproximately(e,t,n,r){if(e>=t-n&&e<=t+n)throw new h(`${e} is within ±${n} of ${t}`,r);return e}},checkWrap:{isInBounds(e,{max:t,min:n}){if(n<=e&&e<=t)return e},isOutBounds(e,{max:t,min:n}){if(e<n||t<e)return e},isInteger(e){if(typeof e=="number"&&!isNaN(e)&&Number.isInteger(e))return e},isNotInteger(e){if(typeof e!="number"||isNaN(e)||!Number.isInteger(e))return e},isAbove(e,t){if(e>t)return e},isAtLeast(e,t){if(e>=t)return e},isBelow(e,t){if(e<t)return e},isAtMost(e,t){if(e<=t)return e},isNaN(e){if(isNaN(e))return e},isFinite(e){if(!isNaN(e)&&e!==1/0&&e!==-1/0)return e},isInfinite(e){if(e===1/0||e===-1/0)return e},isApproximately(e,t,n){if(t-n<=e&&e<=t+n)return e},isNotApproximately(e,t,n){if(e<t-n||e>t+n)return e}},waitUntil:{isInBounds:k(Se.isInBounds),isOutBounds:k(Se.isOutBounds),isInteger:k(Se.isInteger),isNotInteger:k(Se.isNotInteger),isAbove:k(Se.isAbove),isAtLeast:k(Se.isAtLeast),isBelow:k(Se.isBelow),isAtMost:k(Se.isAtMost),isNaN:k(Se.isNaN),isFinite:k(Se.isFinite),isInfinite:k(Se.isInfinite),isApproximately:k(Se.isApproximately),isNotApproximately:k(Se.isNotApproximately)}};function kw(e,t,n,r,i){return Hr(...ds(e,t,n,r,i),!1)}function ds(e,t,n,r,i){const s=Array.isArray(n);return[s?e:Bd,s?t:e,s?n:t,s?r:n,s?i:r]}function Hr(e,t,n,r,i,s){const o=t(...n);if(o instanceof Promise)return new Promise(async(a,u)=>{try{const l=await o;e(l,r),s?a(l):a()}catch(l){u(new h(`Output from '${t.name}' did not produce expected output with input: ${m(n)}: ${Ce(l)}`,i))}});try{return e(o,r),s?o:void 0}catch(a){throw new h(`Output from '${t.name}' did not produce expected output with input: ${m(n)}: ${Ce(a)}`,i)}}function Sw(e,t,n,r,i){try{const s=Hr(...ds(e,t,n,r,i),!1);return s instanceof Promise?new Promise(async o=>{try{await s,o(!0)}catch{o(!1)}}):!0}catch{return!1}}function Fw(e,t,n,r,i){return Hr(...ds(e,t,n,r,i),!0)}function Tw(e,t,n,r,i){try{const s=Hr(...ds(e,t,n,r,i),!0);return s instanceof Promise?new Promise(async o=>{try{o(await s)}catch{o(void 0)}}):s}catch{return}}const mo=Symbol("not set");async function Mw(e,t,n,r,i,s){const o=Array.isArray(n),a=o?e:Bd,u=o?t:e,l=o?n:t,f=o?r:n,c=Ad(o?i:r),d=o?s:i,p=lt(c.timeout,{milliseconds:!0}).milliseconds,y=lt(c.interval,{milliseconds:!0});let v=mo,C;async function A(){try{v=await Hr(a,u,l,f,void 0,!0)}catch(I){v=mo,C=Pe(I)}}const T=Date.now();for(;v===mo;)if(await A(),await Fr(y),Date.now()-T>=p)throw Gr(C,zr(d,`Timeout of '${p}' milliseconds exceeded waiting for callback value to match expectations`));return v}const Nw={output:kw},Wd={assert:Nw,check:{output:Sw},assertWrap:{output:Fw},checkWrap:{output:Tw},waitUntil:{output:Mw}},fr={isPropertyKey(e,t){if(typeof e!="string"&&typeof e!="number"&&typeof e!="symbol")throw new h(`'${m(e)}' is not a PropertyKey.`,t)},isNotPropertyKey(e,t){if(typeof e=="string"||typeof e=="number"||typeof e=="symbol")throw new h(`'${m(e)}' is a PropertyKey.`,t)},isPrimitive(e,t){if(e!==null&&(typeof e=="object"||typeof e=="function"))throw new h(`'${m(e)}' is not a Primitive.`,t)},isNotPrimitive(e,t){if(e===null||typeof e!="object"&&typeof e!="function")throw new h(`'${m(e)}' is not a Primitive.`,t)}},qd={assert:fr,check:{isNotPrimitive(e){return e!==null&&(typeof e=="object"||typeof e=="function")},isNotPropertyKey(e){return typeof e!="string"&&typeof e!="number"&&typeof e!="symbol"},isPrimitive(e){return e===null||typeof e!="object"&&typeof e!="function"},isPropertyKey(e){return typeof e=="string"||typeof e=="number"||typeof e=="symbol"}},assertWrap:{isNotPrimitive(e,t){if(e===null||typeof e!="object"&&typeof e!="function")throw new h(`'${m(e)}' is not a Primitive.`,t);return e},isNotPropertyKey(e,t){if(typeof e=="string"||typeof e=="number"||typeof e=="symbol")throw new h(`'${m(e)}' is a PropertyKey.`,t);return e},isPrimitive(e,t){if(e!==null&&(typeof e=="object"||typeof e=="function"))throw new h(`'${m(e)}' is not a Primitive.`,t);return e},isPropertyKey(e,t){if(typeof e!="string"&&typeof e!="number"&&typeof e!="symbol")throw new h(`'${m(e)}' is not a PropertyKey.`,t);return e}},checkWrap:{isNotPrimitive(e){if(e!==null&&(typeof e=="object"||typeof e=="function"))return e},isNotPropertyKey(e){if(typeof e!="string"&&typeof e!="number"&&typeof e!="symbol")return e},isPrimitive(e){if(e===null||typeof e!="object"&&typeof e!="function")return e},isPropertyKey(e){if(typeof e=="string"||typeof e=="number"||typeof e=="symbol")return e}},waitUntil:{isNotPrimitive:k(fr.isNotPrimitive),isNotPropertyKey:k(fr.isNotPropertyKey),isPrimitive:k(fr.isPrimitive),isPropertyKey:k(fr.isPropertyKey)}},dr={isPromiseLike(e,t){if(!(e instanceof Promise)&&!(e&&typeof e=="object"&&"then"in e&&typeof e.then=="function"))throw new h(`'${m(e)}' is not a PromiseLike.`,t)},isNotPromiseLike(e,t){if(e instanceof Promise||e&&typeof e=="object"&&"then"in e&&typeof e.then=="function")throw new h(`'${m(e)}' is a PromiseLike.`,t)},isPromise(e,t){if(!(e instanceof Promise))throw new h(`'${m(e)}' is not a Promise.`,t)},isNotPromise(e,t){if(e instanceof Promise)throw new h(`'${m(e)}' is a Promise.`,t)}},jd={assert:dr,check:{isPromiseLike(e){return!!(e instanceof Promise||e&&typeof e=="object"&&"then"in e&&typeof e.then=="function")},isNotPromiseLike(e){return!(e instanceof Promise||e&&typeof e=="object"&&"then"in e&&typeof e.then=="function")},isPromise(e){return e instanceof Promise},isNotPromise(e){return!(e instanceof Promise)}},assertWrap:{isPromiseLike(e,t){if(!(e instanceof Promise)&&!(e&&typeof e=="object"&&"then"in e&&typeof e.then=="function"))throw new h(`'${m(e)}' is not a PromiseLike.`,t);return e},isNotPromiseLike(e,t){if(e instanceof Promise||e&&typeof e=="object"&&"then"in e&&typeof e.then=="function")throw new h(`'${m(e)}' is a PromiseLike.`,t);return e},isPromise(e,t){if(!(e instanceof Promise))throw new h(`'${m(e)}' is not a Promise.`,t);return e},isNotPromise(e,t){if(e instanceof Promise)throw new h(`'${m(e)}' is a Promise.`,t);return e}},checkWrap:{isPromiseLike(e){if(e instanceof Promise||e&&typeof e=="object"&&"then"in e&&typeof e.then=="function")return e},isNotPromiseLike(e){if(!(e instanceof Promise||e&&typeof e=="object"&&"then"in e&&typeof e.then=="function"))return e},isPromise(e){if(e instanceof Promise)return e},isNotPromise(e){if(!(e instanceof Promise))return e}},waitUntil:{isPromiseLike:k(dr.isPromiseLike,!0),isNotPromiseLike:k(dr.isNotPromiseLike,!0),isPromise:k(dr.isPromise,!0),isNotPromise:k(dr.isNotPromise,!0)}},po={matches(e,t,n){if(!t.test(e))throw new h(`'${e}' does not match ${t}`,n)},mismatches(e,t,n){if(t.test(e))throw new h(`'${e}' matches ${t}`,n)}},zd={assert:po,check:{matches(e,t){return!!t.test(e)},mismatches(e,t){return!t.test(e)}},assertWrap:{matches(e,t,n){if(!t.test(e))throw new h(`'${e}' does not match ${t}`,n);return e},mismatches(e,t,n){if(t.test(e))throw new h(`'${e}' matches ${t}`,n);return e}},checkWrap:{matches(e,t){if(t.test(e))return e},mismatches(e,t){if(!t.test(e))return e}},waitUntil:{matches:k(po.matches,!0),mismatches:k(po.mismatches,!0)}},ue={isArray(e,t){if(!Array.isArray(e))throw new h(`'${m(e)}' is not an array.`,t)},isBigInt(e,t){if(typeof e!="bigint")throw new h(`'${m(e)}' is not a bigint.`,t)},isBoolean(e,t){if(typeof e!="boolean")throw new h(`'${m(e)}' is not a boolean.`,t)},isFunction(e,t){if(typeof e!="function")throw new h(`'${m(e)}' is not a function.`,t)},isNull(e,t){if(e!==null)throw new h(`'${m(e)}' is not nul.`,t)},isNumber(e,t){if(typeof e!="number"||isNaN(e))throw new h(`'${m(e)}' is not a number.`,t)},isObject(e,t){if(Array.isArray(e)||typeof e!="object"||!e)throw new h(`'${m(e)}' is not a non-null object.`,t)},isString(e,t){if(typeof e!="string")throw new h(`'${m(e)}' is not a string.`,t)},isSymbol(e,t){if(typeof e!="symbol")throw new h(`'${m(e)}' is not a symbol.`,t)},isUndefined(e,t){if(typeof e<"u")throw new h(`'${m(e)}' is not a undefined.`,t)},isNotArray(e,t){if(Array.isArray(e))throw new h(`'${m(e)}' is an array.`,t)},isNotBigInt(e,t){if(typeof e=="bigint")throw new h(`'${m(e)}' is a bigint.`,t)},isNotBoolean(e,t){if(typeof e=="boolean")throw new h(`'${m(e)}' is a boolean.`,t)},isNotFunction(e,t){if(typeof e=="function")throw new h(`'${m(e)}' is a function.`,t)},isNotNull(e,t){if(e===null)throw new h(`'${m(e)}' is a null.`,t)},isNotNumber(e,t){if(typeof e=="number")throw new h(`'${m(e)}' is a number.`,t)},isNotObject(e,t){if(!Array.isArray(e)&&typeof e=="object"&&e)throw new h(`'${m(e)}' is a non-null object.`,t)},isNotString(e,t){if(typeof e=="string")throw new h(`'${m(e)}' is a string.`,t)},isNotSymbol(e,t){if(typeof e=="symbol")throw new h(`'${m(e)}' is a symbol.`,t)},isNotUndefined(e,t){if(typeof e>"u")throw new h(`'${m(e)}' is a undefined.`,t)}},Gd={assert:ue,check:{isArray(e){return Array.isArray(e)},isBigInt(e){return typeof e=="bigint"},isBoolean(e){return typeof e=="boolean"},isFunction(e){return typeof e=="function"},isNull(e){return e===null},isNumber(e){return typeof e=="number"},isObject(e){return!Array.isArray(e)&&typeof e=="object"&&!!e},isString(e){return typeof e=="string"},isSymbol(e){return typeof e=="symbol"},isUndefined(e){return e===void 0},isNotArray(e){return!Array.isArray(e)},isNotBigInt(e){return typeof e!="bigint"},isNotBoolean(e){return typeof e!="boolean"},isNotFunction(e){return typeof e!="function"},isNotNull(e){return e!==null},isNotNumber(e){return typeof e!="number"},isNotObject(e){return Array.isArray(e)||typeof e!="object"||!e},isNotString(e){return typeof e!="string"},isNotSymbol(e){return typeof e!="symbol"},isNotUndefined(e){return typeof e<"u"}},assertWrap:{isArray(e,t){if(!Array.isArray(e))throw new h(`'${m(e)}' is not an array.`,t);return e},isBigInt(e,t){if(typeof e!="bigint")throw new h(`'${m(e)}' is not a bigint.`,t);return e},isBoolean(e,t){if(typeof e!="boolean")throw new h(`'${m(e)}' is not a boolean.`,t);return e},isFunction(e,t){if(typeof e!="function")throw new h(`'${m(e)}' is not a function.`,t);return e},isNull(e,t){if(e!==null)throw new h(`'${m(e)}' is not nul.`,t);return e},isNumber(e,t){if(typeof e!="number"||isNaN(e))throw new h(`'${m(e)}' is not a number.`,t);return e},isObject(e,t){if(Array.isArray(e)||typeof e!="object"||!e)throw new h(`'${m(e)}' is not a non-null object.`,t);return e},isString(e,t){if(typeof e!="string")throw new h(`'${m(e)}' is not a string.`,t);return e},isSymbol(e,t){if(typeof e!="symbol")throw new h(`'${m(e)}' is not a symbol.`,t);return e},isUndefined(e,t){if(typeof e<"u")throw new h(`'${m(e)}' is not a undefined.`,t);return e},isNotArray(e,t){if(Array.isArray(e))throw new h(`'${m(e)}' is an array.`,t);return e},isNotBigInt(e,t){if(typeof e=="bigint")throw new h(`'${m(e)}' is a bigint.`,t);return e},isNotBoolean(e,t){if(typeof e=="boolean")throw new h(`'${m(e)}' is a boolean.`,t);return e},isNotFunction(e,t){if(typeof e=="function")throw new h(`'${m(e)}' is a function.`,t);return e},isNotNull(e,t){if(e===null)throw new h(`'${m(e)}' is a null.`,t);return e},isNotNumber(e,t){if(typeof e=="number")throw new h(`'${m(e)}' is a number.`,t);return e},isNotObject(e,t){if(!Array.isArray(e)&&typeof e=="object"&&e)throw new h(`'${m(e)}' is a non-null object.`,t);return e},isNotString(e,t){if(typeof e=="string")throw new h(`'${m(e)}' is a string.`,t);return e},isNotSymbol(e,t){if(typeof e=="symbol")throw new h(`'${m(e)}' is a symbol.`,t);return e},isNotUndefined(e,t){if(typeof e>"u")throw new h(`'${m(e)}' is a undefined.`,t);return e}},checkWrap:{isArray(e){if(Array.isArray(e))return e},isBigInt(e){if(typeof e=="bigint")return e},isBoolean(e){if(typeof e=="boolean")return e},isFunction(e){if(typeof e=="function")return e},isNull(e){if(e===null)return e},isNumber(e){if(typeof e=="number")return e},isObject(e){if(!Array.isArray(e)&&typeof e=="object"&&e)return e},isString(e){if(typeof e=="string")return e},isSymbol(e){if(typeof e=="symbol")return e},isNotArray(e){if(!Array.isArray(e))return e},isNotBigInt(e){if(typeof e!="bigint")return e},isNotBoolean(e){if(typeof e!="boolean")return e},isNotFunction(e){if(typeof e!="function")return e},isNotNull(e){if(e!==null)return e},isNotNumber(e){if(typeof e!="number")return e},isNotObject(e){if(Array.isArray(e)||typeof e!="object"||!e)return e},isNotString(e){if(typeof e!="string")return e},isNotSymbol(e){if(typeof e!="symbol")return e}},waitUntil:{isArray:k(ue.isArray),isBigInt:k(ue.isBigInt),isBoolean:k(ue.isBoolean),isFunction:k(ue.isFunction),isNull:k(ue.isNull),isNumber:k(ue.isNumber),isObject:k(ue.isObject),isString:k(ue.isString),isSymbol:k(ue.isSymbol),isUndefined:k(ue.isUndefined),isNotArray:k(ue.isNotArray),isNotBigInt:k(ue.isNotBigInt),isNotBoolean:k(ue.isNotBoolean),isNotFunction:k(ue.isNotFunction),isNotNull:k(ue.isNotNull),isNotNumber:k(ue.isNotNumber),isNotObject:k(ue.isNotObject),isNotString:k(ue.isNotString),isNotSymbol:k(ue.isNotSymbol),isNotUndefined:k(ue.isNotUndefined)}};var Me;(function(e){e.Assert="assert",e.AssertWrap="assert-wrap",e.CheckWrap="check-wrap",e.Check="check"})(Me||(Me={}));function Ta(e,t,n){Ma(e,{noError:"No error.",notInstance:`'${m(e)}' is not an error instance.`},t,n)}function fl(e,t,n){Ma(e,{noError:"No Error was thrown.",notInstance:`Thrown value '${m(e)}' is not an error instance.`},t,n)}function Ma(e,t,n,r){if(e)if(e instanceof Error){if(n?.matchConstructor&&!(e instanceof n.matchConstructor)){const i=e.constructor.name;throw new h(`Error constructor '${i}' did not match expected constructor '${n.matchConstructor.name}'.`,r)}else if(n?.matchMessage){const i=Ce(e);if(typeof n.matchMessage=="string"){if(!i.includes(n.matchMessage))throw new h(`Error message
...
`,n)}function h1(e,t,n){if(e===t)throw new S(`
...
`,n)}function m1(e,t,n){if(e!=t)throw new S(`
...
`,n)}function p1(e,t,n){if(e==t)throw new S(`
...
`,n)}function Pa(e,t,n){if(!Ve(e,t))throw new S(`
...
`,n)}function g1(e,t,n){if(Ve(e,t))throw new S(`
...
`,n)}const w1={strictEquals:gh,notStrictEquals:h1,looseEquals:m1,notLooseEquals:p1,deepEquals:Pa,notDeepEquals:g1},wh={assert:w1,check:{strictEquals:g(),notStrictEquals:w,looseEquals:w,notLooseEquals:w,deepEquals:g(),notDeepEquals:w},assertWrap:{strictEquals:g(),notStrictEquals:w,looseEquals:w,notLooseEquals:w,deepEquals:g(),notDeepEquals:w},checkWrap:{strictEquals:g(),notStrictEquals:w,looseEquals:w,notLooseEquals:w,deepEquals:g(),notDeepEquals:w},waitUntil:{strictEquals:g(),notStrictEquals:w,looseEquals:w,notLooseEquals:w,deepEquals:g(),notDeepEquals:w}};function yh(e,t,n){if(!e||typeof e!="object")throw new S(`${P(e)} is not an object.`,n);if(!t||typeof t!="object")throw new S(`${P(t)} is not an object.`,n);Array.from(new Set([...Reflect.ownKeys(e),...Reflect.ownKeys(t)])).forEach(i=>{const s=e[i],o=t[i];try{gh(s,o)}catch{throw new S(`Entries are not equal at key '${String(i)}'.`,n)}})}function y1(e,t,n){try{yh(e,t)}catch{return}throw new S("Entries are equal.",n)}const b1={entriesEqual:yh,notEntriesEqual:y1},bh={assert:b1,check:{entriesEqual:g(),notEntriesEqual:w},assertWrap:{entriesEqual:g(),notEntriesEqual:w},checkWrap:{entriesEqual:g(),notEntriesEqual:w},waitUntil:{entriesEqual:g(),notEntriesEqual:w}};function vl(e,t){return JSON.stringify(e)===JSON.stringify(t)}function La(e,t,n){try{v1(e,t)}catch(r){throw new S(Kn(r),n)}}function E1(e,t,n){try{La(e,t)}catch{return}throw new S("Values are JSON equal.",n)}function v1(e,t){const n=vl(e,t);if(!(e===t||n)){if(e!=null&&t!=null&&typeof e=="object"&&typeof t=="object"){const r=Object.keys(e).sort(),i=Object.keys(t).sort();if(r.length||i.length){if(!vl(r,i))throw new Error("Values are JSON equal.");Object.keys(e).forEach(o=>{try{La(e[o],t[o])}catch(a){throw new Error(`JSON objects are not equal at key '${o}': ${Kn(a)}`)}})}}throw new Error("Values are not JSON equal.")}}const D1={jsonEquals:La,notJsonEquals:E1},Eh={assert:D1,check:{jsonEquals:g(),notJsonEquals:w},assertWrap:{jsonEquals:g(),notJsonEquals:w},checkWrap:{jsonEquals:g(),notJsonEquals:w},waitUntil:{jsonEquals:g(),notJsonEquals:w}};function bs(e,t,n){try{if(!Reflect.ownKeys(e).map(i=>e[i]).includes(t))throw new Error("fail")}catch{throw new S(`'${P(e)}' does not have value '${P(t)}'.`,n)}}function vh(e,t,n){try{bs(e,t)}catch{return}throw new S(`'${P(e)}' has value '${P(t)}'.`,n)}function A1(e,t,n){t.forEach(r=>bs(e,r,n))}function $1(e,t,n){t.forEach(r=>vh(e,r,n))}function Ia(e,t,n){if(typeof t=="string"){if(!t.includes(e))throw new S(`${P(e)} is not in '${t}'.`,n)}else bs(t,e,n)}function C1(e,t,n){try{Ia(e,t)}catch{return}throw new S(`${P(e)} is not in ${P(t)}.`,n)}function Dh(e,t){const n=e;if(n){if(typeof n!="string"&&typeof n!="object")throw new TypeError(`Cannot check if '${P(n)}' is empty.`);if(typeof n=="string"&&n||Array.isArray(n)&&n.length||n instanceof Map&&n.size||n instanceof Set&&n.size||n&&typeof n=="object"&&Object.keys(n).length)throw new S(`'${P(e)}' is not empty.`,t)}else return}function k1(e,t){try{Dh(e)}catch{return}throw new S(`'${P(e)}' is empty.`,t)}const S1={hasValue:bs,lacksValue:vh,hasValues:A1,lacksValues:$1,isIn:Ia,isNotIn:C1,isEmpty:Dh,isNotEmpty:k1},Ah={assert:S1,check:{hasValue:w,lacksValue:w,hasValues:w,lacksValues:w,isIn:g(),isNotIn:g(),isEmpty:g(),isNotEmpty:g()},assertWrap:{hasValue:w,lacksValue:w,hasValues:w,lacksValues:w,isIn:g(),isNotIn:g(),isEmpty:g(),isNotEmpty:g()},checkWrap:{hasValue:w,lacksValue:w,hasValues:w,lacksValues:w,isIn:g(),isNotIn:g(),isEmpty:g(),isNotEmpty:g()},waitUntil:{hasValue:w,lacksValue:w,hasValues:w,lacksValues:w,isIn:g(),isNotIn:g(),isEmpty:g(),isNotEmpty:g()}};function F1(e,t){try{ys(e,x)}catch{throw new S(`${P(e)} is not a valid http status.`,t)}}function T1(e,t,n){try{ys(e,x),Ia(e,xy[t])}catch{throw new S(`${P(e)} is not a '${t}' http status.`,n)}}const M1={isHttpStatus:F1,isHttpStatusCategory:T1},$h={assert:M1,check:{isHttpStatus:w,isHttpStatusCategory:g()},assertWrap:{isHttpStatus:w,isHttpStatusCategory:g()},checkWrap:{isHttpStatus:w,isHttpStatusCategory:g()},waitUntil:{isHttpStatus:w,isHttpStatusCategory:g()}};function N1(e,t,n){if(!(e instanceof t))throw new S(`'${P(e)}' is not an instance of '${t.name}'`,n)}function x1(e,t,n){if(e instanceof t)throw new S(`'${P(e)}' is an instance of '${t.name}'`,n)}const B1={instanceOf:N1,notInstanceOf:x1},Ch={assert:B1,check:{instanceOf:g(),notInstanceOf:g()},assertWrap:{instanceOf:g(),notInstanceOf:g()},checkWrap:{instanceOf:g(),notInstanceOf:g()},waitUntil:{instanceOf:g(),notInstanceOf:g()}};function P1(e,t){return Object.entries(e).reduce((r,[i,s])=>(r[i]=ws(t,i,()=>kh(s)),r),{})}function kh(e){return(...t)=>L1(e,...t)}function L1(e,t,...n){try{return e(t,...n),!0}catch{return!1}}function Sh(e,t,n){try{Es(t,e)}catch{throw new S(`'${String(e)}' is not a key of '${P(t)}'.`,n)}}function I1(e,t,n){try{Sh(e,t)}catch{return}throw new S(`'${String(e)}' is a key of '${P(t)}'.`,n)}const R1=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function Es(e,t,n){const r=`'${P(e)}' does not have key '${String(t)}'.`;if(!R1.some(s=>{try{return s(e,t)}catch{return!1}}))throw new S(r,n)}function O1(e,t,n){try{Es(e,t)}catch{return}throw new S(`'${P(e)}' has key '${String(t)}'.`,n)}const Fh=kh(Es);function _1(e,t,n){const r=t.filter(i=>!Fh(e,i));if(r.length)throw new S(`'${P(e)}' does not have keys '${r.join(",")}'.`,n)}function V1(e,t,n){const r=t.filter(i=>Fh(e,i));if(r.length)throw new S(`'${P(e)}' does not lack keys '${r.join(",")}'.`,n)}const U1={isKeyOf:Sh,isNotKeyOf:I1,hasKey:Es,lacksKey:O1,hasKeys:_1,lacksKeys:V1},Th={assert:U1,check:{isKeyOf:g(),isNotKeyOf:g(),hasKey:g(),lacksKey:g(),hasKeys:g(),lacksKeys:g()},assertWrap:{isKeyOf:g(),isNotKeyOf:g(),hasKey:g(),lacksKey:g(),hasKeys:g(),lacksKeys:g()},checkWrap:{isKeyOf:g(),isNotKeyOf:g(),hasKey:g(),lacksKey:g(),hasKeys:g(),lacksKeys:g()},waitUntil:{isKeyOf:g(),isNotKeyOf:g(),hasKey:g(),lacksKey:g(),hasKeys:g(),lacksKeys:g()}};function W1(e,t,n){if((Array.isArray(e)||typeof e=="string"?e.length:gs(e).length)<t)throw new S(`Length '${e.length}' is not at least '${t}'.`,n)}function q1(e,t,n){if((Array.isArray(e)||typeof e=="string"?e.length:gs(e).length)!==t)throw new S(`Length '${e.length}' is not exactly '${t}'.`,n)}const j1={isLengthAtLeast:W1,isLengthExactly:q1},Mh={assert:j1,check:{isLengthAtLeast:g(),isLengthExactly:g()},assertWrap:{isLengthAtLeast:g(),isLengthExactly:g()},checkWrap:{isLengthAtLeast:g(),isLengthExactly:g()},waitUntil:{isLengthAtLeast:g(),isLengthExactly:g()}};function z1(e,t){if(e==null)throw new S(`'${P(e)}' is not defined.`,t)}function G1(e,t){if(e!=null)throw new S(`'${P(e)}' is not a nullish.`,t)}const K1={isDefined:z1,isNullish:G1},Nh={assert:K1,check:{isDefined:g(),isNullish:w},assertWrap:{isDefined:g(),isNullish:w},checkWrap:{isDefined:void 0,isNullish:void 0},waitUntil:{isDefined:g(),isNullish:w}};function Z1(e,t,n){if(e<=t)throw new S(`${e} is not above ${t}`,n)}function Y1(e,t,n){if(e<t)throw new S(`${e} is not at least ${t}`,n)}function J1(e,{max:t,min:n},r){if(e<n||t<e)throw new S(`${e} is not within the bounds ${P({min:n,max:t})}`,r)}function H1(e,{min:t,max:n},r){if(t<=e&&e<=n)throw new S(`${e} is not outside the bounds ${P({min:t,max:n})}`,r)}function Q1(e,t){if(ch(e),!Number.isInteger(e))throw new S(`${e} is not an integer.`,t)}function X1(e,t){if(Number.isInteger(e))throw new S(`${e} is an integer.`,t)}function e2(e,t,n){if(e>=t)throw new S(`${e} is not below ${t}`,n)}function t2(e,t,n){if(e>t)throw new S(`${e} is not at most ${t}`,n)}function n2(e,t){if(!isNaN(e))throw new S(`${e} is not NaN`,t)}function r2(e,t){if(isNaN(e)||e===1/0||e===-1/0)throw new S(`${e} is not finite`,t)}function i2(e,t){if(e!==1/0&&e!==-1/0)throw new S(`${e} is not infinite`,t)}function s2(e,t,n,r){if(e<t-n||e>t+n)throw new S(`${e} is not within ±${n} of ${t}`,r)}function o2(e,t,n,r){if(e>=t-n&&e<=t+n)throw new S(`${e} is within ±${n} of ${t}`,r)}const a2={isInBounds:J1,isOutBounds:H1,isInteger:Q1,isNotInteger:X1,isAbove:Z1,isAtLeast:Y1,isBelow:e2,isAtMost:t2,isNaN:n2,isFinite:r2,isInfinite:i2,isApproximately:s2,isNotApproximately:o2},xh={assert:a2,check:{isInBounds:w,isOutBounds:w,isInteger:w,isNotInteger:w,isAbove:w,isAtLeast:w,isBelow:w,isAtMost:w,isNaN:w,isFinite:w,isInfinite:w,isApproximately:w,isNotApproximately:w},assertWrap:{isInBounds:w,isOutBounds:w,isInteger:w,isNotInteger:w,isAbove:w,isAtLeast:w,isBelow:w,isAtMost:w,isNaN:w,isFinite:w,isInfinite:w,isApproximately:w,isNotApproximately:w},checkWrap:{isInBounds:w,isOutBounds:w,isInteger:w,isNotInteger:w,isAbove:w,isAtLeast:w,isBelow:w,isAtMost:w,isNaN:w,isFinite:w,isInfinite:w,isApproximately:w,isNotApproximately:w},waitUntil:{isInBounds:w,isOutBounds:w,isInteger:w,isNotInteger:w,isAbove:w,isAtLeast:w,isBelow:w,isAtMost:w,isNaN:w,isFinite:w,isInfinite:w,isApproximately:w,isNotApproximately:w}},Dl={interval:{milliseconds:100},timeout:{seconds:10}},yo=Symbol("not set");async function Bh(e,t,n){const{callback:r,extraAssertionArgs:i,failureMessage:s,options:o}=l2(t),a=lt(o.timeout,{milliseconds:!0}).milliseconds,u=lt(o.interval,{milliseconds:!0});let l=yo,f;async function c(){try{l=n?r():await r(),e(l,...i)}catch(p){l=yo,f=Ft(p)}}const d=Date.now();for(;l===yo;)if(await c(),await lh(u),Date.now()-d>=a){const y=`${s?`${s}: `:""}Timeout of '${a}' milliseconds exceeded waiting for callback value to match expectations`;throw uh(f,y)}return l}function u2(e,t){return Object.entries(e).reduce((r,[i,s])=>(r[i]=ws(t,i,()=>Rn(s)),r),{})}function Rn(e,t=!1){return(...n)=>Bh(e,n,t)}function l2(e){const t={extraAssertionArgs:[],options:void 0,failureMessage:void 0};if(e.toReversed().forEach(n=>{if(t.callback)t.extraAssertionArgs.push(n);else if(typeof n=="function")t.callback=n;else if(typeof n=="string")t.failureMessage=n;else if(typeof n=="object")t.options=n;else{if(n===void 0)return;throw new TypeError(`Unexpected waitUntil arg: ${JSON.stringify(n)}`)}}),!t.callback)throw new TypeError("Missing waitUntil callback.");return{callback:t.callback,options:Ph(t.options),extraAssertionArgs:t.extraAssertionArgs.toReversed(),failureMessage:t.failureMessage}}function Ph(e){return{interval:e?.interval||Dl.interval,timeout:e?.timeout||Dl.timeout}}function c2(e,t,n,r,i){return Qr(...vs(e,t,n,r,i),!1)}function vs(e,t,n,r,i){const s=Array.isArray(n);return[s?e:Pa,s?t:e,s?n:t,s?r:n,s?i:r]}function Qr(e,t,n,r,i,s){const o=t(...n);if(o instanceof Promise)return new Promise(async(a,u)=>{try{const l=await o;e(l,r),s?a(l):a()}catch(l){u(new S(`Output from '${t.name}' did not produce expected output with input: ${P(n)}: ${Kn(l)}`,i))}});try{return e(o,r),s?o:void 0}catch(a){throw new S(`Output from '${t.name}' did not produce expected output with input: ${P(n)}: ${Kn(a)}`,i)}}function f2(e,t,n,r,i){try{const s=Qr(...vs(e,t,n,r,i),!1);return s instanceof Promise?new Promise(async o=>{try{await s,o(!0)}catch{o(!1)}}):!0}catch{return!1}}function d2(e,t,n,r,i){return Qr(...vs(e,t,n,r,i),!0)}function h2(e,t,n,r,i){try{const s=Qr(...vs(e,t,n,r,i),!0);return s instanceof Promise?new Promise(async o=>{try{o(await s)}catch{o(void 0)}}):s}catch{return}}const bo=Symbol("not set");async function m2(e,t,n,r,i,s){const o=Array.isArray(n),a=o?e:Pa,u=o?t:e,l=o?n:t,f=o?r:n,c=Ph(o?i:r),d=o?s:i,p=lt(c.timeout,{milliseconds:!0}).milliseconds,y=lt(c.interval,{milliseconds:!0});let v=bo,C;async function A(){try{v=await Qr(a,u,l,f,void 0,!0)}catch(I){v=bo,C=Ft(I)}}const T=Date.now();for(;v===bo;)if(await A(),await lh(y),Date.now()-T>=p)throw uh(C,Ba(d,`Timeout of '${p}' milliseconds exceeded waiting for callback value to match expectations`));return v}const p2={output:c2},Lh={assert:p2,check:{output:f2},assertWrap:{output:d2},checkWrap:{output:h2},waitUntil:{output:m2}};function Ih(e,t){if(e!==null&&(typeof e=="object"||typeof e=="function"))throw new S(`'${P(e)}' is not a Primitive.`,t)}function g2(e,t){try{Ih(e)}catch{return}throw new S(`'${P(e)}' is a Primitive.`,t)}function Rh(e,t){if(typeof e!="string"&&typeof e!="number"&&typeof e!="symbol")throw new S(`'${P(e)}' is not a PropertyKey.`,t)}function w2(e,t){try{Rh(e)}catch{return}throw new S(`'${P(e)}' is a PropertyKey.`,t)}const y2={isPropertyKey:Rh,isNotPropertyKey:w2,isPrimitive:Ih,isNotPrimitive:g2},Oh={assert:y2,check:{isNotPrimitive:g(),isNotPropertyKey:g(),isPrimitive:w,isPropertyKey:w},assertWrap:{isNotPrimitive:g(),isNotPropertyKey:g(),isPrimitive:w,isPropertyKey:w},checkWrap:{isNotPrimitive:g(),isNotPropertyKey:g(),isPrimitive:w,isPropertyKey:w},waitUntil:{isNotPrimitive:g(),isNotPropertyKey:g(),isPrimitive:w,isPropertyKey:w}};function Ra(e,t){if(!(e instanceof Promise)&&!(e&&typeof e=="object"&&"then"in e&&typeof e.then=="function"))throw new S(`'${P(e)}' is not a PromiseLike.`,t)}function _h(e,t){try{Ra(e)}catch{return}throw new S(`'${P(e)}' is a PromiseLike.`,t)}function Vh(e,t){if(!(e instanceof Promise))throw new S(`'${P(e)}' is not a Promise.`,t)}function Uh(e,t){if(e instanceof Promise)throw new S(`'${P(e)}' is a Promise.`,t)}const b2={isPromiseLike:Ra,isNotPromiseLike:_h,isPromise:Vh,isNotPromise:Uh},Wh={assert:b2,check:{isPromiseLike:w,isNotPromiseLike:g(),isPromise:w,isNotPromise:g()},assertWrap:{isPromiseLike:g(),isNotPromiseLike:g(),isPromise:g(),isNotPromise:g()},checkWrap:{isNotPromise:g(),isNotPromiseLike:g(),isPromise:w,isPromiseLike:w},waitUntil:{isPromiseLike:Rn(Ra,!0),isNotPromiseLike:Rn(_h,!0),isPromise:Rn(Vh,!0),isNotPromise:Rn(Uh,!0)}};function E2(e,t,n){if(!t.test(e))throw new S(`'${e}' does not match ${t}`,n)}function v2(e,t,n){if(t.test(e))throw new S(`'${e}' matches ${t}`,n)}const D2={matches:E2,mismatches:v2},qh={assert:D2,check:{matches:w,mismatches:w},assertWrap:{matches:w,mismatches:w},checkWrap:{matches:w,mismatches:w},waitUntil:{matches:w,mismatches:w}};var Ne;(function(e){e.Assert="assert",e.AssertWrap="assert-wrap",e.CheckWrap="check-wrap",e.Check="check"})(Ne||(Ne={}));function jh(e,t,n){zh(e,{noError:"No error.",notInstance:`'${P(e)}' is not an error instance.`},t,n)}function Al(e,t,n){zh(e,{noError:"No Error was thrown.",notInstance:`Thrown value '${P(e)}' is not an error instance.`},t,n)}function zh(e,t,n,r){if(e)if(e instanceof Error){if(n?.matchConstructor&&!(e instanceof n.matchConstructor)){const i=e.constructor.name;throw new S(`Error constructor '${i}' did not match expected constructor '${n.matchConstructor.name}'.`,r)}else if(n?.matchMessage){const i=Kn(e);if(typeof n.matchMessage=="string"){if(!i.includes(n.matchMessage))throw new S(`Error message

'${i}'

does not contain

'${n.matchMessage}'.`,r)}else if(!i.match(n.matchMessage))throw new S(`Error message

'${i}'

does not match RegExp

'${n.matchMessage}'.`,r)}}else throw new S(t.notInstance,r);else throw new S(t.noError,r)}function Ds(e,t,n,r){let i;try{const s=t instanceof Promise?t:t();if(s instanceof Promise)return new Promise(async(o,a)=>{try{await s}catch(u){i=Ft(u)}try{Al(i,n,r),e===Ne.Assert?o():e===Ne.Check?o(!0):o(i)}catch(u){e===Ne.CheckWrap?o(void 0):e===Ne.Check?o(!1):a(Ft(u))}})}catch(s){i=Ft(s)}try{return Al(i,n,r),e===Ne.Check?!0:e!==Ne.Assert?i:void 0}catch(s){if(e===Ne.CheckWrap)return;if(e===Ne.Check)return!1;throw s}}function A2(e,t,n){return Ds(Ne.Assert,e,t,n)}function $2(e,t){return Ds(Ne.Check,e,t)}function C2(e,t,n){return Ds(Ne.AssertWrap,e,t,n)}function k2(e,t,n){return Ds(Ne.CheckWrap,e,t,n)}const S2=Rn(jh);function F2(e,t,n,r){const i=typeof e=="function"||e instanceof Promise?void 0:e,s=i?t:e,o=typeof n=="object"?r:n,a=typeof n=="object"?n:t;if(typeof s!="function")throw new TypeError(`Callback is not a function, got '${P(s)}'`);return S2(i,async()=>{try{await s();return}catch(u){return Ft(u)}},a,o)}const T2={throws:A2,isError:jh},Gh={assert:T2,check:{throws:$2,isError:w},assertWrap:{throws:C2,isError:w},checkWrap:{throws:k2,isError:w},waitUntil:{throws:F2,isError:w}},Kh=/^[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[089ab][0-9a-f]{3}-[0-9a-f]{12}$/i;function M2(e,t){if(!String(e).match(Kh))throw new S(`'${String(e)}' is not a UUID.`,t)}function N2(e,t){if(String(e).match(Kh))throw new S(`'${String(e)}' is a UUID.`,t)}const x2={isUuid:M2,isNotUuid:N2},Zh={assert:x2,check:{isUuid:w,isNotUuid:g()},assertWrap:{isUuid:w,isNotUuid:g()},checkWrap:{isUuid:w,isNotUuid:g()},waitUntil:{isUuid:w,isNotUuid:g()}},Xr={...hh.assert,...mh.assert,...bh.assert,...ph.assert,...Ch.assert,...Eh.assert,...Th.assert,...Mh.assert,...Nh.assert,...xh.assert,...Oh.assert,...Wh.assert,...qh.assert,...fh.assert,...wh.assert,...Gh.assert,...Zh.assert,...Ah.assert,...$h.assert,...Lh.assert},As=[hh,mh,bh,ph,Ch,Eh,Th,Mh,Nh,xh,Oh,Wh,qh,fh,wh,Gh,Zh,Ah,$h,Lh],B2=Object.assign({},...As.map(e=>e.check)),P2=Object.assign({},...As.map(e=>e.assertWrap)),L2=Object.assign({},...As.map(e=>e.checkWrap)),I2=Object.assign({},...As.map(e=>e.waitUntil)),R2=P1(Xr,B2),Yo=Object.assign(function(t){return!!t},R2);function O2(e,t){return Object.entries(e).reduce((r,[i,s])=>(r[i]=ws(t,i,()=>_2(s)),r),{})}function _2(e){return(...t)=>(e(...t),t[0])}const V2=O2(Xr,P2);Object.assign(function(t,n){if(!t)throw new S("Assertion failed.",n);return t},V2);function U2(e){return{equals:()=>{},notEquals:()=>{},matches:()=>{},notMatches:()=>{},slowEquals:()=>{}}}const W2={tsType:U2},q2={assert:W2},j2={fail:e=>{throw new S("Failure triggered.",e)}},z2={...q2.assert,...Xr,...j2};Object.assign(function(t,n){if(!t)throw new S("Assertion failed.",n)},z2);function G2(e,t){return Object.entries(e).reduce((r,[i,s])=>(r[i]=ws(t,i,()=>K2(s)),r),{})}function K2(e){return(...t)=>{try{return e(...t),t[0]}catch{return}}}const Z2=G2(Xr,L2);Object.assign(function(t){if(t)return t},Z2);const Y2=u2(Xr,I2);Object.assign(function(t,n){return Bh((r,i)=>{if(!r)throw new S("Assertion failed.",i)},[t,n],!1)},Y2);function J2(e,t,n){if(t in e)return e[t];{const r=n();return Yo.isPromise(r)?new Promise(async(i,s)=>{try{const o=await r;e[t]=o,i(o)}catch(o){s(Ft(o))}}):(e[t]=r,r)}}function $l(e){return gs(e).map(t=>e[t])}class H2{listeners={};getListenerCount(){return $l(this.listeners).map(n=>n.size||0).reduce((n,r)=>n+r,0)}listen(t,n,r={}){const i=this.listeners,s=Yo.isString(t)?t:t.type;function o(){return i[s]?.delete(n)||!1}function a(u,l){r.once&&o(),n(u,l)}return J2(i,s,()=>new Map).set(n,{listener:a,removeListener:o}),o}removeListener(t,n){const r=Yo.isString(t)?t:t.type,i=this.listeners[r];if(!i)return!1;const s=i.get(n);return s?s.removeListener():!1}dispatch(t){const n=this.listeners[t.type],r=n?.size||0;return n?.forEach(i=>{i.listener(t,i.removeListener)}),r}removeAllListeners(){const n=$l(this.listeners).reduce((r,i)=>{const s=i.size||0;return i.clear(),r+s},0);return this.listeners={},n}destroy(){this.removeAllListeners()}}class Yh extends H2{}function Jh(e,t,n,r){return e.addEventListener(t,n,r),()=>e.removeEventListener(t,n,r)}function Cl(e,t,n){return Jh(globalThis,e,t,n)}function Oa(e,t){return Gi(e.title),e.parent?[...Oa(e.parent),Gi(e.parent.title)].concat([]):[]}function Gi(e){return Fy(e).toLowerCase().replaceAll(/\s/g,"-")}function Q2({searchFor:e,searchIn:t}){return e.every((n,r)=>t[r]===n)}const X2={[ve.ElementExample]:()=>[],[ve.Page]:e=>[!e.title&&new Error("Cannot define an element-book page with an empty title."),...Qw(e.controls,e.title)].filter(E.isTruthy),[ve.Root]:()=>[]},Ki="_isBookTreeNode",Hh=new Map;function eb(e){return Hh.get(e)}function tb(e,t){Xw(Hh,e,()=>t)}function Wn(e,t){return!!(Qh(e)&&e.entry.entryType===t)}function Qh(e){return!!(E.hasKeys(e,[Ki,"entry"])&&e[Ki])}function nb(){return{[Ki]:!0,entry:{entryType:ve.Root,title:"",parent:void 0,errors:[],descriptionParagraphs:[]},urlBreadcrumb:"",fullUrlBreadcrumbs:[],children:{},manuallyAdded:!0}}function rb({entries:e,debug:t}){const n=eb(e);if(n)return n;const r=nb();e.forEach(o=>_a({tree:r,newEntry:o,debug:t,manuallyAdded:!0}));const i=Xh(r),s={tree:r,flattenedNodes:i};return tb(e,s),t&&console.info("element-book tree:",r),s}function ib(e,t,n){if(!t.parent)return e;const r=Jo(t,e);if(r)return r;n&&console.info(`parent of ${t.title} not found in tree; adding it now.`),_a({tree:e,newEntry:t.parent,debug:n,manuallyAdded:!1});const i=Jo(t,e);if(!i)throw new Error(`Failed to find node despite having just added it: ${Oa(t).join(" > ")}`);return i}function _a({tree:e,newEntry:t,debug:n,manuallyAdded:r}){const i=X2[t.entryType](t);t.errors.push(...i);const s=ib(e,t,n),o=Gi(t.title),a=s.children[o];if(a){if(r){if(a.manuallyAdded){a.entry.errors.push(new Error(`Cannot create duplicate '${o}'${s.urlBreadcrumb?` in parent '${s.urlBreadcrumb}'.`:""}`));return}a.manuallyAdded=!0}return}const u={[Ki]:!0,children:{},urlBreadcrumb:o,fullUrlBreadcrumbs:[...s.fullUrlBreadcrumbs,o],entry:t,manuallyAdded:r};s.children[o]=u,Jw(t,ve.Page)&&Object.values(t.elementExamples).length&&Object.values(t.elementExamples).forEach(l=>_a({tree:e,newEntry:l,debug:n,manuallyAdded:r}))}function Jo(e,t){const n=Qh(e)?e.fullUrlBreadcrumbs.slice(0,-1):Oa(e);return n.length?n.reduce((i,s)=>{if(i)return i.children[s]},t):void 0}function Xh(e){const n=!!e.entry.errors.length?[]:Object.values(e.children).map(i=>Xh(i));return[e,...n].flat()}function Va(e,t){return Ua(e,["",...t],void 0)}function Ua(e,t,n){const r=t.slice(1),i=r[0];!i&&n&&(e.controls=n);const s=e.children[i||""],o=s&&Ua(s,r,n);return{...e.controls,...o}}function sb(e,t,n){const r={...e};return Ua(r,["",...t],n),r}function e0(e,t){const n=t?.controls||(Wn(e,ve.Page)?we(e.entry.controls,(i,s)=>s.initValue):{});return{children:we(e.children,(i,s)=>e0(s,t?.children?.[s.urlBreadcrumb])),controls:n}}function ft(e){const t={...e,entryType:ve.Page,elementExamples:{},descriptionParagraphs:e.descriptionParagraphs??[],controls:e.controls??{},errors:[]},n=new Set;return e.defineExamples&&e.defineExamples({defineExample(r){const i={...r,entryType:ve.ElementExample,parent:t,descriptionParagraphs:r.descriptionParagraphs??[],errors:[n.has(r.title)&&new Error(`Example title '${r.title}' in page '${e.title}' is already taken.`)].filter(E.isTruthy)};n.add(r.title),t.elementExamples[Gi(i.title)]=i}}),t}var it=(e=>(e.Search="search",e.Book="book",e))(it||{});function Ho(e){return e[0]==="book"?"":e[1]?decodeURIComponent(e[1]):""}const Zn={hash:void 0,paths:["book"],search:void 0};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pi=globalThis,Wa=Pi.ShadowRoot&&(Pi.ShadyCSS===void 0||Pi.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,qa=Symbol(),kl=new WeakMap;let t0=class{constructor(t,n,r){if(this._$cssResult$=!0,r!==qa)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=n}get styleSheet(){let t=this.o;const n=this.t;if(Wa&&t===void 0){const r=n!==void 0&&n.length===1;r&&(t=kl.get(n)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),r&&kl.set(n,t))}return t}toString(){return this.cssText}};const le=e=>new t0(typeof e=="string"?e:e+"",void 0,qa),Li=(e,...t)=>{const n=e.length===1?e[0]:t.reduce((r,i,s)=>r+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+e[s+1],e[0]);return new t0(n,e,qa)},ob=(e,t)=>{if(Wa)e.adoptedStyleSheets=t.map(n=>n instanceof CSSStyleSheet?n:n.styleSheet);else for(const n of t){const r=document.createElement("style"),i=Pi.litNonce;i!==void 0&&r.setAttribute("nonce",i),r.textContent=n.cssText,e.appendChild(r)}},Sl=Wa?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let n="";for(const r of t.cssRules)n+=r.cssText;return le(n)})(e):e;/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const oD={attribute:!0,type:String,converter:Zi,reflect:!1,hasChanged:ja},aD=(e=oD,t,n)=>{const{kind:r,metadata:i}=n;let s=globalThis.litPropertyMetadata.get(i);if(s===void 0&&globalThis.litPropertyMetadata.set(i,s=new Map),s.set(n.name,e),r==="accessor"){const{name:o}=n;return{set(a){const u=t.get.call(this);t.set.call(this,a),this.requestUpdate(o,u,e)},init(a){return a!==void 0&&this.P(o,void 0,e),a}}}if(r==="setter"){const{name:o}=n;return function(a){const u=this[o];t.call(this,a),this.requestUpdate(o,u,e)}}throw Error("Unsupported decorator location: "+r)};function uD(e){return(t,n)=>typeof n=="object"?aD(e,t,n):((r,i,s)=>{const o=i.hasOwnProperty(s);return i.constructor.createProperty(s,o?{...r,wrapped:!0}:r),o?Object.getOwnPropertyDescriptor(i,s):void 0})(e,t,n)}/**
 * @license
 ...
 */const Wc=(e,t,n)=>{const r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},kD=nn(class extends Pt{constructor(e){if(super(e),e.type!==Ws.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);const i=[],s=[];let o=0;for(const a of e)i[o]=r?r(a,o):o,s[o]=n(a,o),o++;return{values:s,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){const i=sD(e),{values:s,keys:o}=this.dt(t,n,r);if(!Array.isArray(i))return this.ut=o,s;const a=this.ut??=[],u=[];let l,f,c=0,d=i.length-1,p=0,y=s.length-1;for(;c<=d&&p<=y;)if(i[c]===null)c++;else if(i[d]===null)d--;else if(a[c]===o[p])u[p]=cn(i[c],s[p]),c++,p++;else if(a[d]===o[y])u[y]=cn(i[d],s[y]),d--,y--;else if(a[c]===o[y])u[y]=cn(i[c],s[y]),mr(e,u[y+1],i[c]),c++,y--;else if(a[d]===o[p])u[p]=cn(i[d],s[p]),mr(e,i[c],i[d]),d--,p++;else if(l===void 0&&(l=Wc(o,p,y),f=Wc(a,c,d)),l.has(a[c]))if(l.has(a[d])){const v=f.get(o[p]),C=v!==void 0?i[v]:null;if(C===null){const A=mr(e,i[c]);cn(A,s[p]),u[p]=A}else u[p]=cn(C,s[p]),mr(e,i[c],C),i[v]=null;p++}else Bo(i[d]),d--;else Bo(i[c]),c++;for(;p<=y;){const v=mr(e,u[y+1]);cn(v,s[p]),u[p++]=v}for(;c<=d;){const v=i[c++];v!==null&&Bo(v)}return this.ut=o,iD(e,u),ze}}),SD=kD;function js(e,t){return Rr(e,t),e.element}function FD(e){try{return e.options.host.tagName.toLowerCase()}catch{return}}function Rr(e,t){const n=FD(e),r=n?`: in ${n}`:"";if(e.type!==Ws.ELEMENT)throw new Error(`${t} directive can only be attached directly to an element${r}.`);if(!e.element)throw new Error(`${t} directive found no element${r}.`)}function TD(e){const t=nn(class extends Pt{element;constructor(n){super(n),this.element=js(n,e)}render(n){return this.element.setAttribute(e,n),ze}});return{attributeSelector(n){return`[${e}="${n}"]`},attributeDirective(n){return t(n)},attributeName:e}}function Q(e,t){return MD(e,t)}const MD=nn(class extends Pt{element;lastListenerMetaData;constructor(e){super(e),this.element=js(e,"listen")}resetListener(e){this.lastListenerMetaData&&this.element.removeEventListener(this.lastListenerMetaData.eventType,this.lastListenerMetaData.listener),this.element.addEventListener(e.eventType,e.listener),this.lastListenerMetaData=e}createListenerMetaData(e,t){return{eventType:e,callback:t,listener:n=>this.lastListenerMetaData?.callback(n)}}render(e,t){const n=typeof e=="string"?e:e.type;if(typeof n!="string")throw new TypeError(`Cannot listen to an event with a name that is not a string. Given event name: '${String(n)}'`);return this.lastListenerMetaData&&this.lastListenerMetaData.eventType===n?this.lastListenerMetaData.callback=t:this.resetListener(this.createListenerMetaData(n,t)),ze}}),qc="onDomCreated",jc=nn(class extends Pt{element;constructor(e){super(e),Rr(e,qc)}update(e,[t]){Rr(e,qc);const n=e.element;return n!==this.element&&(window.requestAnimationFrame(()=>t(n)),this.element=n),this.render(t)}render(e){}}),Po="onResize",gm=nn(class extends Pt{element;resizeObserver=new ResizeObserver(e=>this.fireCallback(e));callback;constructor(e){super(e),Rr(e,Po)}fireCallback(e){const t=e[0];if(!t)throw console.error(e),new Error(`${Po} observation triggered but the first entry was empty.`);this.callback?.({target:t.target,contentRect:t.contentRect},this.element)}update(e,[t]){Rr(e,Po),this.callback=t;const n=e.element,r=this.element;return n!==r&&(this.element=n,r&&this.resizeObserver.unobserve(r),this.resizeObserver.observe(n)),this.render(t)}render(e){}});function Be(e,t,n){return lD(e,()=>t,()=>n)}const{attributeDirective:ND}=TD("data-test-id"),br=ND;J({assign:"",assignedInputs:"",cssVars:"",elementOptions:"",events:"",hostClasses:"",init:"",inputsType:"",render:"",slotNames:"",stateInitStatic:"",stateType:"",styles:"",tagName:"",updateStateType:""});function xD(e){return{[ns]:e}}function wm(e){const{assertInputs:t,transformInputs:n}={assertInputs:e?.assertInputs??(()=>{}),transformInputs:e?.transformInputs??(r=>r)};return{defineElement:()=>r=>(t(r),pm()(n(r))),defineElementNoInputs:r=>(t(r),qs(n(r)))}}function BD(e,t){return PD(void 0,e)}const PD=nn(class extends Pt{element;constructor(e){super(e),this.element=js(e,"assign")}render(e,t){return hm(this.element,t),ze}}),LD={};function ID(e,t){return t.map((n,r)=>{const i=e[r],s=e[r+1];if(i&&s){const{shouldHaveTagNameHere:o}=ym(i,s);if(o&&E.isString(n))return{tagName:n,tagInterpolationKey:Jd(LD,n,()=>({tagName:n}))}}return n})}function ym(e,t){const n=e.trim().endsWith("<")&&!!t.match(/^[\s>]/),r=e.trim().endsWith("</")&&t.trim().startsWith(">");return{isOpeningTag:n,shouldHaveTagNameHere:n||r}}function RD(...[e,t,n]){const r=Ri(n)?n.definition:n,{isOpeningTag:i,shouldHaveTagNameHere:s}=ym(e,t),o=iu(r);if(o&&s&&r.tagInterpolationKey)return{replacement:r.tagName,getExtraValues:void 0};if(s&&!o)throw console.error({lastNewString:e,currentTemplateString:t,currentValue:r}),new Error(`Got interpolated tag name but found no tag name on the given value: '${r?.tagName||r?.prototype?.constructor?.name||r?.constructor?.name}'`);if(!s||!o)return;if(i&&r.elementOptions&&!r.elementOptions.ignoreUnsetInputs&&!Ri(n))throw new Error(`Missing inputs for '${r.tagName}'`);return{replacement:r.tagName,getExtraValues(u){const l=Ri(u)?u.inputs:void 0;return[i&&l?BD(l):void 0].filter(E.isTruthy)}}}function OD(e){}function _D(e){return fm(e.strings,e.values,RD,OD)}function D(e,...t){const n=ID(e,t),r=yb(e,...n),i=cm(e,n,()=>_D(r));return{...r,strings:i.strings,values:i.values}}function bm(e){return we(e,(t,n)=>n instanceof X?le(n.toString({format:"hex"})):bm(n))}const VD="dodgerblue";function ha(e){const t=Math.abs(e.contrast("white","APCA")),n=Math.abs(e.contrast("black","APCA"));return t>n?"white":"black"}function Lo({background:e,foreground:t}){return{background:e??new X(ha(t)),foreground:t??new X(ha(e))}}function UD(e){return e==="black"?"white":"black"}const WD={black:{foregroundFaint1:new X("#ccc"),foregroundFaint2:new X("#eee")},white:{foregroundFaint1:new X("#ccc"),foregroundFaint2:new X("#eee")}},qD={black:{backgroundFaint1:new X("#666"),backgroundFaint2:new X("#444")},white:{backgroundFaint1:new X("#ccc"),backgroundFaint2:new X("#fafafa")}};function zc({themeColor:e=VD,themeStyle:t="light"}={}){const n=new X(e),r=new X(t==="dark"?"black":"white"),i=ha(r),s=new X(i),o={nav:{hover:Lo({background:n.clone().set({"hsl.l":93})}),active:Lo({background:n.clone().set({"hsl.l":90})}),selected:Lo({background:n.clone().set({"hsl.l":85})})},accent:{icon:n.clone().set({"hsl.l":40})},page:{background:r,...qD[UD(i)],foreground:s,...WD[i]}};return bm(o)}var kt=(e=>(e.Footer="book-footer",e.NavHeader="book-nav-header",e))(kt||{});async function ma(e=1){const t=new wf;function n(){requestAnimationFrame(()=>{e--,e?n():t.resolve()})}return n(),t.promise}function jD(e){return[...e.children,...e.shadowRoot?.children??[]]}function zD(e){return e.matches(":focus")}function rs(e){if(e instanceof ShadowRoot)return rs(e.host);const t=e.parentNode;if(t)return t instanceof Element?t:rs(t)}function Em(e,t){if(t(e))return e;const n=rs(e);if(n)return Em(n,t)}async function GD(e){return KD(e,1)}async function KD(e,t){return new Promise(n=>{new IntersectionObserver((i,s)=>{ir.isLengthAtLeast(i,1),s.disconnect(),n(i[0].intersectionRatio>=t)}).observe(e)})}function Er(e,t,n={}){const r=n.useOriginalTarget?e.target:e.currentTarget;if(!(r instanceof t)){const i=t.name,s=r?.constructor.name,o=n.useOriginalTarget?`Current target from event '${e.type}' was not of type '${i}'. Got '${s}'.`:`Target from event '${e.type}' was not of type '${i}'. Got '${s}'.`;throw new Error(o)}return r}function ZD(e){const t=rs(e);return t&&Em(t,n=>globalThis.getComputedStyle(n).overflowY!=="visible")||document.body}const YD={a:window.HTMLAnchorElement,abbr:window.HTMLElement,address:window.HTMLElement,area:window.HTMLAreaElement,article:window.HTMLElement,aside:window.HTMLElement,audio:window.HTMLAudioElement,b:window.HTMLElement,base:window.HTMLBaseElement,bdi:window.HTMLElement,bdo:window.HTMLElement,blockquote:window.HTMLQuoteElement,body:window.HTMLBodyElement,br:window.HTMLBRElement,button:window.HTMLButtonElement,canvas:window.HTMLCanvasElement,caption:window.HTMLTableCaptionElement,cite:window.HTMLElement,code:window.HTMLElement,col:window.HTMLTableColElement,colgroup:window.HTMLTableColElement,data:window.HTMLDataElement,datalist:window.HTMLDataListElement,dd:window.HTMLElement,del:window.HTMLModElement,details:window.HTMLDetailsElement,dfn:window.HTMLElement,dialog:window.HTMLDialogElement,div:window.HTMLDivElement,dl:window.HTMLDListElement,dt:window.HTMLElement,em:window.HTMLElement,embed:window.HTMLEmbedElement,fieldset:window.HTMLFieldSetElement,figcaption:window.HTMLElement,figure:window.HTMLElement,footer:window.HTMLElement,form:window.HTMLFormElement,h1:window.HTMLHeadingElement,h2:window.HTMLHeadingElement,h3:window.HTMLHeadingElement,h4:window.HTMLHeadingElement,h5:window.HTMLHeadingElement,h6:window.HTMLHeadingElement,head:window.HTMLHeadElement,header:window.HTMLElement,hgroup:window.HTMLElement,hr:window.HTMLHRElement,html:window.HTMLHtmlElement,i:window.HTMLElement,iframe:window.HTMLIFrameElement,img:window.HTMLImageElement,input:window.HTMLInputElement,ins:window.HTMLModElement,kbd:window.HTMLElement,label:window.HTMLLabelElement,legend:window.HTMLLegendElement,li:window.HTMLLIElement,link:window.HTMLLinkElement,main:window.HTMLElement,map:window.HTMLMapElement,mark:window.HTMLElement,menu:window.HTMLMenuElement,meta:window.HTMLMetaElement,meter:window.HTMLMeterElement,nav:window.HTMLElement,noscript:window.HTMLElement,object:window.HTMLObjectElement,ol:window.HTMLOListElement,optgroup:window.HTMLOptGroupElement,option:window.HTMLOptionElement,output:window.HTMLOutputElement,p:window.HTMLParagraphElement,picture:window.HTMLPictureElement,pre:window.HTMLPreElement,progress:window.HTMLProgressElement,q:window.HTMLQuoteElement,rp:window.HTMLElement,rt:window.HTMLElement,ruby:window.HTMLElement,s:window.HTMLElement,samp:window.HTMLElement,script:window.HTMLScriptElement,search:window.HTMLElement,section:window.HTMLElement,select:window.HTMLSelectElement,slot:window.HTMLSlotElement,small:window.HTMLElement,source:window.HTMLSourceElement,span:window.HTMLSpanElement,strong:window.HTMLElement,style:window.HTMLStyleElement,sub:window.HTMLElement,summary:window.HTMLElement,sup:window.HTMLElement,table:window.HTMLTableElement,tbody:window.HTMLTableSectionElement,td:window.HTMLTableCellElement,template:window.HTMLTemplateElement,textarea:window.HTMLTextAreaElement,tfoot:window.HTMLTableSectionElement,th:window.HTMLTableCellElement,thead:window.HTMLTableSectionElement,time:window.HTMLTimeElement,title:window.HTMLTitleElement,tr:window.HTMLTableRowElement,track:window.HTMLTrackElement,u:window.HTMLElement,ul:window.HTMLUListElement,var:window.HTMLElement,video:window.HTMLVideoElement,wbr:window.HTMLElement},JD=Object.keys(YD),HD={annotation:window.MathMLElement,"annotation-xml":window.MathMLElement,maction:window.MathMLElement,math:window.MathMLElement,merror:window.MathMLElement,mfrac:window.MathMLElement,mi:window.MathMLElement,mmultiscripts:window.MathMLElement,mn:window.MathMLElement,mo:window.MathMLElement,mover:window.MathMLElement,mpadded:window.MathMLElement,mphantom:window.MathMLElement,mprescripts:window.MathMLElement,mroot:window.MathMLElement,mrow:window.MathMLElement,ms:window.MathMLElement,mspace:window.MathMLElement,msqrt:window.MathMLElement,mstyle:window.MathMLElement,msub:window.MathMLElement,msubsup:window.MathMLElement,msup:window.MathMLElement,mtable:window.MathMLElement,mtd:window.MathMLElement,mtext:window.MathMLElement,mtr:window.MathMLElement,munder:window.MathMLElement,munderover:window.MathMLElement,semantics:window.MathMLElement},QD=Object.keys(HD),XD={a:window.SVGAElement,animate:window.SVGAnimateElement,animateMotion:window.SVGAnimateMotionElement,animateTransform:window.SVGAnimateTransformElement,circle:window.SVGCircleElement,clipPath:window.SVGClipPathElement,defs:window.SVGDefsElement,desc:window.SVGDescElement,ellipse:window.SVGEllipseElement,feBlend:window.SVGFEBlendElement,feColorMatrix:window.SVGFEColorMatrixElement,feComponentTransfer:window.SVGFEComponentTransferElement,feComposite:window.SVGFECompositeElement,feConvolveMatrix:window.SVGFEConvolveMatrixElement,feDiffuseLighting:window.SVGFEDiffuseLightingElement,feDisplacementMap:window.SVGFEDisplacementMapElement,feDistantLight:window.SVGFEDistantLightElement,feDropShadow:window.SVGFEDropShadowElement,feFlood:window.SVGFEFloodElement,feFuncA:window.SVGFEFuncAElement,feFuncB:window.SVGFEFuncBElement,feFuncG:window.SVGFEFuncGElement,feFuncR:window.SVGFEFuncRElement,feGaussianBlur:window.SVGFEGaussianBlurElement,feImage:window.SVGFEImageElement,feMerge:window.SVGFEMergeElement,feMergeNode:window.SVGFEMergeNodeElement,feMorphology:window.SVGFEMorphologyElement,feOffset:window.SVGFEOffsetElement,fePointLight:window.SVGFEPointLightElement,feSpecularLighting:window.SVGFESpecularLightingElement,feSpotLight:window.SVGFESpotLightElement,feTile:window.SVGFETileElement,feTurbulence:window.SVGFETurbulenceElement,filter:window.SVGFilterElement,foreignObject:window.SVGForeignObjectElement,g:window.SVGGElement,image:window.SVGImageElement,line:window.SVGLineElement,linearGradient:window.SVGLinearGradientElement,marker:window.SVGMarkerElement,mask:window.SVGMaskElement,metadata:window.SVGMetadataElement,mpath:window.SVGMPathElement,path:window.SVGPathElement,pattern:window.SVGPatternElement,polygon:window.SVGPolygonElement,polyline:window.SVGPolylineElement,radialGradient:window.SVGRadialGradientElement,rect:window.SVGRectElement,script:window.SVGScriptElement,set:window.SVGSetElement,stop:window.SVGStopElement,style:window.SVGStyleElement,svg:window.SVGSVGElement,switch:window.SVGSwitchElement,symbol:window.SVGSymbolElement,text:window.SVGTextElement,textPath:window.SVGTextPathElement,title:window.SVGTitleElement,tspan:window.SVGTSpanElement,use:window.SVGUseElement,view:window.SVGViewElement},e5=Object.keys(XD);Array.from(new Set([...JD,...e5,...QD].sort()));function t5({searchQuery:e,searchIn:t}){const n=t.length,r=e.length;if(r>n)return!1;if(r===n)return e===t;const i=t.toLowerCase(),s=e.toLowerCase();e:for(let o=0,a=0;o<r;o++){const u=s.codePointAt(o);for(;a<n;)if(i.codePointAt(a++)===u)continue e;return!1}return!0}const n5=Hd(32);function Oi(e){return e.join(n5)}function vm(e){if(!e.length)return[];const t=Oi(e),n=vm(e.slice(0,-1));return[t,...n]}const r5=["error","errors"];function i5(e){return r5.includes(e)}function s5({flattenedNodes:e,searchQuery:t}){const n={};function r(i){Object.values(i.children).map(o=>(r(o),Oi(o.fullUrlBreadcrumbs))).forEach(o=>n[o]=!0)}return e.forEach(i=>{const s=i.entry.errors.length&&i5(t),o=Oi(i.fullUrlBreadcrumbs);if(t5({searchIn:[i.entry.title,...i.entry.descriptionParagraphs].join(" ").toLowerCase(),searchQuery:t.toLowerCase()})||s||n[o]){const u=vm(i.fullUrlBreadcrumbs);r(i),u.forEach(l=>n[l]=!0)}else n[o]=!1}),e.filter(i=>{const s=Oi(i.fullUrlBreadcrumbs),o=n[s];if(!E.isBoolean(o))throw new TypeError(`Failed to find '${i.fullUrlBreadcrumbs.join(" > ")}' in includeInSearchResults.`);return o})}class ou extends Error{name="SpaRouterError"}class Gc extends ou{name="GlobalUrlEventsConsolidationError"}class o5 extends ou{name="SanitizationDepthMaxed"}tn({paths:[""],search:xe(void 0,tu({keys:"",values:[""],required:!1})),hash:xe(void 0,"")});const a5=tn({basePath:xe("",void 0),sanitizeRoute:e=>e,maxListenerCount:xe(1,void 0),disableWarnings:xe(void 0,!1),isPaused:xe(!1,void 0)}),Io="://";function au(...e){const t=e.join("/"),[n,r=""]=t.includes(Io)?t.split(Io):["",t];let i=!1;const s=r.replace(/\/{2,}/g,"/").split("/").reduce((o,a,u,l)=>{if(i)return o;const f=l[u+1];let c=a;const d=f?.startsWith("?"),p=!a.includes("?")&&d,y=f==="?";if(d||p){i=!0;let v=!1;const C=l.slice(u+2).reduce((A,T)=>(T.includes("#")&&(v=!0),v?A.concat(T):[A,T].join("&")),"");c=[a,f,y?Un({value:C,prefix:"&"}):C].join("")}return o.concat(c)},[]);return[n,n?Io:"",s.join("/")].join("")}var Or;(function(e){e.Encode="encode",e.Decode="decode",e.None="none"})(Or||(Or={}));var _r;(function(e){e.Clear="clear",e.Replace="replace",e.Append="append"})(_r||(_r={}));function Ai(e,t){return e.map(n=>{if(n!=null)return qn(String(n),t)}).filter(n=>n!=null)}function qn(e,t){return t?.encoding===Or.Decode?decodeURIComponent(e):t?.encoding===Or.Encode?encodeURIComponent(e):e}const u5=tn(tu({keys:"",values:[""],required:!0}));function l5(e,t,n){const r=n?.searchParamStrategy===_r.Clear?{}:we(e,(o,a)=>E.isString(a)?[a]:a),i=we(t,(o,a)=>{if(n?.searchParamStrategy===_r.Append){const u=r[o],l=E.isArray(u)?u:[u];if(a){const f=E.isArray(a)?a:[a];return Ai([...l,...f],n)}else return Ai(l,n)}else return E.isArray(a)?Ai(a,n):a?Ai([a],n):void 0});return xa({...r,...i},(o,a)=>!!a)}function Dm(e,t){return E.isString(e)&&!e.includes("?")?{}:(E.isString(e)?e:e instanceof URLSearchParams?e.toString():e.search).replace(/(^.*\?)|(#[^#]*$)/,"").split("&").map(s=>{const[o,...a]=yy(s,"=");return[o,a.length?a.join("="):void 0]}).reduce((s,[o,a])=>{const u=Am({options:t,key:o,value:a}),l=Jd(s,u.key,()=>[]);return a!=null&&l.push(u.value),s},{})}function c5(e){if(e!=null)return E.isArray(e)?[...e]:e===""?[]:[e]}function f5(e,t){const n=ps(Object.entries(e),([r,i])=>{const s=c5(i);return s?.length?s.map(o=>{const a=Am({options:t,key:r,value:o});return[a.key,a.value].join("=")}):[r]},(r,[,i])=>i!=null).flat();return n.length?je({value:n.join("&"),prefix:"?"}):""}function Am({options:e,key:t,value:n}){return{key:qn(t,e),value:qn(String(n),e)}}function $m({hash:e,hostname:t,password:n,pathname:r,port:i,protocol:s,search:o,username:a}){return[s?s+"://":"",a?a+":":"",n?n+"@":"",zs({hostname:t,port:i}),uu({hash:e,pathname:r,search:o})].join("")}function Cm({pathname:e}){const t=Un({value:e,prefix:"/"});return t?t.split("/"):[]}function uu({hash:e,pathname:t,search:n}){return[je({value:t,prefix:"/"}),n?je({value:n,prefix:"?"}):"",e?je({value:e,prefix:"#"}):""].join("")}function zs({hostname:e,port:t}){return[e,t?":"+t:""].join("")}function km({hostname:e,port:t,protocol:n}){return[n,zs({hostname:e,port:t})].filter(E.isTruthy).join("://")}function is(e,t){const n=E.isString(e)?e:e.toString(),r=n.replace(/^[^#]*(?:#|$)/,""),i=r?je({value:qn(r,t),prefix:"#"}):"",s=n.replace(/#[^#]*$/,""),o=s.replace(/^[^?]*(?:\?|$)/,""),a=o?je({value:qn(o,t),prefix:"?"}):"",u=s.replace(/\?[^?]*$/,""),l=u.includes("://")?u.replace(/:\/\/.*$/,""):"",f=u.replace(/^.*:\/\//,"").replace(/\/\//g,"/"),c=f.replace(/@.*/,""),d=f.replace(/^[^@]*@/,""),p=c!==d,[y,...v]=p?c.split(":").reverse():[],C=v.toReversed().join("").replace(/[/:]/g,"")||"",A=y?.replace(/[/:]/g,"")||"",T=d.replace(/[:/].*/,""),I=d.replace(/^[^/:]*(:|\/|$)/,"$1"),_=Un({value:I.replace(/\/.*/,""),prefix:":"}),G=qn(I.replace(/^[^/]*(?:\/|$)/,"/"),t),De=zs({hostname:T,port:_}),It=km({hostname:T,port:_,protocol:l}),ke=$m({hash:i,hostname:T,password:A,pathname:G,port:_,protocol:l,search:a,username:C}),Re=Dm(a),dt=Cm({pathname:G});return{fullPath:uu({hash:i,pathname:G,search:a}),hash:i,host:De,hostname:T,href:ke,origin:It,password:A,pathname:G,paths:dt,port:_,protocol:l,search:a,searchParams:Re,username:C}}function d5(e,t,n){const r=E.isString(e)?e:e instanceof URL?e.toString():"",i=E.isString(e)||e instanceof URL?t:e,s=E.isString(e)||e instanceof URL?n:t,o=is(r),a=we(o,(d,p)=>{if(!E.hasKey(i,d))return p;const y=i[d];return E.isNumber(y)?String(y):E.isString(y)?d==="hash"&&y?je({value:y,prefix:"#"}):d==="pathname"?je({value:y,prefix:"/"}):y:p});E.hasKey(i,"paths")&&i.paths&&(a.pathname=au("",...i.paths));const u=E.isString(i.search)?Dm(je({value:i.search,prefix:"?"})):Xd(i.search||{}),l=l5(a.searchParams,u,{...s,encoding:Or.None}),f=f5(l,s);return{...a,searchParams:l,search:f,paths:Cm(a),fullPath:uu(a),host:zs(a),origin:km(a),href:$m({...a,search:f})}}const h5=tn({protocol:"",username:"",password:"",host:"",hostname:"",port:"",origin:"",pathname:"/",paths:[""],search:"",searchParams:u5,hash:"",fullPath:"/",href:"/"});({...h5.defaultValue});const m5=0;function Sm(e){return!(e.type!=="click"&&e.type!=="mousedown"||e.metaKey||e.altKey||e.ctrlKey||e.shiftKey||e.button!==m5)}const Gs="locationchange";globalThis.SPA_ROUTER_VIR_HISTORY_EVENTS_CONSOLIDATED_ALREADY=!1;const p5=globalThis.history.pushState;function Kc(...e){const t=p5.apply(globalThis.history,e);return globalThis.dispatchEvent(new Event(Gs)),t}const g5=globalThis.history.replaceState;function Zc(...e){const t=g5.apply(globalThis.history,e);return globalThis.dispatchEvent(new Event(Gs)),t}function w5(){if(!globalThis.SPA_ROUTER_VIR_HISTORY_EVENTS_CONSOLIDATED_ALREADY){{if(globalThis.history.pushState===Kc)throw new Gc("The consolidation module thinks that window events have not been consolidated yet but globalThis.history.pushState has already been overridden. Does this module have two copies in your repo?");if(globalThis.history.replaceState===Zc)throw new Gc("The consolidation module thinks that window events have not been consolidated yet but globalThis.history.replaceState has already been overridden. Does this module have two copies in your repo?")}globalThis.SPA_ROUTER_VIR_HISTORY_EVENTS_CONSOLIDATED_ALREADY=!0,globalThis.history.pushState=Kc,globalThis.history.replaceState=Zc,globalThis.addEventListener("popstate",()=>{globalThis.dispatchEvent(new Event(Gs))})}}function Ro(e,t){const n=is(e),r=Un({value:Un({value:n.pathname,prefix:je({value:t||"",prefix:"/"})}),prefix:"/"}),i=r?r.split("/"):[],s=Object.keys(n.searchParams).length?n.searchParams:void 0,o=n.hash?Un({value:n.hash,prefix:"#"}):void 0;return{paths:i,search:s,hash:o}}class y5{innerObservable;removeGlobalListener;sanitizationDepth=0;params;constructor(t){Uv(t,a5),this.params={...t};const n=this.readCurrentRoute();this.innerObservable=new nm({defaultValue:n,equalityCheck:()=>!1}),w5(),this.removeGlobalListener=Jh(globalThis,Gs,()=>{if(this.params.isPaused)return;if(this.sanitizationDepth>2)throw new o5("Looping route sanitization detected; aborting window URL change listener.");const r=Ro(globalThis.location.href,this.params.basePath),i=t.sanitizeRoute(r);E.jsonEquals(r,i)?(this.sanitizationDepth=0,this.innerObservable.setValue(i)):(this.sanitizationDepth++,this.setRoute(i,{replace:!0}),t.disableWarnings||console.warn("Route sanitized.",{from:r,to:i}))}),this.setRoute(n,{replace:!0})}routeIncludesBasePath(t){return!t.paths||!this.params.basePath?!1:au(...t.paths).startsWith(this.params.basePath)}readCurrentRoute(){return this.sanitizeRoute(Ro(globalThis.location.href,this.params.basePath))}sanitizeRoute(t){return this.params.sanitizeRoute(t)}createRouteUrl(t){const n=Ro(globalThis.location.href,void 0),r={...n,...t},i=this.sanitizeRoute(r),o=this.routeIncludesBasePath(n)&&!this.routeIncludesBasePath(i)&&this.params.basePath?{...i,paths:[this.params.basePath,...i.paths]}:i;return d5(globalThis.location.href,{paths:o.paths,search:o.search,hash:o.hash?je({value:o.hash,prefix:"#"}):"#"},{searchParamStrategy:_r.Clear}).href}setRoute(t,n={}){const r=this.createRouteUrl(t),{fullPath:i}=is(r);return this.params.isPaused||!n.force&&E.jsonEquals(is(globalThis.location.href).fullPath,i)?!1:n.replace?(globalThis.history.replaceState(void 0,"",i),!0):(globalThis.history.pushState(void 0,"",i),!0)}setRouteOnDirectNavigation(t,n){return Sm(n)?(n.preventDefault(),this.setRoute(t)):!1}listen(t,n){const r=this.params.maxListenerCount==null?1:this.params.maxListenerCount;if(r&&this.innerObservable.getListenerCount()>=r)throw new ou(`Attempting to attach more route listeners than the \`maxListenerCount\` of '${r}'.`);return this.innerObservable.listen(t,n),()=>this.removeListener(n)}removeListener(t){return this.innerObservable.removeListener(t)}getListenerCount(){return this.innerObservable.getListenerCount()}destroy(){this.params.isPaused=!0,this.removeGlobalListener(),this.innerObservable.destroy()}}function b5(e){return new y5({basePath:e,sanitizeRoute(t){return{paths:E5(t.paths),hash:void 0,search:void 0}}})}function E5(e){const t=e[0];if(E.isEnumValue(t,it)){if(t===it.Book)return[it.Book,...e.slice(1)];if(t===it.Search)return e[1]?[t,e[1]]:[it.Book,...e.slice(1)];throw new Error(`Route path not handled for sanitization: ${e.join("/")}`)}else return Zn.paths}const ss=su()("element-book-change-route"),Yc="vira-",{defineElement:v5}=wm({assertInputs:e=>{if(!e.tagName.startsWith(Yc))throw new Error(`Tag name should start with '${Yc}' but got '${e.tagName}'`)}}),Lt=v5,$=en({"vira-icon-stroke-color":"currentColor","vira-icon-fill-color":"none","vira-icon-stroke-width":"1px"}),D5=X;function A5(e){try{if(!e)throw new Error("invalid empty color");return new D5(e)}catch{throw new Error(`Invalid color: ${m(e)}`)}}function se({name:e,svgTemplate:t}){return{name:e,svgTemplate:t}}function Jc(e,t){const n=J(t).map(r=>{const i=t[r],s=A5(i);return`${$[r].name}: ${s.toString()};`}).join(" ");return se({name:e.name,svgTemplate:D`
    ...
    `}),ot=en({"vira-form-input-radius":"8px"}),Ks=F`
    pointer-events: none;
    opacity: 0.3;
    cursor: not-allowed;
`,at=en({"vira-extended-animation-duration":"1.2s","vira-pretty-animation-duration":"300ms","vira-interaction-animation-duration":"84ms"}),En=en({"vira-focus-outline-color":"#59b1ff","vira-focus-outline-border-radius":F`calc(${ot["vira-form-input-radius"].value} + 4px)`});function lu({selector:e,elementBorderSize:t,outlineGap:n=2,outlineWidth:r=2}){const i=le(th(r+n+t));return F`
        ${le(e)}::after {
            content: '';
            top: calc(${i} * -1);
            left: calc(${i} * -1);
    ...
    `}const Gt=en({"vira-form-border-color":"#cccccc","vira-form-background-color":"white","vira-form-foreground-color":"black","vira-form-focus-color":En["vira-focus-outline-color"].value,"vira-form-selection-hover-background-color":"#d2eaff","vira-form-selection-hover-foreground-color":"black"}),$5=F`
    padding: 0;
    margin: 0;
`,zt=F`
    ${$5};
...
`,Hc=F`#e2e2e2`,Tm={menuShadow:F`
    ...
    user-select: none;
`,O=Lt()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>F`
        :host {
    ...
    `,render({inputs:e}){return e.icon?e.icon.svgTemplate:""}}),Ct=Lt()({tagName:"vira-dropdown-item",hostClasses:{"vira-dropdown-item-selected":({inputs:e})=>e.selected},styles:({hostClasses:e})=>F`
        :host {
            display: flex;
            ${Vr};
        }
    ...
    `,render({inputs:e,dispatch:t,events:n}){const r=e.options.map(i=>{const s=i.template||D`
            ...
            `});return D`
            <slot>${r}</slot>
        `}}),V5=se({name:"Chat24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Im=se({name:"ChevronUp24Icon",svgTemplate:D`
        <svg
    ...
    `}),Rm=se({name:"CloseX24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <circle
                cx="12"
                cy="12"
    ...
    `}),U5=se({name:"Commit24Icon",svgTemplate:D`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            xml:space="preserve"
            width="24"
    ...
    `}),W5=se({name:"Document24Icon",svgTemplate:D`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            xml:space="preserve"
            width="24"
    ...
    `}),Om=se({name:"Element16Icon",svgTemplate:D`
    ...
    `}),St=se({name:"Element24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),_m=se({name:"EyeClosed24Icon",svgTemplate:D`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${$["vira-icon-fill-color"].value}
            stroke=${$["vira-icon-stroke-color"].value}
    ...
    `}),Vm=se({name:"EyeOpen24Icon",svgTemplate:D`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${$["vira-icon-fill-color"].value}
            stroke=${$["vira-icon-stroke-color"].value}
    ...
    `}),Um=se({name:"Loader24Icon",svgTemplate:D`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
...
`,qr=se({name:"LoaderAnimated24Icon",svgTemplate:D`
        <style>
            ${q5}
        </style>
        ${Um.svgTemplate}
    `}),fu=se({name:"Options24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <g
                fill=${$["vira-icon-fill-color"].value}
                stroke=${$["vira-icon-stroke-color"].value}
    ...
    `}),j5=se({name:"Pencil24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),z5=se({name:"Shield24Icon",svgTemplate:D`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            xml:space="preserve"
            width="24"
    ...
    `}),G5=se({name:"SpeakerLoud24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),K5=se({name:"SpeakerMedium24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Z5=se({name:"SpeakerMuted24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Y5=se({name:"SpeakerQuiet24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),J5=se({name:"Star24Icon",svgTemplate:D`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
    ...
    `}),os=se({name:"StatusFailure24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <circle
                cx="12"
                cy="12"
    ...
    `}),H5=se({name:"StatusInProgress24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <circle
                cx="12"
                cy="12"
    ...
    `}),Q5=se({name:"StatusSuccess24Icon",svgTemplate:D`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <circle
                cx="12"
                cy="12"
    ...
    `}),ya={Chat24Icon:V5,Check24Icon:Fm,ChevronUp24Icon:Im,CloseX24Icon:Rm,Commit24Icon:U5,Document24Icon:W5,Element16Icon:Om,Element24Icon:St,EyeClosed24Icon:_m,EyeOpen24Icon:Vm,Loader24Icon:Um,LoaderAnimated24Icon:qr,Options24Icon:fu,Pencil24Icon:j5,Shield24Icon:z5,SpeakerLoud24Icon:G5,SpeakerMedium24Icon:K5,SpeakerMuted24Icon:Z5,SpeakerQuiet24Icon:Y5,Star24Icon:J5,StatusFailure24Icon:os,StatusInProgress24Icon:H5,StatusSuccess24Icon:Q5};class X5 extends nm{constructor(){super({defaultValue:document.hidden,equalityCheck:E.strictEquals}),globalThis.addEventListener("visibilitychange",n=>this.updateVisibility(n));const t=n=>this.updateVisibility(n);globalThis.onpageshow=t,globalThis.onpagehide=t,globalThis.onfocus=t,globalThis.onblur=t}updateVisibility(t){const n=tA.includes(t.type),r=eA.includes(t.type),i=n?!0:r?!1:document.hasFocus()||!document.hidden;this.setValue(i)}}const eA=["blur","focusout","pagehide"],tA=["focus","focusin","pageshow"],nA=new X5;function rA(e,t){return nA.listen(e,t)}const rf={top:0,left:0,right:0,bottom:0};class Wm extends oh("hide-pop-up"){}class qm extends sh()("nav-select"){}class iA{listenTarget=new Yh;options={minDownSpace:200,verticalDiffThreshold:20,supportNavigation:!0};cleanupCallbacks=[];lastRootElement;constructor(t){this.options={...this.options,...t}}attachGlobalListeners(t){const n=new Lm(t);this.cleanupCallbacks=[rA(!1,r=>{r||this.removePopUp()}),Cl("mousedown",r=>{this.lastRootElement&&r.composedPath().includes(this.lastRootElement)||this.removePopUp()},{passive:!0}),Cl("keydown",r=>{const i=r.code;if(i==="Escape")this.removePopUp();else if(this.options.supportNavigation){if(i==="ArrowDown")r.stopImmediatePropagation(),r.preventDefault(),n.navigate({direction:He.Down,allowWrapping:!1});else if(i==="ArrowUp")r.stopImmediatePropagation(),r.preventDefault(),n.navigate({direction:He.Up,allowWrapping:!1});else if(i==="ArrowLeft")r.stopImmediatePropagation(),r.preventDefault(),n.navigate({direction:He.Left,allowWrapping:!1});else if(i==="ArrowRight")r.stopImmediatePropagation(),r.preventDefault(),n.navigate({direction:He.Right,allowWrapping:!1});else if(i==="Enter"||i==="Return"){const s=n.getCurrentlyFocused();s&&(n.enterInto(),this.listenTarget.dispatch(new qm({detail:s.node.coords})),r.stopImmediatePropagation(),r.preventDefault())}}})]}listen(t,n,r){return this.listenTarget.listen(t,n,r)}removePopUp(){this.cleanupCallbacks.forEach(t=>t()),this.listenTarget.dispatch(new Wm)}showPopUp(t,n){this.lastRootElement=t;const r={...this.options,...n},i=ZD(t);ir.instanceOf(i,HTMLElement);const s=t.getBoundingClientRect(),o=i.getBoundingClientRect(),a=i.offsetWidth-i.clientWidth,u=i.offsetHeight-i.clientHeight,l=i===document.body?{top:0,left:0,right:globalThis.innerWidth,bottom:globalThis.innerHeight}:{top:o.top,left:o.left,right:o.right-a,bottom:o.bottom-u},f=we(rf,p=>s[p]),c=we(rf,p=>{const y=l[p],v=f[p];return Math.abs(y-v)}),d=c.top>c.bottom+r.verticalDiffThreshold&&c.bottom<r.minDownSpace;return this.attachGlobalListeners(t),{popDown:!d,positions:{container:l,root:f,diff:c}}}destroy(){this.removePopUp(),this.listenTarget.destroy()}}function sA({selected:e,options:t,isMultiSelect:n}){if(e.length&&t.length){const r=t.filter(i=>e.includes(i.id));return r.length>1&&!n?(console.error("vira-dropdown has multiple selections but `isMultiSelect` is not `true`. Truncating to the first selection."),r.slice(0,1)):r}else return[]}function oA(e){const t=new Set,n=[];if(e.forEach(r=>{t.has(r.id)?n.push(r.id):t.add(r.id)}),n.length)throw new Error(`Duplicate option ids were given to ViraDropdown: ${Sy(n)}`)}function sf(e,t,n){return n?t.includes(e)?t.filter(r=>r!==e):[...t,e]:[e]}function of({open:e,emitEvent:t},{updateState:n,popUpManager:r,dispatch:i,host:s}){e?n({showPopUpResult:r.showPopUp(s)}):r.removePopUp(),t&&i(e)}const Ci={trigger:"dropdown-trigger",icon:"dropdown-icon",prefix:"dropdown-prefix",options:"dropdown-options"},vr=Lt()({tagName:"vira-dropdown",hostClasses:{"vira-dropdown-disabled":({inputs:e})=>!!e.isDisabled},styles:({hostClasses:e})=>F`
        :host {
            display: inline-flex;
    ...
    `,events:{selectedChange:ct(),openChange:ct()},stateInitStatic:{showPopUpResult:void 0,popUpManager:xD(()=>new iA),navController:void 0},cleanup({state:e,updateState:t}){t({showPopUpResult:void 0}),e.popUpManager.destroy()},init({state:e,updateState:t,host:n,inputs:r,dispatch:i,events:s}){e.popUpManager.listen(Wm,()=>{if(t({showPopUpResult:void 0}),!r.isDisabled){const o=n.shadowRoot.querySelector(".dropdown-wrapper");ir.instanceOf(o,HTMLButtonElement,"failed to find dropdown wrapper child"),o.focus()}}),e.popUpManager.listen(qm,o=>{const a=o.detail.x,u=r.options[a];if(!u)throw new Error(`Found no dropdown option at index '${a}'`);r.isMultiSelect||of({emitEvent:!0,open:!1},{dispatch:l=>{i(new s.openChange(l))},host:n,popUpManager:e.popUpManager,updateState:t}),i(new s.selectedChange(sf(u.id,r.selected,!!r.isMultiSelect)))}),t({navController:new Lm(n)})},render({dispatch:e,events:t,state:n,inputs:r,updateState:i,host:s}){oA(r.options);function o(y){of(y,{dispatch:v=>{e(new t.openChange(v))},host:s,popUpManager:n.popUpManager,updateState:i})}r.isDisabled?o({open:!1,emitEvent:!1}):r.z_debug_forceOpenState!=null&&(!r.z_debug_forceOpenState&&n.showPopUpResult?o({emitEvent:!1,open:!1}):r.z_debug_forceOpenState&&!n.showPopUpResult&&o({emitEvent:!1,open:!0}));const a=sA(r),u=r.icon?D`
              ...
              `:"",l=n.showPopUpResult?n.showPopUpResult.popDown?F`
                  ...
                  `:"",p=c?r.placeholder||"":a.map(y=>y.label).join(", ");return D`
            <button
    ...
    `,render:({inputs:e})=>{const t=e.icon?D`
        ...
        `}}),vt=Lt()({tagName:"vira-collapsible-wrapper",hostClasses:{"vira-collapsible-wrapper-expanded":({inputs:e})=>e.expanded},slotNames:["header"],styles:({hostClasses:e})=>F`
        :host {
            display: flex;
            flex-direction: column;
        }
    ...
    `,events:{expandChange:ct()},stateInitStatic:{contentHeight:0},render({state:e,slotNames:t,updateState:n,dispatch:r,events:i,inputs:s}){const o=s.expanded?F`
        ...
        `}}),_t=Lt()({tagName:"vira-image",hostClasses:{"vira-image-height-constrained":({inputs:e})=>e.dominantDimension==="height"},slotNames:["loading","error"],events:{imageLoad:ct(),imageError:ct()},styles:({hostClasses:e})=>F`
        :host {
            display: inline-flex;
            overflow: hidden;
            flex-direction: column;
    ...
    `,stateInitStatic:{loadedUrls:{},erroredUrls:{}},render({inputs:e,state:t,updateState:n,dispatch:r,events:i,slotNames:s}){const o=e.imageUrl,a=t.erroredUrls[o]?D`
            ...
            <img
                ...
                src=${o}
            />
        `}});function ba({input:e,matcher:t}){return!e||!t?!0:e.length>1?!!e.split("").every(n=>ba({input:n,matcher:t})):t instanceof RegExp?!!e.match(t):t.includes(e)}function aA({value:e,allowed:t,blocked:n}){const r=t?ba({input:e,matcher:t}):!0,i=n?ba({input:e,matcher:n}):!1;return r&&!i}function Ea(e){if(!e.value)return{filtered:e.value,blocked:""};const{filtered:t,blocked:n}=e.value.split("").reduce((r,i)=>(aA({...e,value:i})?r.filtered.push(i):r.blocked.push(i),r),{filtered:[],blocked:[]});return{filtered:t.join(""),blocked:n.join("")}}function uA({inputs:e,previousValue:t,event:n,inputBlockedCallback:r,newValueCallback:i}){if(!(n instanceof InputEvent))throw new TypeError("Text input event was not an InputEvent.");const s=Er(n,HTMLInputElement),o=n.data;if(o){const{blocked:u}=Ea({value:o,allowed:e.allowedInputs,blocked:e.blockedInputs});u.length&&r(u)}const a=Ea({value:s.value,allowed:e.allowedInputs,blocked:e.blockedInputs}).filtered;s.value!==a&&(s.value=a),t!==a&&i(a)}var zm=(e=>(e.Default="text",e.Password="password",e.Email="email",e))(zm||{});const oe=Lt()({tagName:"vira-input",hostClasses:{"vira-input-disabled":({inputs:e})=>!!e.disabled,"vira-input-fit-text":({inputs:e})=>!!e.fitText,"vira-input-clear-button-shown":({inputs:e})=>!!e.showClearButton},cssVars:{"vira-input-background-color":"white","vira-input-placeholder-color":"#cccccc","vira-input-text-color":"#000000","vira-input-border-color":"#cccccc","vira-input-focus-border-color":En["vira-focus-outline-color"].default,"vira-input-text-selection-color":"#cfe9ff","vira-input-action-button-color":"#aaaaaa","vira-input-clear-button-hover-color":"#ff0000","vira-input-clear-button-active-color":"#b30000","vira-input-show-password-button-hover-color":"#0a89ff","vira-input-show-password-button-active-color":"#0261ba","vira-input-padding-horizontal":"10px","vira-input-padding-vertical":"6px"},events:{valueChange:ct(),inputBlocked:ct()},styles:({hostClasses:e,cssVars:t})=>F`
            :host {
                position: relative;
                display: inline-flex;
                width: 224px;
        ...
        `,stateInitStatic:{forcedInputWidth:0,showPassword:!1},render:({inputs:e,dispatch:t,state:n,updateState:r,events:i})=>{const{filtered:s}=Ea({value:e.value,allowed:e.allowedInputs,blocked:e.blockedInputs}),o=e.icon?D`
            ...
            <label>
                ...
                <input
                    ...
                    ?disabled=${e.disabled}
                    .value=${s}
                    ${Q("input",l=>{uA({inputs:e,previousValue:s,event:l,inputBlockedCallback(f){t(new i.inputBlocked(f))},newValueCallback(f){t(new i.valueChange(f))}})})}
                    placeholder=${e.placeholder}
                />
                ${Be(!!(e.showClearButton&&e.value),D`
                        <button
        ...
        `}});function lA(e,t){return e==="password"&&t?"text":e||"text"}const ki=Lt()({tagName:"vira-link",cssVars:{"vira-link-hover-color":"currentColor"},styles:({cssVars:e})=>F`
        :host {
            display: inline;
    ...
    `,render({inputs:e}){function t(n){e.route&&e.route.router.setRouteOnDirectNavigation(e.route.route,n)&&e.route.scrollToTop&&window.scrollTo(0,0)}if(e.link?.newTab)return D`
            ...
            `}}}),{defineElement:tt}=wm(),Qe=tt()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>F`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,render:({inputs:e,dispatch:t})=>{const n=e.router?.createRouteUrl({...e.route})??"#";return D`
        ...
        `}});function cA(e,t){return e.entry.entryType===ve.Root?!1:e.entry.entryType===ve.Page||E.jsonEquals(t,e.fullUrlBreadcrumbs.slice(0,-1))?!0:E.jsonEquals(t?.slice(0,-1),e.fullUrlBreadcrumbs.slice(0,-1))}const At=tt()({tagName:"book-nav",cssVars:{"book-nav-internal-indent":"0"},styles:({cssVars:e})=>F`
        :host {
            display: flex;
            flex-direction: column;
            padding: 16px 0;
    ...
    `,render({inputs:e}){const t=e.flattenedNodes.map(n=>{if(!cA(n,e.selectedPath))return;const r=F`
        ...
        `}});async function fA(e){await ma(2);const t=e.shadowRoot.querySelector(".selected");if(!t)throw new Error("Failed to find selected nav tree element.");await GD(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const Xt=tt()({tagName:"book-error",styles:F`
        :host {
            display: flex;
            flex-direction: column;
            color: red;
    ...
    `,render({inputs:e}){return(E.isArray(e.message)?e.message:[e.message]).map(n=>D`
                <p>${n}</p>
            `)}}),jr=tt()({tagName:"book-page-controls",events:{controlValueChange:ct()},hostClasses:{"book-page-controls-has-controls":({inputs:e})=>!!Object.keys(e.config).length},styles:({hostClasses:e})=>F`
        :host {
            display: flex;
            flex-wrap: wrap;
    ...
    `,render({inputs:e,dispatch:t,events:n}){return Object.entries(e.config).length?Object.entries(e.config).map(([r,i],s)=>{if(i.controlType===Y.Hidden)return"";const o=dA(e.currentValues[r],i,a=>{const u=E.isArray(e.fullUrlBreadcrumbs)?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[r];if(!u)throw new Error(`Failed to find breadcrumbs from given control name: '${r}'`);t(new n.controlValueChange({fullUrlBreadcrumbs:u,newValues:{...e.currentValues,[r]:a}}))});return D`
                ...
                `}):""}});function dA(e,t,n){return Cn(t,Y.Hidden)?"":Cn(t,Y.Checkbox)?D`
            <input
                type="checkbox"
                .value=${e}
        ...
        `:Cn(t,Y.Color)?D`
            ...
            />
        `:Cn(t,Y.Text)?D`
            <${oe.assign({value:String(e),showClearButton:!0,disableBrowserHelps:!0})}
                ${Q(oe.events.valueChange,r=>{n(r.detail)})}
            ></${oe}>
        `:Cn(t,Y.Number)?D`
            <input
                type="number"
        ...
        `}const af=tt()({tagName:"book-breadcrumbs",styles:F`
        :host {
            display: flex;
            color: #999;
        }
    ...
    `,render:({inputs:e})=>{const t=e.currentRoute.paths.slice(1);return t.length?t.map((n,r,i)=>{const s=r>=i.length-1,o=i.slice(0,r+1),a=s?"":D`
            ...
            `}):D`
                &nbsp;
            `}}),Oo=tt()({tagName:"book-breadcrumbs-bar",styles:F`
        :host {
    ...
    `,render({inputs:e,dispatch:t}){return D`
            ...
            />
        `}}),uf=tt()({tagName:"book-entry-description",styles:F`
        :host {
            color: ${Z["element-book-page-foreground-faint-level-1-color"].value};
            display: inline-flex;
            flex-direction: column;
    ...
    `,render({inputs:e}){return e.descriptionParagraphs.map(t=>D`
                <p>${t}</p>
            `)}}),lf=tt()({tagName:"book-page-wrapper",styles:F`
        :host {
            display: block;
        }
    ...
    `,render({inputs:e}){const t=e.isTopLevel?D`
              ...
              `,n=[it.Book,...e.pageNode.fullUrlBreadcrumbs],r=e.pageNode.entry.errors.length?Qd(e.pageNode.entry.errors):void 0;return r&&console.error(r),D`
        ...
        `}}),Si=tt()({tagName:"book-element-example-controls",styles:F`
        :host {
            display: flex;
            color: ${Z["element-book-page-foreground-faint-level-1-color"].value};
    ...
    `,render({inputs:e}){const t=[it.Book,...e.elementExampleNode.fullUrlBreadcrumbs];return D`
        ...
        `}}),cf=Symbol("unset-internal-state"),ff=tt()({tagName:"book-element-example-viewer",stateInitStatic:{isUnset:cf},render({state:e,inputs:t,updateState:n}){try{if(t.elementExampleNode.entry.errors.length)throw Qd(t.elementExampleNode.entry.errors);if(!t.elementExampleNode.entry.render||typeof t.elementExampleNode.entry.render=="string")throw new Error(`Failed to render example '${t.elementExampleNode.entry.title}': render is not a function`);e.isUnset===cf&&n({isUnset:void 0,...t.elementExampleNode.entry.stateInitStatic});const r=t.elementExampleNode.entry.render({state:e,updateState:n,controls:t.currentPageControls});if(r instanceof Promise)throw new TypeError("render output cannot be a promise");return D`
                ${Be(!!t.elementExampleNode.entry.styles,D`
                        <style>
                            ${t.elementExampleNode.entry.styles}
                        </style>
                    `)}
                ${r}
            `}catch(r){return console.error("ERROR HERE",Ce(r)),console.error(r),D`
                <${Xt.assign({message:`${t.elementExampleNode.entry.title} failed: ${Ce(r)}`})}></${Xt}>
            `}},options:{allowPolymorphicState:!0}}),df=tt()({tagName:"book-element-example-wrapper",styles:F`
        :host {
            display: inline-flex;
            flex-direction: column;
            gap: 24px;
    ...
    `,render({inputs:e}){return D`
        ...
        `}});function Gm(e,t,n,r){const i=Jo(n,r),s=[];if(i){const o=Gm(e,t,i,r);o&&s.push(o)}if(Wn(n,ve.Page)&&!e.includes(n)){const o=Va(t,n.fullUrlBreadcrumbs);s.push({config:n.entry.controls,current:o,breadcrumbs:we(o,()=>n.fullUrlBreadcrumbs)})}return s.reduce((o,a)=>({config:{...o.config,...a.config},current:{...o.current,...a.current},breadcrumbs:{...o.breadcrumbs,...a.breadcrumbs}}),{config:{},current:{},breadcrumbs:{}})}function hA({currentNodes:e,isTopLevel:t,router:n,isSearching:r,controls:i,originalTree:s}){if(!e.length&&r)return[D`
                No results
            `];const o=E.isLengthAtLeast(e,1)?Gm(e,i,e[0],s):void 0,a=o&&Object.values(o.config).length&&E.isLengthAtLeast(e,1)?D`
                  <${jr.assign({config:o.config,currentValues:o.current,fullUrlBreadcrumbs:o.breadcrumbs})}></${jr}>
              `:re,u=SD(e,l=>l.fullUrlBreadcrumbs.join(">"),l=>{if(Wn(l,ve.Page))return D`
                    <${lf.assign({isTopLevel:t,pageNode:l,controls:i,router:n})}
                        class="block-entry"
                    ></${lf}>
                `;if(Wn(l,ve.ElementExample)){const f=Va(i,l.fullUrlBreadcrumbs.slice(0,-1));return D`
                    <${df.assign({elementExampleNode:l,currentPageControls:f,router:n})}
                        class="inline-entry"
                    ></${df}>
                `}else return Wn(l,ve.Root)?re:D`
                    <${Xt.assign({message:`Unknown entry type for rendering: '${l.entry.entryType}'`})}
                        class="block-entry"
                    ></${Xt}>
                `});return[a,u]}const Mn=tt()({tagName:"book-entry-display",styles:F`
        :host {
            display: flex;
            flex-direction: column;
            position: relative;
    ...
    `,events:{loadingRender:ct()},stateInitStatic:{lastElement:void 0},render:({inputs:e,dispatch:t,events:n,state:r,updateState:i})=>{const s=Ho(e.currentRoute.paths),o=hA({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!s,controls:e.controls,originalTree:e.originalTree});return D`
            ...
            ${Be(e.showLoading,D`
                ...
                `,D`
                    ...
                    <slot name=${kt.Footer}></slot>
                `)}
        `}});function mA(e,t,n){const r=hf(e,t);return r.length?r:(n(Zn),hf(e,Zn.paths))}function hf(e,t){return e.filter(n=>Q2({searchFor:t.slice(1),searchIn:n.fullUrlBreadcrumbs}))}const _o=pm()({tagName:"element-book-app",events:{pathUpdate:ct()},stateInitStatic:{currentRoute:Zn,router:void 0,loading:!0,colors:{config:void 0,theme:zc(void 0)},treeBasedControls:void 0,originalWindowTitle:void 0},styles:F`
        :host {
            display: flex;
            flex-direction: column;
            height: 100%;
    ...
    `,init({host:e,state:t}){setTimeout(async()=>{await mf(e,Ho(t.currentRoute.paths),t.currentRoute)},500)},cleanup({state:e,updateState:t}){e.router&&(e.router.destroy(),t({router:void 0}))},render:({state:e,inputs:t,host:n,updateState:r,dispatch:i,events:s})=>{t._debug&&console.info("rendering element-book app");function o(f){return{...e.currentRoute,...f}}function a(f){const c=o(f);return!E.jsonEquals(e.currentRoute,c)}function u(f){t.preventWindowTitleChange||(e.originalWindowTitle||r({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,f].filter(E.isTruthy).join(" - "))}function l(f){if(!a(f))return;const c=o(f);e.router?e.router.setRoute(c):r({currentRoute:{...e.currentRoute,...c}}),t.elementBookRoutePaths&&!E.jsonEquals(t.elementBookRoutePaths,e.currentRoute.paths)&&i(new s.pathUpdate(c.paths))}try{if(t.elementBookRoutePaths&&!E.jsonEquals(t.elementBookRoutePaths,e.currentRoute.paths)&&l({paths:t.elementBookRoutePaths}),t.internalRouterConfig?.useInternalRouter&&!e.router){const A=b5(t.internalRouterConfig.basePath);r({router:A}),A.listen(!0,T=>{r({currentRoute:T})})}else!t.internalRouterConfig?.useInternalRouter&&e.router&&e.router.destroy();const f={themeColor:t.themeColor};if(!E.jsonEquals(f,e.colors.config)){const A=zc(f);r({colors:{config:f,theme:A}}),Nb(n,A)}const c=t._debug??!1,d=rb({entries:t.pages,debug:c});(!e.treeBasedControls||e.treeBasedControls.pages!==t.pages||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),r({treeBasedControls:{pages:t.pages,lastGlobalInputs:t.globalValues??{},controls:e0(d.tree,{children:e.treeBasedControls?.controls.children,controls:t.globalValues})}}));const p=Ho(e.currentRoute.paths),v=(p?s5({flattenedNodes:d.flattenedNodes,searchQuery:p}):void 0)??mA(d.flattenedNodes,e.currentRoute.paths,l);u(v[0]?.entry.title);const C=e.treeBasedControls?.controls;return C?(t._debug&&console.info({currentControls:C}),D`
                <div
                    class="root"
                    ${Q(ss,async A=>{const T=A.detail;if(!a(T))return;if(r({loading:!0}),l(T),!(n.shadowRoot.querySelector(At.tagName)instanceof At))throw new TypeError(`Failed to find child '${At.tagName}'`);await mf(n,p,e.currentRoute)})}
                    ${Q(jr.events.controlValueChange,A=>{if(!e.treeBasedControls)return;const T=sb(C,A.detail.fullUrlBreadcrumbs,A.detail.newValues);r({treeBasedControls:{...e.treeBasedControls,controls:T}})})}
                >
                    ...
                    <${Mn.assign({controls:C,currentNodes:v,currentRoute:e.currentRoute,debug:c,originalTree:d.tree,router:e.router,showLoading:e.loading})}
                        ${Q(Mn.events.loadingRender,async A=>{await ma();const T=n.shadowRoot.querySelector(Mn.tagName);T?T.scroll({top:0,behavior:"instant"}):console.error(`Failed to find '${Mn.tagName}' for scrolling.`),await ma(),r({loading:!A.detail})})}
                    >
                        <slot
                            name=${kt.Footer}
                            slot=${kt.Footer}
        ...
        `,inputs:{label:"wide",selected:!0}}],gA=ft({title:Ct.tagName,parent:du,controls:{Selected:{controlType:Y.Dropdown,initValue:"",options:["","all","none"]},Label:{controlType:Y.Text,initValue:""}},defineExamples({defineExample:e}){pA.forEach(t=>{e({title:t.title,stateInitStatic:{selected:t.inputs.selected||[]},styles:t.customStyle,render({controls:n}){const r={label:n.Label||t.inputs.label,selected:n.Selected?n.Selected==="all":t.inputs.selected};return t.customTemplate?D`
                            <${Ct.assign(r)}>
                                ${t.customTemplate}
                            </${Ct}>
                        `:D`
                            <${Ct.assign(r)}></${Ct}>
                        `}})})}}),kr=[{label:"Option 1",id:1},{label:"Option 2",id:2},{label:"Option 3",id:3},{label:"Really really super duper long option",id:4},{label:"Really really super duper long option",id:5},{label:"Really really super duper long option",id:6},{label:"Really really super duper long option",id:7},{label:"Really really super duper long it just keeps going because it's so long option",id:8}],wA=[{title:"default"},{title:"disabled",inputs:{isDisabled:!0}},{title:"short options",inputs:{options:[{id:"1",label:"1"},{id:"2",label:"2"}]}},{title:"multi select",inputs:{isMultiSelect:!0}},{title:"long selection",inputs:{selected:[8]}},{title:"with custom template",inputs:{selected:[],options:[...kr,{id:42,label:"custom template",template:D`
                        <select>
                            <option selected>NESTED SELECT!!!</option>
                            <option>this is a terrible idea</option>
                            <option>pls don't do this</option>
                        </select>
                    `}]}},{title:"with disabled item",inputs:{selected:[],options:[...kr,{id:42,label:"this is disabled",disabled:!0}]}},{title:"constrained width",customStyle:F`
            :host {
                max-width: 150px;
            }
        ...
        `},{title:"without a placeholder",inputs:{placeholder:void 0}},{title:"with a prefix",inputs:{selectionPrefix:"Pre:",selected:[1]}},{title:"with an icon",inputs:{icon:St}}],yA=ft({title:vr.tagName,parent:du,controls:{Selected:{controlType:Y.Dropdown,initValue:"",options:["",...kr.map(e=>e.label)]},Prefix:{controlType:Y.Text,initValue:""},"Force State":{controlType:Y.Dropdown,options:["","force open","force closed"],initValue:""},"Multi Select":{controlType:Y.Dropdown,options:["","all","none"],initValue:""},Icon:{controlType:Y.Dropdown,initValue:"",options:["",...Object.keys(ya)]},Disabled:{controlType:Y.Dropdown,options:["","all","none"],initValue:""},Placeholder:{controlType:Y.Text,initValue:"Select something"}},defineExamples({defineExample:e}){wA.forEach(t=>{e({title:t.title,stateInitStatic:{selected:t.inputs?.selected||[]},styles:t.customStyle,render({state:n,updateState:r,controls:i}){const s={placeholder:t.inputs&&"placeholder"in t.inputs?t.inputs.placeholder:i.Placeholder,options:t.inputs?.options||kr,selected:i.Selected?[kr.find(o=>o.label===i.Selected)?.id].filter(E.isTruthy):n.selected,selectionPrefix:i.Prefix||t.inputs?.selectionPrefix,isDisabled:i.Disabled?i.Disabled==="all":t.inputs?.isDisabled,icon:i.Icon?ya[i.Icon]:t.inputs?.icon,isMultiSelect:i["Multi Select"]?i["Multi Select"]==="all":t.inputs?.isMultiSelect,z_debug_forceOpenState:i["Force State"]?i["Force State"]==="force open":t.inputs?.z_debug_forceOpenState};return D`
                        <${vr.assign(s)}
                            ${Q(vr.events.selectedChange,o=>{r({selected:o.detail})})}
                        ></${vr}>
                    `}})})}}),bA=ft({title:"Icons",parent:void 0,controls:{"Stroke Color":{controlType:Y.Color,initValue:""},"Fill Color":{controlType:Y.Color,initValue:""},"Stroke Width":{controlType:Y.Number,initValue:1}},defineExamples({defineExample:e}){Object.values(ya).forEach(t=>{e({title:t.name,styles:F`
                    :host(:hover) ${O} {
                ...
                `,render({controls:n}){const r=F`
                        ${$["vira-icon-fill-color"].name}: ${le(n["Fill Color"]||"inherit")};
                        ${$["vira-icon-stroke-color"].name}: ${le(n["Stroke Color"]||"inherit")};
                        ${$["vira-icon-stroke-width"].name}: ${le(n["Stroke Width"]?th(n["Stroke Width"]):"inherit")};
                    `;return D`
                        <${O.assign({icon:t})} style=${r}></${O}>
                    `}})})}}),EA=ft({parent:rn,title:de.tagName,descriptionParagraphs:["Standard button element. All colors are customizable with CSS vars. Size is flexible. Press tab to see focus outlines!"],controls:{"Primary color":{controlType:Y.Color,initValue:de.cssVars["vira-button-primary-color"].default},"Secondary color":{controlType:Y.Color,initValue:de.cssVars["vira-button-secondary-color"].default},"Hover color":{controlType:Y.Color,initValue:de.cssVars["vira-button-primary-hover-color"].default},"Active color":{controlType:Y.Color,initValue:de.cssVars["vira-button-primary-active-color"].default}},defineExamples({defineExample:e}){function t({title:n,styles:r,inputs:i}){const s=r??F``;e({title:n,styles:s,render({controls:o}){const a=F`
                        ${de.cssVars["vira-button-primary-color"].name}: ${le(o["Primary color"]||"inherit")};
                        ${de.cssVars["vira-button-secondary-color"].name}: ${le(o["Secondary color"]||"inherit")};
                        ${de.cssVars["vira-button-primary-hover-color"].name}: ${le(o["Hover color"]||"inherit")};
                        ${de.cssVars["vira-button-primary-active-color"].name}: ${le(o["Active color"]||"inherit")};
                    `;return D`
                        <${de.assign({text:"hello",...i})}
                            style=${a}
                        ></${de}>
                    `}})}t({title:"basic"}),t({title:"with icon",inputs:{icon:fu}}),t({title:"outline",inputs:{buttonStyle:jm.Outline}}),t({title:"disabled",inputs:{disabled:!0}}),t({title:"custom width",styles:F`
                ${de} {
                    width: 100px;
                }
            ...
            `,render(){return D`
                ...
                `}})}}),vA=ft({title:vt.tagName,parent:rn,descriptionParagraphs:["A very basic collapsible wrapper element that expands to fit its content with smooth animations. The animations even adapt to dynamic child sizes!","This element does not make any assumptions on styling, all styles are applied by consumers."],defineExamples({defineExample:e}){e({title:"stacked examples",styles:F`
                .section-header {
                    padding: 16px;
            ...
            `,stateInitStatic:{expandedStates:[],showMoreStates:[]},render({updateState:t,state:n}){return new Array(3).fill(0).map((r,i)=>D`
                        <${vt.assign({expanded:!!n.expandedStates[i]})}
                            ${Q(vt.events.expandChange,s=>{const o=[...n.expandedStates];o[i]=s.detail,t({expandedStates:o})})}
                        >
                            <div
                                class="section-header"
                                slot=${vt.slotNames.header}
                            >
                                Section ${i}
                            </div>
            ...
            `,stateInitStatic:{expandedStates:[],showMoreStates:[]},render({updateState:t,state:n}){return new Array(3).fill(0).map((r,i)=>D`
                    ...
                    `)}})}}),DA=ft({title:O.tagName,parent:rn,descriptionParagraphs:["See the 'Icons' page for a list of all included icons."],defineExamples({defineExample:e}){e({title:"basic",render(){return D`
                    <${O.assign({icon:St})}></${O}>
            ...
            `,render(){return D`
                ...
                `,stateInitStatic:{imageUrl:n.inputs.imageUrl},render({state:r,updateState:i}){return D`
                    ...
                    `}})})}}),$A=ft({title:oe.tagName,parent:rn,descriptionParagraphs:["Supports placeholders, suffixes, icons, disabling browser helps (like spellchecking), blocking/allowing specific inputs, etc.","Has completely customizable sizing and coloring."],controls:{"Text color":{controlType:Y.Color,initValue:oe.cssVars["vira-input-text-color"].default},"Placeholder color":{controlType:Y.Color,initValue:oe.cssVars["vira-input-placeholder-color"].default},"Border color":{controlType:Y.Color,initValue:oe.cssVars["vira-input-border-color"].default},"Focus color":{controlType:Y.Color,initValue:oe.cssVars["vira-input-focus-border-color"].default},"Selection color":{controlType:Y.Color,initValue:oe.cssVars["vira-input-text-selection-color"].default}},defineExamples({defineExample:e}){function t({styles:r,title:i,inputs:s}){e({title:i,styles:F`
                    ${r||F``}
                `,stateInitStatic:{value:s.value},render({state:o,updateState:a,controls:u}){const l={[String(oe.cssVars["vira-input-text-color"].name)]:u["Text color"],[String(oe.cssVars["vira-input-placeholder-color"].name)]:u["Placeholder color"],[String(oe.cssVars["vira-input-border-color"].name)]:u["Border color"],[String(oe.cssVars["vira-input-focus-border-color"].name)]:u["Focus color"],[String(oe.cssVars["vira-input-text-selection-color"].name)]:u["Selection color"]},f=we(l,(d,p)=>p||"inherit"),c=Object.entries(f).map(([d,p])=>[d,p].join(": ")+";").join(`
`);return D`
                        <${oe.assign({...s,value:o.value})}
                            style=${c}
                            ${Q(oe.events.valueChange,d=>{a({value:d.detail})})}
                        ></${oe}>
                ...
                `,inputs:{value:"",placeholder:"width",icon:St}},{title:"taller height",styles:F`
                    ${oe} {
                        height: 48px;
                    }
                `,inputs:{value:"",placeholder:"taller",icon:St}},{title:"shorter height",styles:F`
                    ${oe} {
                        height: 26px;
                    }
                `,inputs:{value:"",placeholder:"shorter",showClearButton:!0,icon:St}},{title:"max width",styles:F`
                    ${oe} {
                        max-width: 150px;
                    }
                ...
                `,inputs:{value:"",placeholder:"42",fitText:!0}},{title:"password",inputs:{value:"as password",type:zm.Password}}].forEach(t)}}),CA=ft({title:ki.tagName,parent:rn,descriptionParagraphs:["Securely handles hyperlinks or route changes without harming right click or modifier+click functionality."],controls:{"CSS Color":{controlType:Y.Color,initValue:""},"Hover color":{controlType:Y.Color,initValue:""}},defineExamples({defineExample:e}){function t({title:n,inputs:r}){e({title:n,render({controls:i}){const s=F`
                        ${ki.cssVars["vira-link-hover-color"].name}: ${le(i["Hover color"]||"inherit")};
                        color: ${le(i["CSS Color"]||"inherit")};
                    `;return D`
                        <${ki.assign(r)} style=${s}>My Link</${ki}>
                    `}})}t({title:"with URL",inputs:{link:{newTab:!0,url:"https://www.wikipedia.org"}}}),t({title:"with route",inputs:{route:{route:{paths:[]},router:{createRouteUrl(){return window.location.href},setRouteOnDirectNavigation(n,r){return console.info(n,r),!1}}}}})}}),kA=[rn,bA,du,EA,vA,gA,yA,DA,AA,$A,CA].sort((e,t)=>e.title.localeCompare(t.title));qs({tagName:"vira-book-app",styles:F`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,render(){return D`
            <${_o.assign({internalRouterConfig:{basePath:au("element-vir","vira"),useInternalRouter:!0},pages:kA,themeColor:"#33ccff"})}>
