...
//     namedListen,
// } from '..';
// import {defineTypedEvent} from '../functional-element/typed-event';
...
// const customTypedEvent = defineTypedEvent<string>()('my-custom-typed-event');

// const TestElementNoEventsOrProps = defineFunctionalElement({
//     tagName: 'test-element-no-events-or-props',
//     renderCallback: ({props, dispatchEvent, dispatchElementEvent, events}): TemplateResult => {
//         // @ts-expect-error
...
//         // @ts-expect-error
//         dispatchElementEvent(new ElementEvent(MyElementEvent, 5));
//         dispatchElementEvent(new ElementEvent(MyElementEvent, 'derp'));
//         // @ts-expect-error
//         dispatchElementEvent(new ElementEvent(events.thingHappened));
//         // @ts-expect-error
//         dispatchElementEvent(new ElementEvent(events.thingHappened, 5));
